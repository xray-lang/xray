...
CONTRACT_SPECS = (
    ...
    ContractSpec(
        ...
        (
            ...
            "src/frontend/analyzer/xa_core_intrinsic_registry.c",
    ...
    ContractSpec(
        ...
        (
            ...
            "src/ir/xi_scalar_program.h",
            "src/ir/xi_scalar_program.c",
            "src/ir/xi_scalar_program_verify.c",
            "src/ir/xi_scalar_semantic_plan.h",
            "src/ir/xi_scalar_semantic_plan.c",
            ...
            "tests/unit/ir/test_xi_scalar_program.c",
