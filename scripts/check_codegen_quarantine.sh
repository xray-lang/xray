#!/bin/bash
# Codegen quarantine check: prevents new hand-written encoding patterns
# in quarantined files. Run in CI to enforce the xisa migration contract.
#
