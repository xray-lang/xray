    ...
    for index, text in enumerate(cases):
        ...
        lines.extend(
            [
                ...
                f"print(compress.crc32(text{index}))",
                f"print(compress.adler32(text{index}))",
                ...
                f"var gz{index} = compress.gzip(text{index}) ?? \"\"",
                f"print(compress.isGzip(gz{index}))",
                f"print(compress.gunzip(gz{index}) == text{index})",
                f"var deflated{index} = compress.deflate(text{index}) ?? \"\"",
                f"print(compress.inflate(deflated{index}) == text{index})",
                f"var zlibbed{index} = compress.zlibCompress(text{index}) ?? \"\"",
                f"print(compress.isZlib(zlibbed{index}))",
                f"print(compress.zlibDecompress(zlibbed{index}) == text{index})",
