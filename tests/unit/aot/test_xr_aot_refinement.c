...
static bool ensure_fixture_module_identity(XiFunc *root) {
    ...
    if (!root->module->identity &&
        !xi_module_set_identity(root->module, "memory-module-v1:id=25:aot-refinement-fixture-v1"))
        return false;
    return true;
}

static bool build_fixture_semantic_plan_and_attach(XiFunc *root, char *error, size_t error_size) {
...
static XrTargetPlan *build_attached_target_plan(XiFunc *function, XrTargetProfile **out_profile);
...
/* Every hand-built print in this file is built from a plan, because a print
 * without one is refused before the semantic plan is ever produced.  One
 * helper means a new fixture cannot forget. */
static XiValue *fixture_print(XiFunc *func, XiBlock *block) {
    XrLocation source = {
        .file = "refinement_fixture.xr",
        .line = 1,
        .column = 1,
        .end_line = 1,
        .end_column = 6,
    ...
    XrPrintPlan plan;
    if (xr_print_plan_build(XR_CORE_BUILTIN_PRINT, 1, source, XR_CORE_INTRINSIC_TARGET_OUTPUT_ALL,
                            XR_PRINT_CAPABILITY_NONE, &plan) != XR_PRINT_PLAN_OK)
        return NULL;
    return xi_value_new_print(func, block, &scalar_unit, &plan);
}
...
static RepresentationFixture representation_fixture_create(void) {
    ...
    fixture.native_constant = xi_const_int(fixture.function, fixture.entry, 40, &scalar_int);
    fixture.rhs = xi_value_new(fixture.function, fixture.entry, XI_UNBOX, &scalar_int, 1);
    REQUIRE(fixture.native_constant != NULL && fixture.rhs != NULL);
    fixture.rhs->args[0] = fixture.native_constant;
    fixture.tagged_call = xi_value_new(fixture.function, fixture.entry, XI_BOX, &scalar_int, 1);
    REQUIRE(fixture.tagged_call != NULL);
    fixture.tagged_call->args[0] = fixture.rhs;
    fixture.sum = xi_value_new(fixture.function, fixture.entry, XI_ADD, &scalar_int, 2);
    ...
    char error[512] = {0};
    REQUIRE(build_fixture_semantic_plan_and_attach(fixture.function, error, sizeof(error)));
    fixture.target_profile = build_target_profile();
    REQUIRE(xr_target_plan_build(fixture.function->semantic_plan, fixture.target_profile,
                                 &fixture.target_plan, error, sizeof(error)));
    return fixture;
}
...
static MaterializationFixture materialization_fixture_create_scoped(bool cold) {
    MaterializationFixture fixture = {0};
    fixture.function = xi_func_new("representation_materialization", &scalar_int);
    REQUIRE(fixture.function != NULL);
    fixture.entry = xi_block_new(fixture.function);
    ...
    REQUIRE(fixture.entry && fixture.then_block && fixture.else_block && fixture.merge_block);

    fixture.dominating_value = xi_const_int(fixture.function, fixture.entry, 1, &scalar_int);
    REQUIRE(fixture.dominating_value != NULL);
    XiValue *condition = xi_param(fixture.function, fixture.entry, 0, &scalar_bool);
    REQUIRE(condition != NULL);
    fixture.function->nparams = 1;
    fixture.function->params = (XiValue **) xr_malloc(sizeof(*fixture.function->params));
    REQUIRE(fixture.function->params != NULL);
    fixture.function->params[0] = condition;
    fixture.then_value = xi_const_int(fixture.function, fixture.then_block, 10, &scalar_int);
    fixture.else_value = xi_const_int(fixture.function, fixture.else_block, 20, &scalar_int);
    REQUIRE(fixture.then_value && fixture.else_value);
    xi_block_set_if(fixture.entry, condition, fixture.then_block, fixture.else_block);
    xi_block_set_jump(fixture.then_block, fixture.merge_block);
    xi_block_set_jump(fixture.else_block, fixture.merge_block);
    fixture.phi = xi_phi_new(fixture.function, fixture.merge_block, &scalar_int, 2);
    REQUIRE(fixture.phi != NULL);
    fixture.phi->value.args[0] = fixture.then_value;
    fixture.phi->value.args[1] = fixture.else_value;
    fixture.sum = xi_value_new(fixture.function, fixture.merge_block, XI_ADD, &scalar_int, 2);
    REQUIRE(fixture.sum);
    fixture.sum->args[0] = &fixture.phi->value;
    fixture.sum->args[1] = fixture.dominating_value;
    xi_block_set_return(fixture.merge_block, fixture.sum);
    fixture.function->stage = XI_STAGE_OPTIMIZED;

    if (cold) {
        XiFunc *child = fixture.function;
        XiFunc *root = xi_func_new("cold_adapter_root", &scalar_unit);
        XiBlock *entry = root ? xi_block_new(root) : NULL;
        REQUIRE(root && entry);
    ...
    REQUIRE(build_fixture_semantic_plan_and_attach(fixture.function, error, sizeof(error)));
    fixture.target_profile = build_target_profile();
    const XrSemanticPlan *modules[] = {fixture.function->semantic_plan};
    bool built =
        cold ? xr_target_plan_build_program_module_set(modules, 1u, modules[0],
                                                       fixture.target_profile, &fixture.target_plan,
                                                       error, sizeof(error))
             : xr_target_plan_build(fixture.function->semantic_plan, fixture.target_profile,
                                    &fixture.target_plan, error, sizeof(error));
    if (!built) {
...
static MaterializationFixture materialization_fixture_create(void) {
    return materialization_fixture_create_scoped(false);
}
...
static SharedScalarFixture shared_scalar_fixture_create(void) {
    ...
    fixture.function = xi_func_new("shared_scalar_representation", &scalar_unit);
    REQUIRE(fixture.function != NULL);
    fixture.entry = xi_block_new(fixture.function);
    REQUIRE(fixture.entry != NULL);
    fixture.constant = xi_const_int(fixture.function, fixture.entry, 42, &scalar_int);
    fixture.store = xi_value_new(fixture.function, fixture.entry, XI_SET_SHARED, &scalar_unit, 1);
    fixture.load = xi_value_new(fixture.function, fixture.entry, XI_GET_SHARED, &scalar_int, 0);
    fixture.print = fixture_print(fixture.function, fixture.entry);
...
static ClosureStorageFixture closure_storage_fixture_create(bool captured) {
    ...
    fixture.function =
        xi_func_new(captured ? "capturing_closure_storage" : "exact_closure_storage", &scalar_unit);
    fixture.child =
        xi_func_new(captured ? "capturing_closure_child" : "exact_closure_child", &scalar_int);
    ...
    XiValue *child_result = xi_const_int(fixture.child, child_entry, 42, &scalar_int);
    ...
    if (captured) {
        captured_value = xi_const_int(fixture.function, fixture.entry, 7, &scalar_int);
    ...
    fixture.closure = xi_value_new(fixture.function, fixture.entry, XI_CLOSURE_NEW, &scalar_closure,
                                   captured ? 1 : 0);
...
direct_local_callee_storage_fixture_create(bool extra_use, bool tail_call, bool concat_result) {
    DirectLocalCalleeStorageFixture fixture = {0};
    fixture.function = xi_func_new("direct_local_shared_root", &scalar_int);
    fixture.caller = xi_func_new("direct_local_shared_caller", &scalar_int);
    ...
    XiValue *child_result = xi_const_int(fixture.child, child_entry, 42, &scalar_int);
    XiValue *decoy_result = xi_const_int(fixture.decoy, decoy_entry, 7, &scalar_int);
    REQUIRE(child_result && decoy_result);
    xi_block_set_return(child_entry, child_result);
    xi_block_set_return(decoy_entry, decoy_result);

    fixture.function->children = (XiFunc **) xr_calloc(3, sizeof(*fixture.function->children));
    REQUIRE(fixture.function->children != NULL);
    ...
    XiValue *closure =
        xi_value_new(fixture.function, fixture.entry, XI_CLOSURE_NEW, &scalar_closure, 0);
    XiValue *store = xi_value_new(fixture.function, fixture.entry, XI_SET_SHARED, &scalar_unit, 1);
    fixture.load = xi_value_new(fixture.caller, caller_entry, XI_GET_SHARED, &opaque_callable, 0);
    fixture.call = xi_value_new(fixture.caller, caller_entry, tail_call ? XI_TAIL_CALL : XI_CALL,
                                &scalar_int, 1);
    ...
    if (extra_use) {
        XiValue *unexpected = fixture_print(fixture.caller, caller_entry);
        REQUIRE(unexpected != NULL);
        unexpected->args[0] = fixture.load;
    }
    if (concat_result) {
        REQUIRE(!tail_call);
        XiValue *prefix = xi_const_str(fixture.caller, caller_entry, "answer: ", &scalar_string);
        XiValue *concat =
            xi_value_new(fixture.caller, caller_entry, XI_STR_CONCAT, &scalar_string, 2);
        XiValue *release = xi_value_new(fixture.caller, caller_entry, XI_RELEASE, &scalar_unit, 1);
        REQUIRE(prefix && concat && release);
        concat->args[0] = prefix;
        concat->args[1] = fixture.call;
    ...
    fixture.function->stage = fixture.caller->stage = fixture.child->stage = fixture.decoy->stage =
        XI_STAGE_OPTIMIZED;

    char error[512] = {0};
    REQUIRE(build_fixture_semantic_plan_and_attach(fixture.function, error, sizeof(error)));
    fixture.target_profile = build_target_profile();
    bool built = xr_target_plan_build(fixture.function->semantic_plan, fixture.target_profile,
                                      &fixture.target_plan, error, sizeof(error));
    if (extra_use) {
...
static void direct_local_callee_storage_fixture_free(DirectLocalCalleeStorageFixture *fixture) {
    xr_target_plan_free(fixture->target_plan);
    xr_target_profile_free(fixture->target_profile);
    xi_func_free(fixture->function);
    memset(fixture, 0, sizeof(*fixture));
...
static DirectLocalTaggedRefFixture direct_local_tagged_ref_fixture_create(void) {
    ...
    fixture.function = xi_func_new("direct_local_tagged_ref_root", &scalar_int);
    fixture.child = xi_func_new("direct_local_tagged_ref_target", &scalar_int);
    ...
    fixture.parameter = xi_param(fixture.child, child_entry, 0, &direct_local_byte_array);
    ...
    XiValue *loaded =
        xi_value_new(fixture.child, child_entry, XI_PLACE_LOAD, &direct_local_byte_array, 1);
    XiValue *index = xi_const_int(fixture.child, child_entry, 0, &scalar_int);
    XiValue *element = xi_const_int(fixture.child, child_entry, 7, &scalar_byte);
    XiValue *write = xi_value_new(fixture.child, child_entry, XI_INDEX_SET, &scalar_unit, 3);
    XiValue *length = xi_value_new(fixture.child, child_entry, XI_LEN, &scalar_int, 1);
    ...
    XiValue *closure =
        xi_value_new(fixture.function, root_entry, XI_CLOSURE_NEW, &scalar_closure, 0);
    ...
    fixture.caller_storage =
        xi_value_new(fixture.function, root_entry, XI_GET_SHARED, &direct_local_byte_array, 0);
    fixture.place =
        xi_value_new(fixture.function, root_entry, XI_LOCAL_ADDR, &direct_local_byte_array, 1);
    REQUIRE(closure && closure_store && callable && fixture.caller_storage && fixture.place);
    closure->aux = fixture.child;
    ...
    XiCallPlan *call_plan =
        (XiCallPlan *) xi_func_arena_alloc(fixture.function, (uint32_t) sizeof(*call_plan));
    XiCallArgPlan *argument_plan =
        (XiCallArgPlan *) xi_func_arena_alloc(fixture.function, (uint32_t) sizeof(*argument_plan));
    ...
    fixture.writeback =
        xi_value_new(fixture.function, root_entry, XI_PLACE_LOAD, &direct_local_byte_array, 1);
    XiValue *retain =
        xi_value_new(fixture.function, root_entry, XI_RETAIN, &direct_local_byte_array, 1);
    XiValue *store = xi_value_new(fixture.function, root_entry, XI_SET_SHARED, &scalar_unit, 1);
    ...
    fixture.function->shared_slot_funcs = (XiFunc **) xi_func_arena_alloc(
        fixture.function, (uint32_t) sizeof(*fixture.function->shared_slot_funcs));
    REQUIRE(fixture.function->shared_slot_funcs != NULL);
    fixture.function->shared_slot_funcs[0] = fixture.child;
    fixture.function->shared_slot_func_count = 1;
    fixture.function->stage = fixture.child->stage = XI_STAGE_OPTIMIZED;
    ...
    REQUIRE(xi_module_set_identity(module,
                                   "memory-module-v1:id=34:direct-local-tagged-ref-fixture-v1"));
...
static void direct_local_tagged_ref_fixture_free(DirectLocalTaggedRefFixture *fixture) {
    xr_target_plan_free(fixture->target_plan);
    xr_target_profile_free(fixture->target_profile);
    xi_func_free(fixture->function);
    memset(fixture, 0, sizeof(*fixture));
...
static DirectLocalScalarRefFixture direct_local_scalar_ref_fixture_create(const char *identity,
                                                                          bool initializer) {
    ...
    REQUIRE(fixture.function && fixture.child);
    fixture.function->is_module_initializer = initializer;
    XiBlock *root_entry = xi_block_new(fixture.function);
    XiBlock *child_entry = xi_block_new(fixture.child);
    REQUIRE(root_entry && child_entry);
    ...
    fixture.load_before = xi_value_new(fixture.child, child_entry, XI_PLACE_LOAD, &scalar_int, 1);
    ...
    fixture.load_after = xi_value_new(fixture.child, child_entry, XI_PLACE_LOAD, &scalar_int, 1);
    ...
    REQUIRE(module != NULL);
    REQUIRE(xi_module_set_identity(module, identity));
    fixture.function->module = module;
...
static int source_namespace_suspendability(void *ud, const XiFunc *current, const XiValue *call) {
    (void) ud;
    (void) current;
...
static const XiFunc *source_namespace_resolve_method(void *ud, const XiFunc *current,
                                                     const XiValue *call) {
    (void) current;
...
static SourceNamespaceStorageFixture source_namespace_storage_fixture_create(bool extra_use,
                                                                             bool standalone) {
    SourceNamespaceStorageFixture fixture = {0};
    XiFunc *dependency_root = xi_func_new("source_namespace_dependency_init", &scalar_unit);
    ...
    XiValue *closure =
        xi_value_new(dependency_root, dependency_entry, XI_CLOSURE_NEW, &scalar_closure, 0);
    XiValue *store =
        xi_value_new(dependency_root, dependency_entry, XI_SET_SHARED, &scalar_unit, 1);
    ...
    XiValue *yield = xi_value_new(worker, worker_entry, XI_YIELD, &scalar_unit, 0);
    REQUIRE(yield);
    ...
    fixture.dependency_module = xi_module_new("fixture/source_namespace_dependency.xr",
                                              "source_namespace_dependency", dependency_root);
    REQUIRE(fixture.dependency_module);
    REQUIRE(xi_module_set_identity(fixture.dependency_module,
    ...
    fixture.dependency_module->exports =
        (XiModuleExport *) xr_calloc(1, sizeof(*fixture.dependency_module->exports));
    ...
    char error[512] = {0};
    REQUIRE(build_fixture_semantic_plan_and_attach(dependency_root, error, sizeof(error)));
    fixture.dependency = xr_semantic_plan_retain(dependency_root->semantic_plan);

    fixture.function = xi_func_new("source_namespace_caller_init", &scalar_unit);
    ...
    fixture.namespace_ref =
        xi_value_new(fixture.function, root_entry, XI_IMPORT_REF, &module_namespace, 0);
    fixture.namespace_alias =
        standalone ? NULL
                   : xi_value_new(fixture.function, root_entry, XI_COPY, &module_namespace, 1);
    fixture.namespace_retain =
        xi_value_new(fixture.function, root_entry, XI_RETAIN, &module_namespace, 1);
    fixture.namespace_store =
        xi_value_new(fixture.function, root_entry, XI_SET_SHARED, &scalar_unit, 1);
    REQUIRE(fixture.namespace_ref && fixture.namespace_retain && fixture.namespace_store &&
            (standalone || fixture.namespace_alias));
    XiImportRef *live_import =
        (XiImportRef *) xi_func_arena_alloc(fixture.function, sizeof(*live_import));
    REQUIRE(live_import);
    *live_import = fixture.import_ref;
    ...
    fixture.namespace_store->args[0] =
        fixture.namespace_alias ? fixture.namespace_alias : fixture.namespace_ref;
    fixture.namespace_store->aux_int = 0;
    if (extra_use) {
        XiValue *unexpected = fixture_print(fixture.function, root_entry);
        REQUIRE(unexpected);
    ...
    if (!standalone) {
        fixture.receiver =
            xi_value_new(fixture.caller, caller_entry, XI_GET_SHARED, &module_namespace, 0);
        fixture.receiver_alias =
            xi_value_new(fixture.caller, caller_entry, XI_COPY, &module_namespace, 1);
        fixture.call = xi_value_new(fixture.caller, caller_entry, XI_CALL_METHOD, &scalar_unit, 1);
    ...
    fixture.function->stage = fixture.caller->stage = XI_STAGE_SEMANTIC_LOWERED;
    ...
    fixture.module = xi_module_new("fixture/source_namespace_caller.xr", "source_namespace_caller",
                                   fixture.function);
    REQUIRE(fixture.module);
    REQUIRE(xi_module_set_identity(fixture.module,
    ...
    REQUIRE(xr_semantic_plan_build_and_attach_module_set(fixture.function, dependencies, 1, error,
                                                         sizeof(error)));

    fixture.target_profile = build_target_profile();
    const XrSemanticPlan *semantic_dependencies[] = {fixture.dependency};
    bool built = xr_target_plan_build_module_set(fixture.function->semantic_plan,
                                                 semantic_dependencies, 1, fixture.target_profile,
                                                 &fixture.target_plan, error, sizeof(error));
    if (extra_use) {
        REQUIRE(!built && fixture.target_plan == NULL);
    } else {
        if (!built) {
            ...
            bool semantic_verified = xr_semantic_plan_verify_module_set(
                fixture.function->semantic_plan, semantic_dependencies, 1, semantic_error,
...
static void source_namespace_storage_fixture_free(SourceNamespaceStorageFixture *fixture) {
    XiFunc *dependency_function =
        fixture->dependency_module ? fixture->dependency_module->init : NULL;
    xr_target_plan_free(fixture->target_plan);
    xr_target_profile_free(fixture->target_profile);
    xi_func_free(fixture->function);
...
static int native_namespace_suspendability(void *ud, const XiFunc *current, const XiValue *call) {
    (void) ud;
    (void) current;
    return call && (call->op == XI_CALL || (call->op == XI_CALL_METHOD && call->aux &&
                   (strcmp((const char *) call->aux, "__sleep") == 0 ||
                    strcmp((const char *) call->aux, "__resolveAll") == 0)))
               ? 1
               : -1;
}

static NativeNamespaceYieldableStorageFixture
native_namespace_yieldable_storage_fixture_create(bool extra_use, unsigned result_mode) {
    static XrFunctionParam parameters[] = {{.type = &scalar_string, .mode = XR_PARAM_READ}};
    static XrType callee_type = {
        .kind = XR_KIND_FUNCTION, .id = 9210, .frozen = true, .scalar_rep = XR_SCALAR_REP_NONE,
        .function = {.params = parameters, .param_count = 1, .min_params = 1,
                     .return_type = &tagged_string_array, .throw_effect = XR_FN_EFFECT_MAY_THROW},
    };
    bool array_result = result_mode != 0;
    bool selective = result_mode == 2;
    XrType *import_type = &module_namespace;
    ...
    XiImportRef *import_ref =
        (XiImportRef *) xi_func_arena_alloc(fixture.function, sizeof(*import_ref));
    REQUIRE(import_ref != NULL);
    *import_ref = (XiImportRef) {
        .module_path = array_result ? "net" : "time",
    ...
    fixture.namespace_ref =
        xi_value_new(fixture.function, root_entry, XI_IMPORT_REF, import_type, 0);
    XiValue *retain = xi_value_new(fixture.function, root_entry, XI_RETAIN, import_type, 1);
    XiValue *store = xi_value_new(fixture.function, root_entry, XI_SET_SHARED, &scalar_unit, 1);
    ...
    fixture.namespace_load = xi_value_new(fixture.caller, caller_entry,
        selective ? XI_IMPORT_REF : XI_GET_SHARED, selective ? &callee_type : import_type, 0);
    if (selective) {
        XiImportRef *member_ref = xi_func_arena_alloc(fixture.caller, sizeof(*member_ref));
        REQUIRE(member_ref && fixture.namespace_load);
        *member_ref = *import_ref;
        member_ref->member_name = "__resolveAll";
        fixture.namespace_load->aux = member_ref;
    }
    XiValue *argument = array_result
        ? xi_const_str(fixture.caller, caller_entry, "127.0.0.1", &scalar_string)
        : xi_const_int(fixture.caller, caller_entry, 1, &scalar_int);
    fixture.call = xi_value_new(fixture.caller, caller_entry,
        selective ? XI_CALL : XI_CALL_METHOD, array_result ? &tagged_string_array : &scalar_unit, 2);
    ...
    /* The public sleep wrapper is source-owned; this fixture exercises the
     * actual yieldable runtime boundary declared by the native registry. */
    fixture.call->aux = selective ? NULL : (void *) (array_result ? "__resolveAll" : "__sleep");
    fixture.call->aux_int = 0;
    if (array_result) {
        fixture.call->call_return_ownership = (XiReturnOwnership) {
            .kind = XI_RETURN_OWNERSHIP_OWNED, .param_index = -1, .complete = true,
        };
        XiCallPlan *call_plan = xi_func_arena_alloc(fixture.caller, sizeof(*call_plan));
        XiCallArgPlan *arg = xi_func_arena_alloc(fixture.caller, sizeof(*arg));
        REQUIRE(call_plan && arg);
        *arg = (XiCallArgPlan) {.param_mode = XR_PARAM_READ, .access = XR_CALL_ARG_PLAIN,
                               .origin_var_id = XI_NO_VAR_ID};
        *call_plan = (XiCallPlan) {.args = arg, .nargs = 1, .verified = true};
        fixture.call->call_plan = call_plan;
        XiValue *release = xi_value_new(fixture.caller, caller_entry, XI_RELEASE, &scalar_unit, 1);
        REQUIRE(release);
        release->args[0] = fixture.call;
    }
    if (extra_use) {
        XiValue *unexpected = fixture_print(fixture.caller, caller_entry);
        REQUIRE(unexpected != NULL);
...
static void
native_namespace_yieldable_storage_fixture_free(NativeNamespaceYieldableStorageFixture *fixture) {
    xr_target_plan_free(fixture->target_plan);
    xr_target_profile_free(fixture->target_profile);
    xi_func_free(fixture->function);
    memset(fixture, 0, sizeof(*fixture));
...
direct_local_go_callee_storage_fixture_create(bool extra_use, bool second_store,
    ...
    store->args[0] = closure;
    if (second_store) {
        XiValue *decoy_closure = xi_value_new(fixture.function, fixture.entry, XI_CLOSURE_NEW,
    ...
    if (extra_use) {
        XiValue *unexpected = fixture_print(fixture.function, fixture.entry);
        REQUIRE(unexpected != NULL);
        unexpected->args[0] = fixture.load;
    }
    xi_block_set_return(fixture.entry, NULL);
    ...
    fixture.function->invariant_mask = fixture.child->invariant_mask =
        fixture.decoy->invariant_mask = xi_stage_invariants(XI_STAGE_SEMANTIC_LOWERED);
    REQUIRE(xi_coro_lower(fixture.function, NULL));
    fixture.function->stage = fixture.child->stage = fixture.decoy->stage = XI_STAGE_OPTIMIZED;
    char error[512] = {0};
    bool semantic_built =
...
static void
direct_local_go_callee_storage_fixture_free(DirectLocalGoCalleeStorageFixture *fixture) {
    xr_target_plan_free(fixture->target_plan);
    xr_target_profile_free(fixture->target_profile);
    xi_func_free(fixture->function);
    memset(fixture, 0, sizeof(*fixture));
...
static XrAotRefinementPlan *build_refused_plan(const XrTargetPlan *target_plan,
    ...
    uint32_t decision = 0;
    REQUIRE(xr_aot_refinement_try_direct_call(builder, &protocol, target_plan, &request, &decision,
                                              diag));
...
static void test_open_target_direct_call_refuses_without_baseline_change(void) {
    SourceNamespaceStorageFixture fixture = source_namespace_storage_fixture_create(false, false);
    XrFingerprint semantic_before = xr_target_plan_semantic_fingerprint(fixture.target_plan);
    XrFingerprint target_before = xr_target_plan_fingerprint(fixture.target_plan);
    XrFingerprint profile_before = xr_target_profile_fingerprint(fixture.target_profile);
    XrAotRefinementDiagnostic diag = {0};
    ...
    REQUIRE(xr_fingerprint_equal(view.baseline.semantic_fingerprint, semantic_before));
    REQUIRE(xr_fingerprint_equal(view.baseline.target_plan_fingerprint, target_before));
    REQUIRE(xr_fingerprint_equal(view.baseline.target_profile_fingerprint, profile_before));
    REQUIRE(view.records[0].decision == XR_AOT_REFINEMENT_REFUSED);
    REQUIRE(view.records[0].diagnostic_issue == XR_AOT_REFINEMENT_DIRECT_CALL_TARGET_NOT_CLOSED);
    ...
    REQUIRE(memcmp(&view.records[0].input_state, &view.records[0].output_state,
...
static void test_direct_call_authority_applies_closed_local_binding(void) {
    DirectLocalCalleeStorageFixture fixture =
        direct_local_callee_storage_fixture_create(false, false, false);
    XrFingerprint target_before = xr_target_plan_fingerprint(fixture.target_plan);
...
static void test_tail_call_backend_conformance_is_exact(void) {
    DirectLocalCalleeStorageFixture fixture =
        direct_local_callee_storage_fixture_create(false, true, false);
    ...
    bool verified = xr_aot_tail_call_conformance_verify(fixture.function, fixture.target_plan,
                                                        &view, &first, &diag);
    if (!verified)
        fprintf(stderr, "tail conformance failed: %s op=%u call=%u function=%u value=%u\n",
                xr_aot_tail_call_conformance_issue_name(diag.issue), diag.semantic_operation,
                diag.target_call_index, diag.semantic_function, diag.semantic_value);
    REQUIRE(verified);
    REQUIRE(first.tail_call_count == 1 && diag.issue == XR_AOT_TAIL_CALL_CONFORMANCE_OK &&
            !fingerprint_is_zero_bytes(&first.fingerprint));
    REQUIRE(xr_aot_tail_call_conformance_verify(fixture.function, fixture.target_plan, &view,
                                                &second, &diag));
    REQUIRE(memcmp(&first, &second, sizeof(first)) == 0);

    const XrSemanticPlan *semantics[2] = {fixture.function->semantic_plan,
                                         fixture.function->semantic_plan};
    XrAotRefinementPlan *plans[2] = {NULL, NULL};
    uint32_t failed_module = UINT32_MAX;
    REQUIRE(xr_aot_refinement_direct_call_authority_build_modules(
        fixture.target_plan, semantics, 2, 27903, plans, &failed_module, &refinement_diag));
    XrAotRefinementPlanView views[2] = {xr_aot_refinement_plan_view(plans[0]),
                                       xr_aot_refinement_plan_view(plans[1])};
    const XiFunc *roots[2] = {fixture.function, fixture.function};
    XrAotTailCallConformance certificates[2] = {0};
    REQUIRE(xr_aot_tail_call_conformance_verify_modules(
        roots, fixture.target_plan, views, 2, certificates, &failed_module, &diag));
    REQUIRE(memcmp(&certificates[0], &first, sizeof(first)) == 0);
    REQUIRE(memcmp(&certificates[1], &first, sizeof(first)) == 0);
    views[1].fingerprint.bytes[0] ^= 1u;
    REQUIRE(!xr_aot_tail_call_conformance_verify_modules(
        roots, fixture.target_plan, views, 2, certificates, &failed_module, &diag));
    REQUIRE(failed_module == 1 && diag.issue == XR_AOT_TAIL_CALL_CONFORMANCE_PLAN_STATE);
    REQUIRE(fingerprint_is_zero_bytes(&certificates[0].fingerprint) &&
            fingerprint_is_zero_bytes(&certificates[1].fingerprint));
    views[1] = xr_aot_refinement_plan_view(plans[1]);
    roots[1] = fixture.caller;
    REQUIRE(!xr_aot_tail_call_conformance_verify_modules(
        roots, fixture.target_plan, views, 2, certificates, &failed_module, &diag));
    REQUIRE(failed_module == 1 && diag.issue == XR_AOT_TAIL_CALL_CONFORMANCE_SOURCE_IDENTITY);
    REQUIRE(fingerprint_is_zero_bytes(&certificates[0].fingerprint));
    xr_aot_refinement_plan_free(plans[0]);
    xr_aot_refinement_plan_free(plans[1]);
    plans[0] = plans[1] = NULL;
    semantics[1] = NULL;
    REQUIRE(!xr_aot_refinement_direct_call_authority_build_modules(
        fixture.target_plan, semantics, 2, 27903, plans, &failed_module, &refinement_diag));
    REQUIRE(failed_module == 1 && plans[0] == NULL && plans[1] == NULL);

    /* A caller cannot promote a corrupt baseline by merely recomputing its
     * content fingerprints. Both scoped construction and public conformance
     * must independently reject it before any live mapping is consumed. */
    XrTargetCallRecord saved_call = fixture.target_plan->calls[0];
    XrFingerprint saved_target_fingerprint = fixture.target_plan->fingerprint;
    fixture.target_plan->calls[0].flags |= UINT16_C(0x8000);
    xr_target_call_compute_fingerprint(fixture.target_plan, 0,
                                       &fixture.target_plan->calls[0].fingerprint);
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    XrAotRefinementPlan *rejected = NULL;
    REQUIRE(!xr_aot_refinement_direct_call_authority_build(
        fixture.target_plan, xr_target_plan_semantic_plan(fixture.target_plan), 27903, &rejected,
        &refinement_diag));
    REQUIRE(rejected == NULL && refinement_diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    REQUIRE(!xr_aot_tail_call_conformance_verify(fixture.function, fixture.target_plan, &view,
                                                 &second, &diag));
    REQUIRE(diag.issue == XR_AOT_TAIL_CALL_CONFORMANCE_PLAN_STATE);
    fixture.target_plan->calls[0] = saved_call;
    fixture.target_plan->fingerprint = saved_target_fingerprint;
    ...
    uint32_t saved_function_index = fixture.caller->semantic_plan_function_index;
    fixture.caller->semantic_plan_function_index = fixture.decoy->semantic_plan_function_index;
    REQUIRE(!xr_aot_tail_call_conformance_verify(fixture.function, fixture.target_plan, &view,
                                                 &second, &diag));
...
#define REQUIRE_BINDING_MUTATION_REJECTED(field_mutation, expected_issue)                          \
    ...
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.callee_function++,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_CALLEE_IDENTITY);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.callee_identity.bytes[0] ^=
                                      1u,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_CALLEE_IDENTITY);
    /* Argument-count and argument-map drift. */
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.argument_count++,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_ARGUMENT_MAPPING);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.parameter_count++,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_ARGUMENT_MAPPING);
    ...
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.error_slot = 0,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_ERROR_MAPPING);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.environment_required = 1,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_ENVIRONMENT_MAPPING);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.generation_required = 1,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_GENERATION_MAPPING);
    /* Result mapping and call classification. */
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.result_ownership =
                                          XR_TARGET_CALL_MOVE,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_RESULT_MAPPING);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.target_kind =
                                          XR_TARGET_CALL_TARGET_SOURCE_EXPORT,
                                      XR_AOT_REFINEMENT_DIRECT_CALL_CALLEE_IDENTITY);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.call_flags |=
    ...
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.decision = XR_AOT_REFINEMENT_REFUSED,
                                      XR_AOT_REFINEMENT_PLAN_STATE);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.diagnostic_issue =
                                          XR_AOT_REFINEMENT_DIRECT_CALL_TARGET_NOT_CLOSED,
                                      XR_AOT_REFINEMENT_PLAN_STATE);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.fingerprint.bytes[0] ^= 1u,
                                      XR_AOT_REFINEMENT_RECORD_FINGERPRINT);
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.fingerprint.bytes[0] ^= 1u,
                                      XR_AOT_REFINEMENT_RECORD_FINGERPRINT);
    /* The request key and the derived record must name the same call row. */
    REQUIRE_BINDING_MUTATION_REJECTED(mutated_record.direct_call_binding.target_call_index = 7,
                                      XR_AOT_REFINEMENT_PLAN_STATE);
...
static void test_direct_call_out_of_range_request_fails_closed(void) {
    ...
    XrAotDirectCallRequest request = {.target_call_index = 0};
    uint32_t decision = 0;
    REQUIRE(!xr_aot_refinement_try_direct_call(builder, &protocol, fixture.target_plan, &request,
                                               &decision, &diag));
...
static XrAotRefinementPlan *build_representation_plan(const RepresentationFixture *fixture,
                                                      XrAotRefinementDiagnostic *diag) {
    XrAotRefinementPlan *plan = NULL;
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    REQUIRE(xr_aot_representation_refinement_build_from_authority(
...
static void test_immutable_authority_matches_backend_materialization(void) {
    ...
    xi_opt_refresh_representations_with_policy(fixture.function, &policy);
    if (!xr_aot_representation_materialization_verify(&view, fixture.function, fixture.target_plan,
                                                      &policy, &diag)) {
        fprintf(stderr,
                "materialization verification failed: issue=%s record=%u value=%u operation=%u\n",
                xr_aot_refinement_issue_name(diag.issue), diag.record_index, diag.semantic_value,
    ...
    REQUIRE(xr_aot_refinement_try_representation_adapter(
        partial_builder, &protocol, fixture.target_plan, &partial_request, &decision, &diag));
    REQUIRE(decision == XR_AOT_REFINEMENT_APPLIED);
    XrAotRefinementPlan *partial_plan = NULL;
    REQUIRE(xr_aot_refinement_builder_freeze(partial_builder, fixture.target_plan, &partial_plan,
                                             &diag));
    XrAotRefinementPlanView partial_view = xr_aot_refinement_plan_view(partial_plan);
    REQUIRE(!xr_aot_representation_materialization_verify(&partial_view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    ...
    REQUIRE(then_box->op == XI_BOX && then_box->backend_origin == XI_BACKEND_VALUE_REP_BOX);
    REQUIRE(else_box->op == XI_BOX && else_box->backend_origin == XI_BACKEND_VALUE_REP_BOX);
    REQUIRE(phi_unbox->op == XI_UNBOX && phi_unbox->backend_origin == XI_BACKEND_VALUE_REP_UNBOX);

    fixture.sum->aux_int++;
    REQUIRE(!xr_aot_representation_materialization_verify(&view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    ...
    then_box->args[0] = fixture.dominating_value;
    char adapter_error[256] = {0};
    if (!xr_aot_rep_adapter_value_is_exact(fixture.target_plan, fixture.function, then_box,
                                           adapter_error, sizeof(adapter_error))) {
        fprintf(stderr, "dominating adapter source failed: %s source=%u rep=%u block=%u\n",
                adapter_error, fixture.dominating_value->id, fixture.dominating_value->rep,
                fixture.dominating_value->block->id);
        abort();
    }
    REQUIRE(!xr_aot_representation_materialization_verify(&view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    then_box->args[0] = fixture.then_value;
    REQUIRE(fixture.then_block->nvalues == 2 &&
            fixture.then_block->values[0] == fixture.then_value &&
            fixture.then_block->values[1] == then_box);
    fixture.then_block->values[0] = then_box;
    fixture.then_block->values[1] = fixture.then_value;
    REQUIRE(!xr_aot_rep_adapter_value_is_exact(fixture.target_plan, fixture.function, then_box,
                                               NULL, 0));
    fixture.then_block->values[0] = fixture.then_value;
    fixture.then_block->values[1] = then_box;
    ...
    REQUIRE(!xr_aot_representation_materialization_verify(&reordered_view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    ...
    XiValue *extra = xi_value_new(fixture.function, fixture.then_block, XI_BOX, &scalar_int, 1);
    REQUIRE(extra != NULL);
...
static void test_scalar_shared_boundary_is_exact_and_fail_closed(void) {
    ...
    const XrSemanticOperationRecord *use =
        xr_semantic_plan_operation(fixture.function->semantic_plan, adapter->use_operation);
    REQUIRE(use != NULL && use->opcode == XI_SET_SHARED);

    xi_opt_refresh_representations_with_policy(fixture.function, &policy);
    REQUIRE(fixture.store->args[0] != NULL && fixture.store->args[0]->op == XI_BOX &&
            fixture.store->args[0]->backend_origin == XI_BACKEND_VALUE_REP_BOX);
    ...
    XiFunc *string_function = xi_func_new("shared_string_representation", &scalar_unit);
    REQUIRE(string_function != NULL);
    XiBlock *entry = xi_block_new(string_function);
    XiValue *text = xi_const_str(string_function, entry, "not-scalar", &scalar_string);
    XiValue *store = xi_value_new(string_function, entry, XI_SET_SHARED, &scalar_unit, 1);
    REQUIRE(entry && text && store);
    store->args[0] = text;
    xi_block_set_return(entry, NULL);
    string_function->stage = XI_STAGE_OPTIMIZED;
    char error[512] = {0};
    REQUIRE(build_fixture_semantic_plan_and_attach(string_function, error, sizeof(error)));
    ...
    REQUIRE(xr_aot_representation_materialization_verify(&view, string_function, target_plan,
                                                         &policy, &diag));
    xr_aot_refinement_plan_free(plan);
...
static void test_exact_heap_closure_storage_is_tagged_and_fail_closed(void) {
    ...
    for (uint32_t i = 0; i < xr_semantic_plan_operation_count(fixture.function->semantic_plan);
         i++) {
        const XrSemanticOperationRecord *operation =
            xr_semantic_plan_operation(fixture.function->semantic_plan, i);
        if (operation && operation->opcode == XI_CLOSURE_NEW) {
            REQUIRE(closure_value == XR_SEMANTIC_INDEX_NONE && operation->operand_count == 0);
    ...
    const XrTargetMachineRepRecord *register_rep =
        xr_target_plan_machine_rep(fixture.target_plan, binding->register_rep);
...
static void test_direct_local_shared_callee_storage_is_exact_and_fail_closed(void) {
    ...
    REQUIRE(load_operation != XR_SEMANTIC_INDEX_NONE && load_value != XR_SEMANTIC_INDEX_NONE);
    const XrTargetValueRepRecord *binding =
    ...
    const XrTargetMachineRepRecord *memory_rep =
        xr_target_plan_machine_rep(fixture.target_plan, binding->memory_rep);
    REQUIRE(register_rep && memory_rep && register_rep->kind == XR_MACHINE_REP_DYN_VALUE &&
            memory_rep->kind == XR_MACHINE_REP_DYN_VALUE &&
    ...
    XrTargetCallRecord saved_call = fixture.target_plan->calls[0];
    XrFingerprint saved_call_plan_fingerprint = fixture.target_plan->fingerprint;
    fixture.target_plan->calls[0].callee_function = fixture.decoy->semantic_plan_function_index;
    xr_target_call_compute_fingerprint(fixture.target_plan, 0,
                                       &fixture.target_plan->calls[0].fingerprint);
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    char error[512] = {0};
    ...
    REQUIRE(
        xr_c_emission_plan_value_view(emission, load_value, &emission_value, error, sizeof(error)));
    REQUIRE(emission_value.rep == XR_C_VALUE_REP_TAGGED &&
            emission_value.materialization == XR_C_VALUE_MATERIALIZATION_NONE &&
            strcmp(emission_value.c_type, "XrValue") == 0 && emission_value.literal_bytes == NULL &&
    ...
    XrCValueEmissionView *row_snapshot =
        (XrCValueEmissionView *) xr_calloc(saved_emission_count, sizeof(*row_snapshot));
    REQUIRE(row_snapshot != NULL);
    memcpy(row_snapshot, emission->values, saved_emission_count * sizeof(*row_snapshot));
    ...
    XrCValueEmissionView *extra_rows =
        (XrCValueEmissionView *) xr_calloc(saved_emission_count + 1u, sizeof(*extra_rows));
    REQUIRE(extra_rows != NULL);
    memcpy(extra_rows, saved_rows, saved_emission_count * sizeof(*extra_rows));
    extra_rows[saved_emission_count] = saved_rows[direct_row_index];
    ...
    uint32_t saved_child_index = fixture.child->semantic_plan_function_index;
    fixture.child->semantic_plan_function_index = fixture.decoy->semantic_plan_function_index;
    REQUIRE(!xr_aot_representation_materialization_verify(&view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    REQUIRE(diag.issue == XR_AOT_REFINEMENT_SOURCE_IDENTITY ||
            diag.issue == XR_AOT_REFINEMENT_SOURCE_TYPE);
    ...
    fixture.target_plan->completed_family_mask &= ~XR_TARGET_FAMILY_DIRECT_LOCAL_CALLEE_STORAGE;
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    ...
    uint16_t saved_ownership = fixture.target_plan->machine_reps[machine_rep_index].ownership;
    fixture.target_plan->machine_reps[machine_rep_index].ownership = XR_TARGET_OWNERSHIP_OWNED;
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    REQUIRE(!xr_target_plan_verify(fixture.target_plan, error, sizeof(error)));
    fixture.target_plan->machine_reps[machine_rep_index].ownership = saved_ownership;
    fixture.target_plan->fingerprint = saved_fingerprint;
    ...
    DirectLocalCalleeStorageFixture extra_use =
        direct_local_callee_storage_fixture_create(true, false, false);
...
static void test_direct_local_tagged_ref_argument_authority_is_exact(void) {
    DirectLocalTaggedRefFixture fixture = direct_local_tagged_ref_fixture_create();
    ...
    REQUIRE(argument->call == call->id && argument->ordinal == 0 &&
            argument->semantic_value == place_value && argument->mode == XR_TARGET_CALL_REFERENCE &&
    ...
    REQUIRE(target->machine_reps[argument->register_rep].kind == XR_MACHINE_REP_DYN_VALUE &&
            target->machine_reps[argument->memory_rep].kind == XR_MACHINE_REP_DYN_VALUE &&
            target->machine_reps[argument->callee_register_rep].kind == XR_MACHINE_REP_RAW_PTR &&
            target->machine_reps[argument->callee_memory_rep].kind == XR_MACHINE_REP_RAW_PTR);
    const XrTargetValueRepRecord *parameter_binding =
        xr_target_plan_value_rep(target, parameter->value);
    REQUIRE(parameter_binding &&
            target->machine_reps[parameter_binding->register_rep].kind == XR_MACHINE_REP_RAW_PTR &&
            target->machine_reps[parameter_binding->memory_rep].kind == XR_MACHINE_REP_RAW_PTR &&
    ...
    REQUIRE(test_pair_identity("xray-target-direct-tagged-ref-argument-v2", semantic_target->id,
                               parameter->id, argument->ordinal, &expected_v2_identity));
    REQUIRE(test_pair_identity("xray-target-direct-array-ref-argument-"
                               "v1",
        ...
        *argument = saved_argument;
        switch (mutation) {
            case 0:
                ...
                break;
            case 1:
                argument->semantic_value = parameter->value;
                break;
            case 2:
                argument->callee_parameter++;
                break;
            case 3:
                argument->caller_slot = argument->callee_slot;
                break;
            case 4:
    ...
    *argument = saved_argument;
    ...
    REQUIRE(direct_view.record_count == 1 && direct_view.verified &&
            ...
            !fingerprint_is_zero_bytes(
                &direct_view.records[0].direct_call_binding.argument_map_fingerprint));
    ...
    REQUIRE(xr_c_emission_plan_call_argument_view(emission, call_operation->result_value, 0,
                                                  &call_view, error, sizeof(error)));
    ...
    REQUIRE(xr_c_emission_plan_value_view(emission, parameter->value, &parameter_view, error,
                                          sizeof(error)));
    REQUIRE(parameter_view.rep == XR_C_VALUE_REP_RAW_PTR &&
            ...
            parameter_view.recipe_discriminant == XR_TARGET_ARRAY_STORAGE_U8 &&
    ...
    XrCCallArgumentEmissionView saved_emission_argument = emission->call_arguments[0];
    for (uint32_t mutation = 0; mutation < 13; mutation++) {
        ...
        switch (mutation) {
            case 0:
                row->semantic_call_value++;
                break;
            case 1:
                row->semantic_operand++;
                break;
            case 2:
                row->semantic_value = parameter->value;
                break;
            case 3:
                row->callee_parameter++;
                break;
            case 4:
                row->ordinal++;
                break;
            case 5:
                row->caller_register_kind = XR_MACHINE_REP_RAW_PTR;
                break;
            case 6:
                row->callee_memory_kind = XR_MACHINE_REP_DYN_VALUE;
                break;
            case 7:
                row->mode = XR_TARGET_CALL_VALUE;
                break;
            case 8:
                row->ownership = XR_TARGET_CALL_READ;
                break;
            case 9:
                row->transfer_mode = XR_TRANSFER_MOVE;
                break;
            case 10:
                row->flags = 0;
                break;
...
static void expect_direct_local_scalar_ref_refinement_rejected(const XrTargetPlan *target,
...
static void test_direct_local_scalar_ref_v1_refinement_is_exact_and_fail_closed(void) {
    DirectLocalScalarRefFixture fixture = direct_local_scalar_ref_fixture_create(
        "memory-module-v1:id=34:direct-local-scalar-ref-fixture-v1", false);
    XrTargetPlan *target = fixture.target_plan;
    const XrSemanticPlan *semantic = fixture.function->semantic_plan;
    REQUIRE(target && semantic && target->calls_count == 1 && target->call_arguments_count == 1);
    const XrTargetCallRecord *call = &target->calls[0];
    XrTargetCallArgumentRecord *argument = &target->call_arguments[0];
    const XrSemanticParameterRecord *parameter =
        xr_semantic_plan_parameter(semantic, argument->callee_parameter);
    ...
    REQUIRE(argument->caller_slot == caller->slot && argument->callee_slot == callee->slot);
    REQUIRE(target->machine_reps[caller->register_rep].kind == XR_MACHINE_REP_I64);
    REQUIRE(target->machine_reps[callee->register_rep].kind == XR_MACHINE_REP_I64);
    REQUIRE(target->machine_reps[place->register_rep].kind == XR_MACHINE_REP_RAW_PTR);
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *plan = NULL;
    ...
    REQUIRE(built);
    XrAotRefinementPlanView view = xr_aot_refinement_plan_view(plan);
    REQUIRE(view.schema_version == XR_AOT_REFINEMENT_SCHEMA_VERSION && view.schema_version == 6 &&
            view.frozen && view.verified && view.record_count == 0);

    xi_opt_refresh_representations_with_policy(fixture.function, &policy);
    REQUIRE(fixture.parameter->rep == XR_REP_RAWPTR && fixture.load_before->rep == XR_REP_I64 &&
            fixture.store->args[0]->rep == XR_REP_RAWPTR &&
            fixture.store->args[1]->rep == XR_REP_I64 && fixture.load_after->rep == XR_REP_I64 &&
            fixture.caller_storage->rep == XR_REP_I64 && fixture.place->rep == XR_REP_RAWPTR &&
            fixture.call->args[1] == fixture.place && fixture.call->args[1]->rep == XR_REP_RAWPTR &&
            xr_aot_representation_materialization_verify(&view, fixture.function, target, &policy,
                                                         &diag));
    ...
    REQUIRE(place_view_found && place_view.rep == XR_C_VALUE_REP_RAW_PTR &&
        ...
        *argument = saved_argument;
        switch (mutation) {
            ...
            case 2:
                ...
                break;
            case 3:
                argument->callee_register_rep = 0;
                break;
            default:
                abort();
        }
...
static void test_direct_local_go_callee_storage_is_exact_and_fail_closed(void) {
    ...
    char error[512] = {0};
    REQUIRE(xr_aot_scalar_semantic_value_id(fixture.target_plan, fixture.function, fixture.load,
    ...
    const XrTargetMachineRepRecord *machine =
        binding ? xr_target_plan_machine_rep(fixture.target_plan, binding->register_rep) : NULL;
    REQUIRE(binding && machine && machine->kind == XR_MACHINE_REP_DYN_VALUE &&
    ...
    const XrTargetMachineRepRecord *task_machine =
        task_binding ? xr_target_plan_machine_rep(fixture.target_plan, task_binding->register_rep)
                     : NULL;
    ...
    REQUIRE(xr_aot_scalar_semantic_value_id(fixture.target_plan, fixture.function, fixture.go,
                                            &live_task_function, &live_task_value, error,
                                            sizeof(error)));
    REQUIRE(live_task_function == task_function && live_task_value == task_value);
    ...
    REQUIRE(xr_c_emission_plan_value_view(emission, task_value, &value, error, sizeof(error)));
    REQUIRE(value.rep == XR_C_VALUE_REP_TAGGED &&
            value.materialization == XR_C_VALUE_MATERIALIZATION_NONE &&
            strcmp(value.c_type, "XrValue") == 0);
    xr_c_emission_plan_free(emission);
    ...
    REQUIRE(view.frozen && view.verified && view.record_count == 0);
    xi_opt_refresh_representations_with_policy(fixture.function, &policy);
    REQUIRE(fixture.load->rep == XR_REP_TAGGED && fixture.go->args[0] == fixture.load &&
            fixture.go->rep == XR_REP_TAGGED && fixture.await->args[0] == fixture.go);
    REQUIRE(xr_aot_representation_materialization_verify(&view, fixture.function,
                                                         fixture.target_plan, &policy, &diag));
    ...
    REQUIRE(!xr_aot_representation_materialization_verify(&view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    REQUIRE(diag.issue == XR_AOT_REFINEMENT_USE_SITE && diag.semantic_value == semantic_value);
    ...
    fixture.target_plan->completed_family_mask &= ~XR_TARGET_FAMILY_DIRECT_LOCAL_GO_CALLEE_STORAGE;
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    REQUIRE(!xr_target_plan_verify(fixture.target_plan, error, sizeof(error)));
    ...
    uint32_t machine_rep_index = binding->register_rep;
    uint16_t ownership = fixture.target_plan->machine_reps[machine_rep_index].ownership;
    fixture.target_plan->machine_reps[machine_rep_index].ownership = XR_TARGET_OWNERSHIP_OWNED;
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    REQUIRE(!xr_target_plan_verify(fixture.target_plan, error, sizeof(error)));
    ...
    uint16_t task_ownership = fixture.target_plan->machine_reps[task_machine_rep_index].ownership;
    fixture.target_plan->machine_reps[task_machine_rep_index].ownership = XR_TARGET_OWNERSHIP_OWNED;
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    REQUIRE(!xr_target_plan_verify(fixture.target_plan, error, sizeof(error)));
    fixture.target_plan->machine_reps[task_machine_rep_index].ownership = task_ownership;
    fixture.target_plan->fingerprint = fingerprint;
...
static void test_source_namespace_storage_is_exact_and_fail_closed(void) {
    SourceNamespaceStorageFixture fixture = source_namespace_storage_fixture_create(false, false);
    REQUIRE((fixture.target_plan->completed_family_mask & XR_TARGET_FAMILY_SOURCE_IMPORT_STORAGE) !=
            0);
    ...
    REQUIRE(import_value != XR_SEMANTIC_INDEX_NONE && load_value != XR_SEMANTIC_INDEX_NONE);
    ...
    REQUIRE(import_binding && load_binding &&
            fixture.target_plan->machine_reps[import_binding->register_rep].kind ==
                XR_MACHINE_REP_DYN_VALUE &&
            fixture.target_plan->machine_reps[load_binding->register_rep].kind ==
                XR_MACHINE_REP_DYN_VALUE &&
            fixture.target_plan->machine_reps[import_binding->register_rep].ownership ==
                XR_TARGET_OWNERSHIP_BORROWED &&
            fixture.target_plan->machine_reps[load_binding->register_rep].ownership ==
                XR_TARGET_OWNERSHIP_BORROWED);
    ...
    REQUIRE(
        xr_c_emission_plan_value_view(emission, import_value, &import_view, error, sizeof(error)) &&
        xr_c_emission_plan_value_view(emission, load_value, &load_view, error, sizeof(error)));
    REQUIRE(import_view.rep == XR_C_VALUE_REP_TAGGED && load_view.rep == XR_C_VALUE_REP_TAGGED &&
            import_view.materialization == XR_C_VALUE_MATERIALIZATION_NONE &&
            load_view.materialization == XR_C_VALUE_MATERIALIZATION_NONE &&
            strcmp(import_view.c_type, "XrValue") == 0 && strcmp(load_view.c_type, "XrValue") == 0);
    ...
    REQUIRE(fixture.namespace_ref->rep == XR_REP_TAGGED &&
            ...
            fixture.receiver->rep == XR_REP_TAGGED && fixture.receiver_alias->rep == XR_REP_TAGGED);
    REQUIRE(xr_aot_representation_materialization_verify(&view, fixture.function,
                                                         fixture.target_plan, &policy, &diag));
    ...
    xr_aot_refinement_plan_free(plan);
    source_namespace_storage_fixture_free(&fixture);
    SourceNamespaceStorageFixture extra = source_namespace_storage_fixture_create(true, false);
...
static void test_standalone_source_namespace_storage_is_exact_and_fail_closed(void) {
    SourceNamespaceStorageFixture fixture = source_namespace_storage_fixture_create(false, true);
    REQUIRE(xr_semantic_plan_dependency_count(fixture.function->semantic_plan) == 1 &&
            ...
            (fixture.target_plan->completed_family_mask & XR_TARGET_FAMILY_SOURCE_IMPORT_STORAGE) !=
                0);
    uint32_t import_value = XR_SEMANTIC_INDEX_NONE;
    for (uint32_t i = 0; i < xr_semantic_plan_operation_count(fixture.function->semantic_plan);
         i++) {
    ...
    xi_opt_refresh_representations_with_policy(fixture.function, &policy);
    REQUIRE(fixture.namespace_ref->rep == XR_REP_TAGGED &&
            xr_aot_representation_materialization_verify(&view, fixture.function,
                                                         fixture.target_plan, &policy, &diag));
    ...
    live_import->resolved_module->path = "fixture/forged_standalone_dependency.xr";
    REQUIRE(xr_aot_representation_materialization_verify(&view, fixture.function,
                                                         fixture.target_plan, &policy, &diag));
    ...
    xr_aot_refinement_plan_free(plan);
    source_namespace_storage_fixture_free(&fixture);
    SourceNamespaceStorageFixture extra = source_namespace_storage_fixture_create(true, true);
    source_namespace_storage_fixture_free(&extra);
}
...
static void test_native_namespace_yieldable_storage_uses_frozen_call_identity(void) {
    NativeNamespaceYieldableStorageFixture fixture =
        native_namespace_yieldable_storage_fixture_create(false, 0);
    REQUIRE((fixture.target_plan->completed_family_mask &
    ...
    REQUIRE(semantic_target &&
            semantic_target->kind == XR_SEM_CALL_TARGET_NATIVE_NAMESPACE_YIELDABLE);

    char error[512] = {0};
    uint32_t semantic_function = XR_SEMANTIC_INDEX_NONE;
    uint32_t load_value = XR_SEMANTIC_INDEX_NONE;
    REQUIRE(xr_aot_scalar_semantic_value_id(fixture.target_plan, fixture.caller,
                                            fixture.namespace_load, &semantic_function, &load_value,
                                            error, sizeof(error)));
    const XrTargetValueRepRecord *binding =
        xr_target_plan_value_rep(fixture.target_plan, load_value);
    ...
    const XrTargetMachineRepRecord *memory_rep =
        xr_target_plan_machine_rep(fixture.target_plan, binding->memory_rep);
    const XrTargetSlotRecord *slot = &fixture.target_plan->slots[binding->slot];
    REQUIRE(register_rep && memory_rep && register_rep->kind == XR_MACHINE_REP_DYN_VALUE &&
            memory_rep->kind == XR_MACHINE_REP_DYN_VALUE &&
            register_rep->ownership == XR_TARGET_OWNERSHIP_BORROWED &&
            memory_rep->ownership == XR_TARGET_OWNERSHIP_BORROWED &&
            register_rep->root_kind == XR_TARGET_ROOT_DYNAMIC &&
            slot->semantic_value == load_value && slot->role == XR_TARGET_SLOT_TEMPORARY &&
    ...
    REQUIRE(call_index != UINT32_MAX &&
            ...
            (fixture.target_plan->calls[call_index].flags & XR_TARGET_CALL_SUSPEND) != 0);
    ...
    fixture.target_plan->calls[call_index].semantic_call_target = XR_SEMANTIC_INDEX_NONE;
    xr_target_call_compute_fingerprint(fixture.target_plan, call_index,
    ...
    NativeNamespaceYieldableStorageFixture extra =
        native_namespace_yieldable_storage_fixture_create(true, 0);
    plan = NULL;
    REQUIRE(!xr_aot_representation_refinement_build_from_authority(
...
static void test_exact_string_literal_storage_is_tagged_and_fail_closed(void) {
    XiFunc *function = xi_func_new("representation_string_authority", &scalar_unit);
    REQUIRE(function != NULL);
    XiBlock *entry = xi_block_new(function);
    REQUIRE(entry != NULL);
    XiValue *text = xi_const_str(function, entry, "not-a-machine-layout", &scalar_string);
    XiValue *print = fixture_print(function, entry);
    ...
    function->stage = XI_STAGE_OPTIMIZED;
    char error[512] = {0};
    REQUIRE(build_fixture_semantic_plan_and_attach(function, error, sizeof(error)));
    XrTargetProfile *profile = build_target_profile();
    XrTargetPlan *target_plan = NULL;
    REQUIRE(
        xr_target_plan_build(function->semantic_plan, profile, &target_plan, error, sizeof(error)));
    ...
    uint32_t semantic_function = XR_SEMANTIC_INDEX_NONE;
    uint32_t semantic_value = XR_SEMANTIC_INDEX_NONE;
    REQUIRE(xr_aot_scalar_semantic_value_id(target_plan, function, text, &semantic_function,
    ...
    bool materialized =
        xr_aot_representation_materialization_verify(&view, function, target_plan, &policy, &diag);
    if (!materialized)
        fprintf(stderr, "String literal materialization issue=%s record=%u value=%u operation=%u\n",
                xr_aot_refinement_issue_name(diag.issue), diag.record_index, diag.semantic_value,
                diag.semantic_operation);
...
static void test_stringbuilder_constructor_refinement_is_exact(void) {
    ...
    XiFunc *function = xi_func_new("stringbuilder_refinement", &scalar_unit);
    XiBlock *entry = xi_block_new(function);
    XiValue *builder = xi_value_new(function, entry, XI_CALL_BUILTIN, &stringbuilder_type, 0);
    XiValue *release = xi_value_new(function, entry, XI_RELEASE, &scalar_unit, 1);
    ...
    for (uint32_t mutation = 0; mutation < 3; ++mutation) {
        if (mutation == 0)
        ...
        xr_target_call_compute_fingerprint(target, 0, &target->calls[0].fingerprint);
        xr_target_plan_compute_fingerprint(target, &target->fingerprint);
        REQUIRE(!xr_aot_representation_materialization_verify(&view, function, target, &policy,
                                                               &diag));
        XrAotRefinementPlan *rejected = NULL;
        REQUIRE(!xr_aot_representation_refinement_build_from_authority(
            target, xr_target_plan_semantic_plan(target), &policy, &rejected, &diag));
        REQUIRE(!rejected && diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
        target->calls[0] = saved_call;
...
static void test_bundle_owns_empty_policy_bound_authority(void) {
    ...
    REQUIRE(xaot_bundle_set_program_target_plan(&bundle, fixture.target_plan));
    REQUIRE(xaot_bundle_require_representation_refinements(&bundle));
    REQUIRE(xaot_bundle_install_representation_refinements(&bundle, &plan, &policy));
    REQUIRE(xaot_bundle_representation_refinement_for_module(&bundle, 0) == plan);
    REQUIRE(xaot_bundle_representation_policy_matches(&bundle, 0, &policy));
    XiRepPolicy stale_policy = policy;
    stale_policy.prefer_call_args_native = false;
    REQUIRE(!xaot_bundle_representation_policy_matches(&bundle, 0, &stale_policy));
    REQUIRE(!xaot_bundle_install_representation_refinements(&bundle, &plan, &stale_policy));
...
static void test_representation_adapters_are_immutable_and_consumable(void) {
    ...
    XrFingerprint semantic_before = xr_semantic_plan_fingerprint(fixture.function->semantic_plan);

    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *plan = build_representation_plan(&fixture, &diag);
    XrAotRefinementPlanView view = xr_aot_refinement_plan_view(plan);
    REQUIRE(view.frozen && view.verified && view.record_count == 2);
    REQUIRE(view.records[0].transform_kind == XR_AOT_TRANSFORM_REPRESENTATION_ADAPTER);
    REQUIRE(view.records[0].decision == XR_AOT_REFINEMENT_APPLIED);
    REQUIRE(view.records[0].representation_adapter.adapter_kind == XR_AOT_REP_ADAPTER_BOX);
    REQUIRE(view.records[0].representation_adapter.output_rep_kind == XR_MACHINE_REP_DYN_VALUE);
    REQUIRE(view.records[1].representation_adapter.adapter_kind == XR_AOT_REP_ADAPTER_UNBOX);
    REQUIRE(view.records[1].representation_adapter.input_rep_kind == XR_MACHINE_REP_DYN_VALUE);
    ...
    REQUIRE(xr_fingerprint_equal(semantic_before,
...
static void test_representation_build_and_incremental_admission_reject_corrupt_target(void) {
    RepresentationFixture fixture = representation_fixture_create();
    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *plan = build_representation_plan(&fixture, &diag);
    XrAotRefinementPlanView view = xr_aot_refinement_plan_view(plan);
    ...
    XrAotRepresentationAdapterRequest request = {
        ...
        .source_partition = adapter->source_partition,
        .source_program_module_row = adapter->source_program_module_row,
        ...
        .source_semantic_fingerprint = adapter->source_semantic_fingerprint,
        .source_module_identity = adapter->source_module_identity,
        .policy_fingerprint = adapter->policy_fingerprint,
    };
    const XrSemanticPlan *semantic = xr_target_plan_semantic_plan(fixture.target_plan);
    XrAotRefinementBuilder *builder =
        xr_aot_refinement_builder_create(fixture.target_plan, semantic, &diag);
    REQUIRE(builder && adapter->target_slot < fixture.target_plan->slots_count);
    XrTargetSlotRecord *slot = &fixture.target_plan->slots[adapter->target_slot];
    uint8_t saved_root = slot->root_kind;
    XrFingerprint saved_fingerprint = fixture.target_plan->fingerprint;
    slot->root_kind = UINT8_MAX;
    xr_target_plan_compute_fingerprint(fixture.target_plan, &fixture.target_plan->fingerprint);
    XrAotPassProtocol protocol = xr_aot_refinement_representation_protocol(27902);
    uint32_t decision = 0;
    REQUIRE(!xr_aot_refinement_try_representation_adapter(builder, &protocol, fixture.target_plan,
                                                          &request, &decision, &diag));
    REQUIRE(diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementPlan *rejected = NULL;
    REQUIRE(!xr_aot_representation_refinement_build_from_authority(fixture.target_plan, semantic,
                                                                   &policy, &rejected, &diag));
    REQUIRE(!rejected && diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    slot->root_kind = saved_root;
    fixture.target_plan->fingerprint = saved_fingerprint;
    REQUIRE(xr_aot_refinement_try_representation_adapter(builder, &protocol, fixture.target_plan,
                                                         &request, &decision, &diag));
    REQUIRE(decision == XR_AOT_REFINEMENT_APPLIED);
    xr_aot_refinement_builder_free(builder);
    XrAotRefinementPlan *rebuilt = build_representation_plan(&fixture, &diag);
    XrAotRefinementPlanView rebuilt_view = xr_aot_refinement_plan_view(rebuilt);
    REQUIRE(xr_fingerprint_equal(view.fingerprint, rebuilt_view.fingerprint));
    xr_aot_refinement_plan_free(rebuilt);
    xr_aot_refinement_plan_free(plan);
    representation_fixture_free(&fixture);
}
...
static XrTargetPlan *build_attached_target_plan(XiFunc *function, XrTargetProfile **out_profile) {
    ...
    *out_profile = build_target_profile();
    XrTargetPlan *target_plan = NULL;
    if (!xr_target_plan_build(function->semantic_plan, *out_profile, &target_plan, error,
                              sizeof(error))) {
...
static XiFunc *native_fresh_result_refinement_fixture(bool suspends, XiValue **out_call) {
    ...
    static XrFunctionParam suspended_parameters[] = {
        {.type = &scalar_string, .mode = XR_PARAM_READ},
        {.type = &scalar_int, .mode = XR_PARAM_READ},
        {.type = &scalar_int, .mode = XR_PARAM_READ},
    };
    static XrType suspended_type = {
        .kind = XR_KIND_FUNCTION, .id = 9203, .frozen = true, .scalar_rep = XR_SCALAR_REP_NONE,
        .function = {.params = suspended_parameters, .param_count = 3, .min_params = 3,
                     .return_type = &nullable_storage, .throw_effect = XR_FN_EFFECT_MAY_THROW},
    };
    uint16_t argc = suspends ? 3 : 2;
    ...
    XiValue *callee =
        function && entry ? xi_value_new(function, entry, XI_IMPORT_REF,
            suspends ? &suspended_type : &callee_type, 0) : NULL;
    XiValue *call =
        function && entry ? xi_value_new(function, entry, XI_CALL, &nullable_storage, argc + 1) : NULL;
    XiCallPlan *call_plan =
        function ? (XiCallPlan *) xi_func_arena_alloc(function, sizeof(*call_plan)) : NULL;
    XiCallArgPlan *argument_plan =
        function ? (XiCallArgPlan *) xi_func_arena_alloc(function, argc * sizeof(*argument_plan))
                 : NULL;
    REQUIRE(function && entry && port && address && ref && callee && call && call_plan &&
            argument_plan);
    *ref = (XiImportRef) {
        .module_path = "net",
        .member_name = suspends ? "__connectFd" : "__udpBind",
        .resolved_mod_index = -1,
        .resolved_shared_slot = -1,
        .resolved_export_slot = -1,
        .resolution_attempted = true,
    ...
    callee->aux = ref;
    call->args[0] = callee;
    call->args[1] = suspends ? address : port;
    call->args[2] = suspends ? port : address;
    if (suspends)
        call->args[3] = port;
    ...
    memset(call_plan, 0, sizeof(*call_plan));
    memset(argument_plan, 0, argc * sizeof(*argument_plan));
...
static void test_native_yieldable_fresh_result_ownership(void) {
    for (unsigned mode = 1; mode <= 3; mode++) {
        NativeNamespaceYieldableStorageFixture fixture = {0};
        if (mode <= 2) {
            fixture = native_namespace_yieldable_storage_fixture_create(false, mode);
        } else {
            fixture.function = native_fresh_result_refinement_fixture(true, NULL);
            fixture.target_plan = build_attached_target_plan(fixture.function, &fixture.target_profile);
        }
        XrTargetPlan *target = fixture.target_plan;
        REQUIRE(target && target->calls_count == 1);
        XrTargetCallRecord saved = target->calls[0];
        REQUIRE(saved.result_ownership == XR_TARGET_CALL_RETURN_OWNED);
        REQUIRE(saved.result_slot < target->slots_count);
        REQUIRE(target->slots[saved.result_slot].root_kind == XR_TARGET_ROOT_DYNAMIC);
        REQUIRE(target->slots[saved.result_slot].ownership == XR_TARGET_OWNERSHIP_OWNED);
        XiRepPolicy policy = xi_rep_policy_native_boundary();
        XrAotRefinementDiagnostic diag = {0};
        ...
        if (!built)
            fprintf(stderr, "yieldable result refinement failed: issue %u, value %u, operation %u\n",
                    diag.issue, diag.semantic_value, diag.semantic_operation);
        REQUIRE(built && refinement);
        xr_aot_refinement_plan_free(refinement);
        XrFingerprint fingerprint = target->fingerprint;
...
static void test_native_direct_fresh_result_refinement_authority_is_exact(void) {
    ...
    XiFunc *function = native_fresh_result_refinement_fixture(false, &live_call);
    XrTargetProfile *profile = NULL;
    XrTargetPlan *target = build_attached_target_plan(function, &profile);
    ...
    XrTargetCallArgumentRecord *argument = &target->call_arguments[saved_call.argument_begin];
    XrTargetCallArgumentRecord saved_argument = *argument;
    for (uint32_t mutation = 0; mutation < 3; mutation++) {
        *argument = saved_argument;
        if (mutation == 0)
...
static void test_cold_call_result_concat_emission(void) {
    DirectLocalCalleeStorageFixture fixture =
        direct_local_callee_storage_fixture_create(false, false, true);
    const XrSemanticPlan *semantic = fixture.function->semantic_plan;
    const XrSemanticOperationRecord *concat = NULL;
    const XrSemanticOperationRecord *call = NULL;
    for (uint32_t i = 0; i < xr_semantic_plan_operation_count(semantic); ++i) {
        const XrSemanticOperationRecord *op = xr_semantic_plan_operation(semantic, i);
        if (op->opcode == XI_STR_CONCAT) {
            REQUIRE(!concat);
            concat = op;
        } else if (op->opcode == XI_CALL) {
            REQUIRE(!call);
            call = op;
        }
    }
    REQUIRE(concat && call && concat->function == call->function);
    char error[512] = {0};
    XrCEmissionPlan *emission = NULL;
    XrFingerprint profile = xr_target_profile_fingerprint(fixture.target_profile);
    REQUIRE(xr_c_emission_plan_build(fixture.target_plan, semantic, profile, &emission, error,
                                     sizeof(error)));
    XrCValueEmissionView view = {0};
    REQUIRE(
        xr_c_emission_plan_value_view(emission, concat->result_value, &view, error, sizeof(error)));
    REQUIRE(view.materialization == XR_C_VALUE_MATERIALIZATION_STRING_CONCAT &&
            view.recipe_argument_count == 2 &&
            view.recipe_arguments[1].semantic_value == call->result_value);
    xr_c_emission_plan_free(emission);
    emission = NULL;
    xr_target_plan_free(fixture.target_plan);
    fixture.target_plan = NULL;
    const XrSemanticPlan *modules[] = {semantic};
    REQUIRE(xr_target_plan_build_program_module_set(modules, 1, semantic, fixture.target_profile,
                                                    &fixture.target_plan, error, sizeof(error)));
    REQUIRE(fixture.target_plan->calls_count == 0);
    REQUIRE(xr_target_plan_value_rep_for_module(fixture.target_plan, 0, call->result_value));
    REQUIRE(xr_target_plan_value_rep_for_module(fixture.target_plan, 0, concat->result_value));
    bool built = xr_c_emission_plan_build(fixture.target_plan, semantic, profile, &emission, error,
                                          sizeof(error));
    if (!built)
        fprintf(stderr, "cold call-result concat emission: %s\n", error);
    REQUIRE(built && emission);
    REQUIRE(xr_c_emission_plan_verify(emission, fixture.target_plan, semantic, profile, error,
                                      sizeof(error)));
    REQUIRE(
        xr_c_emission_plan_value_view(emission, concat->result_value, &view, error, sizeof(error)));
    /* The unpartitioned plan above still proves the executable recipe. A
     * retained cold body has no instruction to emit and therefore acquires no
     * physical concat-operand obligation beyond its verified storage row. */
    REQUIRE(view.materialization == XR_C_VALUE_MATERIALIZATION_NONE &&
            view.recipe_argument_count == 0 && view.recipe_arguments == NULL);
    xr_c_emission_plan_free(emission);
    direct_local_callee_storage_fixture_free(&fixture);
}

static void test_unreachable_local_callee_preserves_materialized_identity(void) {
    DirectLocalCalleeStorageFixture fixture =
        direct_local_callee_storage_fixture_create(false, false, false);
    xr_target_plan_free(fixture.target_plan);
    fixture.target_plan = NULL;
    ...
    const XrSemanticPlan *modules[] = {semantic};
    char error[512] = {0};
    REQUIRE(xr_target_plan_build_program_module_set(modules, 1u, semantic, fixture.target_profile,
                                                    &fixture.target_plan, error, sizeof(error)));
    REQUIRE(fixture.target_plan->calls_count == 0u);
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *refinement = NULL;
    REQUIRE(xr_aot_representation_refinement_build_from_authority(fixture.target_plan, semantic,
    ...
    XrSemanticFunctionRecord *caller =
        &semantic->functions[fixture.caller->semantic_plan_function_index];
    caller->is_module_initializer = 1u;
    REQUIRE(!xr_aot_representation_materialization_verify(&view, fixture.function,
                                                          fixture.target_plan, &policy, &diag));
    REQUIRE(diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    caller->is_module_initializer = 0u;
    xr_aot_refinement_plan_free(refinement);
    direct_local_callee_storage_fixture_free(&fixture);
}

static void test_unreachable_adapters_follow_closed_program_scope(void) {
    MaterializationFixture fixture = materialization_fixture_create_scoped(true);
    XiFunc *root = fixture.function;
    XiFunc *child = root->children[0];
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    policy.force_phi_tagged = true;
    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *refinement = NULL;
    REQUIRE(xr_aot_representation_refinement_build_from_authority(
        fixture.target_plan, root->semantic_plan, &policy, &refinement, &diag));
    XrAotRefinementPlanView view = xr_aot_refinement_plan_view(refinement);
    REQUIRE(view.record_count == 0u);
    xi_opt_refresh_representations_with_policy(root, &policy);
    REQUIRE(fixture.phi->value.args[0]->backend_origin == XI_BACKEND_VALUE_REP_BOX);
    REQUIRE(xr_aot_representation_materialization_verify(&view, root, fixture.target_plan, &policy,
                                                         &diag));
    XrSemanticFunctionRecord *owner =
        &root->semantic_plan->functions[child->semantic_plan_function_index];
    owner->is_module_initializer = 1u;
    REQUIRE(!xr_aot_representation_materialization_verify(&view, root, fixture.target_plan, &policy,
                                                          &diag));
    REQUIRE(diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    owner->is_module_initializer = 0u;
    xr_aot_refinement_plan_free(refinement);
    materialization_fixture_free(&fixture);
}

static void test_unreachable_native_direct_preserves_frozen_argument_authority(void) {
    XiFunc *child = native_fresh_result_refinement_fixture(false, NULL);
    XiFunc *root = xi_func_new("native_direct_cold_root", &scalar_unit);
    XiBlock *entry = root ? xi_block_new(root) : NULL;
    REQUIRE(root && entry);
    ...
    REQUIRE(refinement);
    xr_aot_refinement_plan_free(refinement);
    XrSemanticFunctionRecord *owner = &semantic->functions[child->semantic_plan_function_index];
    uint8_t saved_initializer = owner->is_module_initializer;
    owner->is_module_initializer = 1;
    refinement = NULL;
    REQUIRE(!xr_aot_representation_refinement_build_from_authority(target, semantic, &policy,
                                                                   &refinement, &diag));
    REQUIRE(!refinement && diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
...
static void test_borrowed_byte_slice_parameter_storage_is_exact_and_fail_closed(void) {
    XiFunc *function = borrowed_byte_slice_parameter_fixture();
    XiValue *parameter = function->params[0];
    XrTargetProfile *profile = NULL;
    XrTargetPlan *target = build_attached_target_plan(function, &profile);
    char error[512] = {0};
    uint32_t ignored_function = XR_SEMANTIC_INDEX_NONE;
    uint32_t parameter_value = XR_SEMANTIC_INDEX_NONE;
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, parameter, &ignored_function,
                                            &parameter_value, error, sizeof(error)));
    const XrTargetValueRepRecord *binding = xr_target_plan_value_rep(target, parameter_value);
    REQUIRE(binding && binding->register_rep < target->machine_reps_count &&
            ...
            target->machine_reps[binding->register_rep].kind == XR_MACHINE_REP_VIEW &&
            target->machine_reps[binding->memory_rep].kind == XR_MACHINE_REP_VIEW);
...
static void test_emission_literal_identity_is_module_scoped(void) {
    XiFunc *roots[2] = {0};
    XiValue *values[2] = {0};
    uint32_t value_ids[2] = {0};
    const XrSemanticPlan *semantics[2] = {0};
    const char *identities[] = {"memory-module-v1:id=18:literal-text-owner",
                                "memory-module-v1:id=18:literal-bool-owner"};
    char error[512] = {0};
    for (uint32_t i = 0; i < 2; ++i) {
        roots[i] = xi_func_new(i ? "bool_owner" : "text_owner", &scalar_unit);
        XiBlock *entry = roots[i] ? xi_block_new(roots[i]) : NULL;
        REQUIRE(roots[i] && entry);
        values[i] = i ? xi_const_bool(roots[i], entry, true, &scalar_bool)
                      : xi_const_str(roots[i], entry, "module-owned-text", &scalar_string);
        REQUIRE(values[i]);
        if (!i) {
            XiValue *release = xi_value_new(roots[i], entry, XI_RELEASE, &scalar_unit, 1);
            REQUIRE(release);
            release->args[0] = values[i];
        }
        xi_block_set_return(entry, NULL);
        XiModule *module = xi_module_new(identities[i], roots[i]->name, roots[i]);
        REQUIRE(module && xi_module_set_identity(module, identities[i]));
        roots[i]->module = module;
        roots[i]->stage = XI_STAGE_OPTIMIZED;
        REQUIRE(build_fixture_semantic_plan_and_attach(roots[i], error, sizeof(error)));
        semantics[i] = roots[i]->semantic_plan;
        value_ids[i] = xr_semantic_plan_operation(semantics[i], 0u)->result_value;
    }
    REQUIRE(value_ids[0] == value_ids[1]);
    XrTargetProfile *profile = build_target_profile();
    for (uint32_t entry_module = 0; entry_module < 2; ++entry_module) {
        XrTargetPlan *target = NULL;
        REQUIRE(xr_target_plan_build_program_module_set(semantics, 2, semantics[entry_module],
                                                        profile, &target, error, sizeof(error)));
        for (uint32_t i = 0; i < 2; ++i) {
            XrCEmissionPlan *emission = NULL;
            bool built = xr_c_emission_plan_build(target, semantics[i],
                                                  xr_target_profile_fingerprint(profile), &emission,
                                                  error, sizeof(error));
            if (!built)
                fprintf(stderr, "module %u literal emission: %s\n", i, error);
            REQUIRE(built && emission);
            XrCValueEmissionView view = {0};
            REQUIRE(
                xr_c_emission_plan_value_view(emission, value_ids[i], &view, error, sizeof(error)));
            REQUIRE(view.rep == (i ? XR_C_VALUE_REP_BOOL : XR_C_VALUE_REP_TAGGED));
            REQUIRE(view.materialization == (i ? XR_C_VALUE_MATERIALIZATION_NONE
                                               : XR_C_VALUE_MATERIALIZATION_STRING_LITERAL_VIEW));
            if (!i)
                REQUIRE(view.literal_byte_length == 17u &&
                        memcmp(view.literal_bytes, "module-owned-text", 17u) == 0);
            REQUIRE(!xr_c_emission_plan_verify(emission, target, semantics[1u - i],
                                               xr_target_profile_fingerprint(profile), error,
                                               sizeof(error)));
            REQUIRE(xr_c_emission_plan_verify(emission, target, semantics[i],
                                              xr_target_profile_fingerprint(profile), error,
                                              sizeof(error)));
            xr_c_emission_plan_free(emission);
        }
    ...
    xr_target_profile_free(profile);
    for (uint32_t i = 0; i < 2; ++i)
        xi_func_free(roots[i]);
}

static void test_scalar_ref_emission_is_module_scoped(void) {
    DirectLocalScalarRefFixture fixtures[] = {
        direct_local_scalar_ref_fixture_create("memory-module-v1:id=16:scalar-ref-first", true),
        direct_local_scalar_ref_fixture_create("memory-module-v1:id=17:scalar-ref-second", true),
    };
    const XrSemanticPlan *semantics[] = {fixtures[0].function->semantic_plan,
                                         fixtures[1].function->semantic_plan};
    char error[512] = {0};
    for (uint32_t entry_module = 0; entry_module < 2; ++entry_module) {
        XrTargetPlan *target = NULL;
        REQUIRE(xr_target_plan_build_program_module_set(semantics, 2, semantics[entry_module],
                                                        fixtures[0].target_profile, &target, error,
                                                        sizeof(error)));
        REQUIRE(target->call_arguments_count == 2);
        REQUIRE(target->call_arguments[0].semantic_value ==
                target->call_arguments[1].semantic_value);
        REQUIRE(target->module_partitions[1].functions_begin > 0);
        for (uint32_t i = 0; i < 2; ++i) {
            const XrTargetCallArgumentRecord *argument = &target->call_arguments[i];
            const XrTargetValueRepRecord *address =
                xr_target_plan_value_rep_for_module(target, i, argument->semantic_value);
            XrCScalarRefProjection projection = {0};
            REQUIRE(address);
            REQUIRE(xr_c_scalar_ref_project_address(target, address, &projection) ==
                    XR_C_SCALAR_REF_EXACT);
            REQUIRE(projection.function_abi.semantic_function == 1u);
            REQUIRE(projection.function_abi.rep == XR_C_VALUE_REP_RAW_PTR &&
                    projection.function_abi.pointee_rep == XR_C_VALUE_REP_I64);
            XrCEmissionPlan *emission = NULL;
            bool built = xr_c_emission_plan_build(
                target, semantics[i], xr_target_profile_fingerprint(fixtures[0].target_profile),
                &emission, error, sizeof(error));
            if (!built)
                fprintf(stderr, "module %u scalar ref emission: %s\n", i, error);
            REQUIRE(built && emission);
            REQUIRE(xr_c_scalar_ref_projection_views_are_exact(
                &projection, emission->call_arguments, emission->call_argument_count,
                emission->function_abis, emission->function_abi_count));
            XiRepPolicy policy = xi_rep_policy_native_boundary();
            XrAotRefinementDiagnostic diag = {0};
            XrAotRefinementPlan *refinement = NULL;
            REQUIRE(xr_aot_representation_refinement_build_from_authority(
                target, semantics[i], &policy, &refinement, &diag));
            xr_aot_refinement_plan_free(refinement);
            const XrSemanticParameterRecord *parameter =
                xr_semantic_plan_parameter(semantics[i], argument->callee_parameter);
            REQUIRE(parameter &&
                    xr_aot_scalar_ref_v1_parameter_status(semantics[i], target, parameter->value) ==
                        XR_AOT_SCALAR_REF_V1_EXACT);
            XrTargetSlotRecord *slot = &target->slots[argument->caller_slot];
            uint32_t saved_function = slot->function;
            slot->function = target->slots[target->call_arguments[1u - i].caller_slot].function;
            xr_target_plan_compute_fingerprint(target, &target->fingerprint);
            REQUIRE(xr_aot_scalar_ref_v1_parameter_status(semantics[i], target, parameter->value) ==
                    XR_AOT_SCALAR_REF_V1_INVALID);
            slot->function = saved_function;
            xr_target_plan_compute_fingerprint(target, &target->fingerprint);
            REQUIRE(xr_target_plan_verify(target, error, sizeof(error)));
            XrTargetCallArgumentRecord forged = *argument;
            forged.caller_slot = target->call_arguments[1u - i].caller_slot;
            REQUIRE(xr_c_scalar_ref_project_argument(target, &forged, &projection) ==
    ...
    for (uint32_t i = 0; i < 2; ++i)
        direct_local_scalar_ref_fixture_free(&fixtures[i]);
}

static void test_tuple_emission_is_module_scoped(void) {
    XiFunc *roots[2] = {0};
    const XrSemanticPlan *semantics[2] = {0};
    uint32_t values[2] = {0};
    const char *identities[] = {"memory-module-v1:id=11:tuple-first",
                                "memory-module-v1:id=12:tuple-second"};
    char error[512] = {0};
    for (uint32_t i = 0; i < 2; ++i) {
        XrType *elements[] = {&scalar_int, &scalar_int, &scalar_int};
        XrType tuple = {.kind = XR_KIND_TUPLE,
                        .id = 101,
                        .frozen = true,
                        .is_value_type = true,
                        .scalar_rep = XR_SCALAR_REP_NONE};
        tuple.tuple.element_types = elements;
        tuple.tuple.element_count = (uint16_t) (2u + i);
        roots[i] = xi_func_new("tuple_owner", &tuple);
        XiBlock *entry = roots[i] ? xi_block_new(roots[i]) : NULL;
        REQUIRE(entry);
        roots[i]->is_module_initializer = true;
        XiValue *scalar = xi_const_int(roots[i], entry, 41, &scalar_int);
        XiValue *aggregate = xi_value_new(roots[i], entry, XI_TUPLE_NEW, &tuple, 2u + i);
        REQUIRE(scalar && aggregate);
        for (uint32_t j = 0; j < 2u + i; ++j)
            aggregate->args[j] = scalar;
        aggregate->aux_int = xi_tuple_pack_aux((uint16_t) (2u + i), 0);
        ...
        REQUIRE(build_fixture_semantic_plan_and_attach(roots[i], error, sizeof(error)));
        semantics[i] = roots[i]->semantic_plan;
        REQUIRE(xr_semantic_plan_operation_count(semantics[i]) == 2);
        values[i] = xr_semantic_plan_operation(semantics[i], 1)->result_value;
    }
    ...
    for (uint32_t entry_module = 0; entry_module < 2; ++entry_module) {
        ...
        for (uint32_t i = 0; i < 2; ++i) {
            const XrTargetValueRepRecord *binding =
                xr_target_plan_value_rep_for_module(target, i, values[i]);
            XrCAggregateProjection projection = {0};
            REQUIRE(binding && xr_c_aggregate_projection(target, binding, &projection));
            REQUIRE(projection.kind == XR_C_AGGREGATE_PROJECTION_TUPLE_BACKING &&
                    projection.element_count == 2u + i);
            REQUIRE(projection.layout >= target->module_partitions[i].layouts_begin &&
                    projection.layout - target->module_partitions[i].layouts_begin <
                        target->module_partitions[i].layouts_count);
            XrCEmissionPlan *emission = NULL;
            REQUIRE(xr_c_emission_plan_build(target, semantics[i],
                                             xr_target_profile_fingerprint(profile), &emission,
                                             error, sizeof(error)));
            XrCValueEmissionView view = {0};
            REQUIRE(
                xr_c_emission_plan_value_view(emission, values[i], &view, error, sizeof(error)));
...
static void test_slice_view_storage_is_module_scoped(void) {
    XiFunc *roots[2] = {0};
    const XrSemanticPlan *semantics[2] = {0};
    const char *identities[2] = {"memory-module-v1:id=16:slice-view-first",
                                 "memory-module-v1:id=17:slice-view-second"};
    char error[512] = {0};
    for (uint32_t i = 0; i < 2; i++) {
        roots[i] = borrowed_byte_slice_parameter_fixture();
        XiModule *module = xi_module_new(identities[i], roots[i]->name, roots[i]);
        REQUIRE(module && xi_module_set_identity(module, identities[i]));
        roots[i]->module = module;
        roots[i]->stage = XI_STAGE_OPTIMIZED;
    ...
    XrTargetProfile *profile = build_target_profile();
    XrTargetPlan *target = NULL;
    REQUIRE(xr_target_plan_build_program_module_set(semantics, 2, semantics[0], profile, &target,
                                                    error, sizeof(error)));
    REQUIRE(target->module_partitions_count == 2 && target->module_partitions[1].layouts_begin);
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    uint32_t layouts[2] = {0};
    uint32_t reps[2] = {0};
    for (uint32_t i = 0; i < 2; i++) {
        const XrSemanticParameterRecord *parameter = xr_semantic_plan_parameter(semantics[i], 0);
        const XrTargetValueRepRecord *binding =
            parameter ? xr_target_plan_value_rep_for_module(target, i, parameter->value) : NULL;
        REQUIRE(binding && binding->register_rep < target->machine_reps_count);
        reps[i] = binding->register_rep;
        layouts[i] = target->machine_reps[reps[i]].detail;
        REQUIRE(layouts[i] >= target->module_partitions[i].layouts_begin &&
                layouts[i] < target->layouts_count &&
                target->layouts[layouts[i]].semantic_type == parameter->type);
        XrAotRefinementPlan *plan = NULL;
        REQUIRE(xr_aot_representation_refinement_build_from_authority(target, semantics[i], &policy,
                                                                      &plan, &diag));
        XrAotRefinementPlanView view = xr_aot_refinement_plan_view(plan);
        xi_opt_refresh_representations_with_policy(roots[i], &policy);
        REQUIRE(
            xr_aot_representation_materialization_verify(&view, roots[i], target, &policy, &diag));
        xr_aot_refinement_plan_free(plan);
    }
    REQUIRE(layouts[0] != layouts[1]);
    XrFingerprint saved = target->fingerprint;
    target->machine_reps[reps[1]].detail = layouts[0];
    xr_target_plan_compute_fingerprint(target, &target->fingerprint);
    XrAotRefinementPlan *rejected = NULL;
    REQUIRE(!xr_aot_representation_refinement_build_from_authority(target, semantics[1], &policy,
                                                                   &rejected, &diag));
    REQUIRE(!rejected && diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    target->machine_reps[reps[1]].detail = layouts[1];
    target->fingerprint = saved;
    REQUIRE(xr_target_plan_verify(target, error, sizeof(error)));
    xr_target_plan_free(target);
    xr_target_profile_free(profile);
    for (uint32_t i = 0; i < 2; i++)
...
static void test_fixed_array_backing_projection_is_exact_and_fail_closed(void) {
    ...
    XiBlock *entry = xi_block_new(function);
    REQUIRE(entry != NULL);
    XiValue *array = xi_value_new(function, entry, XI_FIXED_ARRAY_NEW, &fixed_u32x4, 0);
    XiValue *index = xi_const_int(function, entry, 0, &scalar_int);
    ...
    uint32_t semantic_function = XR_SEMANTIC_INDEX_NONE;
    uint32_t semantic_value = XR_SEMANTIC_INDEX_NONE;
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, array, &semantic_function,
                                            &semantic_value, error, sizeof(error)));
    const XrTargetValueRepRecord *binding = xr_target_plan_value_rep(target, semantic_value);
    const XrTargetMachineRepRecord *register_rep =
    ...
    REQUIRE(
        binding && register_rep && memory_rep && register_rep->kind == XR_MACHINE_REP_AGGREGATE &&
        memory_rep->kind == XR_MACHINE_REP_AGGREGATE && register_rep->detail == memory_rep->detail);
    ...
    REQUIRE(view.rep == XR_C_VALUE_REP_AGGREGATE &&
            ...
            view.backing_value == semantic_value && view.backing_element_count == 4 &&
            view.backing_native_type == XR_NATIVE_U32 && strcmp(view.c_type, "XrValue") == 0 &&
...
static void add_owned_class_parameter_cleanup(XiFunc *root, XrType *instance_type,
                                              XrType *stringbuilder_type, XiValue **out_release,
                                              XiValue **out_native_scalar) {
    XiFunc *child = xi_func_new("render_after_drop", &scalar_string);
    XiBlock *child_entry = child ? xi_block_new(child) : NULL;
    root->children = (XiFunc **) xr_calloc(1, sizeof(*root->children));
    REQUIRE(child && child_entry && root->children);
    root->children[0] = child;
    root->nchildren = root->children_cap = 1;
    child->parent_func = root;
    child->stage = XI_STAGE_OPTIMIZED;
    child->params = (XiValue **) xr_calloc(1, sizeof(*child->params));
    child->arc_borrow_sig =
        (XiBorrowSig *) xi_func_arena_alloc(child, sizeof(*child->arc_borrow_sig));
    REQUIRE(child->params && child->arc_borrow_sig);
    child->nparams = child->min_params = 1;
    child->params[0] = xi_param(child, child_entry, 0, instance_type);
    child->arc_borrow_sig->nparams = 1;
    child->arc_borrow_sig->param_own[0] = XI_OWN_OWNED;
    child->arc_borrow_sig->valid = true;
    *out_native_scalar = xi_const_int(child, child_entry, 17, &scalar_int);
    XiValue *release = xi_value_new(child, child_entry, XI_RELEASE, &scalar_unit, 1);
    REQUIRE(child->params[0] && *out_native_scalar && release);
    release->args[0] = child->params[0];
    *out_release = release;
    XiValue *builder = xi_value_new(child, child_entry, XI_CALL_BUILTIN, stringbuilder_type, 0);
    XiValue *text = xi_const_str(child, child_entry, "==", &scalar_string);
    XiValue *start = xi_const_int(child, child_entry, 0, &scalar_int);
    XiValue *end = xi_const_int(child, child_entry, 1, &scalar_int);
    XiValue *slice = xi_value_new(child, child_entry, XI_CALL_METHOD, &scalar_string, 3);
    XiValue *append = xi_value_new(child, child_entry, XI_CALL_METHOD, stringbuilder_type, 2);
    REQUIRE(builder && text && start && end && slice && append);
    builder->aux = (void *) "StringBuilder";
    slice->args[0] = text;
    slice->args[1] = start;
    slice->args[2] = end;
    ...
    slice->call_return_ownership = (XiReturnOwnership) {
        .kind = XI_RETURN_OWNERSHIP_OWNED, .param_index = -1, .complete = true};
    ...
    XiValue *render = xi_value_new(child, child_entry, XI_CALL_METHOD, &scalar_string, 1);
    XiValue *drop_builder = xi_value_new(child, child_entry, XI_RELEASE, &scalar_unit, 1);
    REQUIRE(render && drop_builder);
    render->args[0] = builder;
    render->aux = (void *) "toString";
    render->aux_int = 2;
    drop_builder->args[0] = append;
    xi_block_set_return(child_entry, render);
}

static void check_representation_batch_ownership(
    XrTargetPlan *target, const XrSemanticPlan *const *semantics, XiFunc **roots,
    XiValue *second_release, XiValue *native_scalar) {
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    uint32_t failed_module = UINT32_MAX;
    const XrSemanticPlan *incomplete[2] = {semantics[0], NULL};
    XrAotRefinementPlan *plans[2] = {NULL, NULL};
    REQUIRE(!xr_aot_representation_refinement_build_modules(
        target, incomplete, 2, &policy, plans, &failed_module, &diag));
    REQUIRE(failed_module == 1 && !plans[0] && !plans[1]);
    REQUIRE(xr_aot_representation_refinement_build_modules(
        target, semantics, 2, &policy, plans, &failed_module, &diag));
    const XiFunc *immutable_roots[2] = {roots[0], roots[1]};
    XrAotRefinementPlanView views[2] = {
        xr_aot_refinement_plan_view(plans[0]), xr_aot_refinement_plan_view(plans[1])};
    for (uint32_t i = 0; i < 2; ++i)
        xi_opt_refresh_representations_with_policy(roots[i], &policy);
    REQUIRE(xr_aot_representation_materialization_verify_modules(
        views, immutable_roots, 2, target, &policy, &failed_module, &diag));

    XiModule *modules[2] = {roots[0]->module, roots[1]->module};
    XaotBundle bundle;
    REQUIRE(xaot_bundle_init(&bundle, modules, 2, 0));
    REQUIRE(xaot_bundle_set_program_target_plan(&bundle, target));
    REQUIRE(xaot_bundle_require_representation_refinements(&bundle));
    XiValue *saved_source = second_release->args[0];
    second_release->args[0] = native_scalar;
    REQUIRE(!xr_aot_representation_materialization_verify_modules(
        views, immutable_roots, 2, target, &policy, &failed_module, &diag));
    REQUIRE(failed_module == 1);
    REQUIRE(!xaot_bundle_install_representation_refinements(&bundle, plans, &policy));
    REQUIRE(!xaot_bundle_representation_refinement_for_module(&bundle, 0) &&
            !xaot_bundle_representation_refinement_for_module(&bundle, 1));
    second_release->args[0] = saved_source;
    REQUIRE(xaot_bundle_install_representation_refinements(&bundle, plans, &policy));
    REQUIRE(xaot_bundle_representation_refinement_for_module(&bundle, 0) == plans[0] &&
            xaot_bundle_representation_refinement_for_module(&bundle, 1) == plans[1]);
    REQUIRE(xaot_bundle_verify_representation_refinements(&bundle, &policy));
    second_release->args[0] = native_scalar;
    REQUIRE(!xaot_bundle_verify_representation_refinements(&bundle, &policy));
    second_release->args[0] = saved_source;
    REQUIRE(xaot_bundle_verify_representation_refinements(&bundle, &policy));
...
static void test_tagged_temporary_storage_is_module_scoped(void) {
    XrType class_object = {
        .kind = XR_KIND_UNKNOWN,
        .id = 102,
        .frozen = true,
    ...
    XrClassInfo class_info = {.name = "Options"};
    XiClassData declaration = {.class_info = &class_info, .class_name = "Options"};
    XrType instance_type = {
        .kind = XR_KIND_INSTANCE,
        .id = 103,
        .frozen = true,
        .scalar_rep = XR_SCALAR_REP_NONE,
        .instance = {.class_name = "Options", .class_ref = &class_info},
    };
    XrType stringbuilder_type = {
        .kind = XR_KIND_INSTANCE,
        .id = 701,
    ...
    XiFunc *roots[2] = {0};
    XiValue *releases[2] = {0};
    XiValue *native_scalars[2] = {0};
    const XrSemanticPlan *semantics[2] = {0};
    uint32_t values[2] = {0};
    const char *identities[2] = {"memory-module-v1:id=19:class-storage-first",
                                 "memory-module-v1:id=20:class-storage-second"};
    char error[512] = {0};
    for (uint32_t i = 0; i < 2; i++) {
        XiFunc *root = xi_func_new(i ? "second" : "first", &scalar_unit);
        XiBlock *entry = root ? xi_block_new(root) : NULL;
        XiModule *module = root ? xi_module_new(identities[i], root->name, root) : NULL;
        REQUIRE(root && entry && module && xi_module_set_identity(module, identities[i]));
        roots[i] = root;
        root->module = module;
        ...
        module->nclasses = 1;
        XiValue *object = xi_value_new(root, entry, XI_CLASS_CREATE, &class_object, 0);
        XiValue *store = xi_value_new(root, entry, XI_SET_SHARED, &scalar_unit, 1);
        REQUIRE(object && store);
        object->aux = &declaration;
        store->args[0] = object;
        store->aux_int = 0;
        XiValue *prefix = xi_const_str(root, entry, "module ", &scalar_string);
        XiValue *suffix = xi_const_str(root, entry, i ? "second" : "first", &scalar_string);
        XiValue *concat = xi_value_new(root, entry, XI_STR_CONCAT, &scalar_string, 2);
        XiValue *text_store = xi_value_new(root, entry, XI_SET_SHARED, &scalar_unit, 1);
        XiValue *text_load = xi_value_new(root, entry, XI_GET_SHARED, &scalar_string, 0);
        XiValue *print = fixture_print(root, entry);
        REQUIRE(prefix && suffix && concat && text_store && text_load && print);
        concat->args[0] = prefix;
        concat->args[1] = suffix;
        text_store->args[0] = concat;
        text_store->aux_int = text_load->aux_int = 1;
        print->args[0] = text_load;
        XiValue *builder = xi_value_new(root, entry, XI_CALL_BUILTIN, &stringbuilder_type, 0);
        XiValue *drop_builder = xi_value_new(root, entry, XI_RELEASE, &scalar_unit, 1);
        REQUIRE(builder && drop_builder);
        builder->aux = (void *) "StringBuilder";
        drop_builder->args[0] = builder;
        root->nshared = 2;
        xi_block_set_return(entry, NULL);
        add_owned_class_parameter_cleanup(root, &instance_type, &stringbuilder_type, &releases[i],
                                            &native_scalars[i]);
        REQUIRE(build_fixture_semantic_plan_and_attach(root, error, sizeof(error)));
        semantics[i] = root->semantic_plan;
        values[i] = xr_semantic_plan_operation(semantics[i], 0)->result_value;
    }
    REQUIRE(values[0] == values[1]);
    XrTargetProfile *profile = build_target_profile();
    XrTargetPlan *target = NULL;
    REQUIRE(xr_target_plan_build_program_module_set(semantics, 2, semantics[0], profile, &target,
                                                      error, sizeof(error)));
    check_representation_batch_ownership(target, semantics, roots, releases[1], native_scalars[1]);
    REQUIRE(target->module_partitions_count == 2 &&
            target->module_partitions[1].functions_begin != 0);
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    for (uint32_t i = 0; i < 2; i++) {
        XrAotRefinementPlan *plan = NULL;
        bool built = xr_aot_representation_refinement_build_from_authority(target, semantics[i],
                                                                           &policy, &plan, &diag);
        if (!built)
            fprintf(stderr, "class module %u refinement failed: issue=%u value=%u operation=%u\n",
                    i, (unsigned) diag.issue, diag.semantic_value, diag.semantic_operation);
        REQUIRE(built && plan);
        XrAotRefinementPlanView view = xr_aot_refinement_plan_view(plan);
        xi_opt_refresh_representations_with_policy(roots[i], &policy);
        REQUIRE(
            xr_aot_representation_materialization_verify(&view, roots[i], target, &policy, &diag));
        XiValue *saved_owner = releases[i]->args[0];
        releases[i]->args[0] = native_scalars[i];
        REQUIRE(
            !xr_aot_representation_materialization_verify(&view, roots[i], target, &policy, &diag));
        releases[i]->args[0] = saved_owner;
        REQUIRE(
            xr_aot_representation_materialization_verify(&view, roots[i], target, &policy, &diag));
        xr_aot_refinement_plan_free(plan);
    }
    const XrTargetValueRepRecord *binding =
        xr_target_plan_value_rep_for_module(target, 1, values[1]);
    REQUIRE(binding && binding->slot < target->slots_count);
    XrTargetSlotRecord *slot = &target->slots[binding->slot];
    uint32_t saved_function = slot->function;
    XrFingerprint saved_fingerprint = target->fingerprint;
    slot->function = target->module_partitions[0].functions_begin;
    xr_target_plan_compute_fingerprint(target, &target->fingerprint);
    XrAotRefinementPlan *rejected = NULL;
    REQUIRE(!xr_aot_representation_refinement_build_from_authority(target, semantics[1], &policy,
                                                                   &rejected, &diag));
    ...
    target->fingerprint = saved_fingerprint;
    REQUIRE(xr_target_plan_verify(target, error, sizeof(error)));
    uint32_t saved_layout_begin = target->module_partitions[1].layouts_begin;
    REQUIRE(saved_layout_begin != target->module_partitions[0].layouts_begin);
    target->module_partitions[1].layouts_begin = target->module_partitions[0].layouts_begin;
    xr_target_plan_compute_fingerprint(target, &target->fingerprint);
    REQUIRE(!xr_aot_representation_refinement_build_from_authority(target, semantics[1], &policy,
                                                                   &rejected, &diag));
    REQUIRE(!rejected && diag.issue == XR_AOT_REFINEMENT_PLAN_STATE);
    target->module_partitions[1].layouts_begin = saved_layout_begin;
    target->fingerprint = saved_fingerprint;
    REQUIRE(xr_target_plan_verify(target, error, sizeof(error)));
    xr_target_plan_free(target);
    xr_target_profile_free(profile);
...
static void test_named_aggregate_emission_is_exact_and_fail_closed(void) {
    ...
    XiModule *module =
        xi_module_new("named_aggregate_emission.xr", "named_aggregate_emission", function);
    REQUIRE(module != NULL);
    function->module = module;
    module->classes = (XiClassData **) xr_malloc(sizeof(*module->classes));
    ...
    XiValue *class_store = xi_value_new(function, entry, XI_SET_SHARED, &scalar_unit, 1);
    XiValue *class_load = xi_value_new(function, entry, XI_GET_SHARED, &class_object, 0);
    XiValue *aggregate = xi_value_new(function, entry, XI_AGG_NEW, &named_type, 1);
    ...
    uint32_t semantic_function = XR_SEMANTIC_INDEX_NONE;
    uint32_t semantic_value = XR_SEMANTIC_INDEX_NONE;
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, aggregate, &semantic_function,
                                            &semantic_value, error, sizeof(error)));
    XrFingerprint profile_fingerprint = xr_target_profile_fingerprint(profile);
    XrCEmissionPlan *emission = NULL;
    REQUIRE(xr_c_emission_plan_build(target, xr_target_plan_semantic_plan(target),
    ...
    REQUIRE(view.rep == XR_C_VALUE_REP_AGGREGATE &&
            ...
            view.address_projection == XR_C_ADDRESS_PROJECTION_NAMED_AGGREGATE &&
            view.materialization == XR_C_VALUE_MATERIALIZATION_NONE && view.c_type &&
            view.c_type[0]);
...
static void test_scalar_addressable_alias_recipe_is_exact_and_fail_closed(void) {
    XiFunc *function = xi_func_new("scalar_addressable_alias_recipe", &scalar_int);
    REQUIRE(function != NULL);
    XiBlock *entry = xi_block_new(function);
    REQUIRE(entry != NULL);
    function->nparams = 1;
    ...
    XiValue *alias = xi_value_new(function, entry, XI_UNBOX, &scalar_int, 1);
    XiValue *place = xi_value_new(function, entry, XI_LOCAL_ADDR, &scalar_int, 1);
    XiValue *load = xi_value_new(function, entry, XI_PLACE_LOAD, &scalar_int, 1);
    ...
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, source, &semantic_function,
                                            &source_value, error, sizeof(error)));
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, alias, &semantic_function,
                                            &alias_value, error, sizeof(error)));

    const XrTargetValueRepRecord *source_binding = xr_target_plan_value_rep(target, source_value);
    const XrTargetValueRepRecord *alias_binding = xr_target_plan_value_rep(target, alias_value);
    ...
    REQUIRE(view.materialization == XR_C_VALUE_MATERIALIZATION_SCALAR_ADDRESSABLE_ALIAS &&
            view.recipe_operand_value == source_value && view.recipe_argument_value == UINT32_MAX &&
            view.recipe_symbol == NULL && view.rep == XR_C_VALUE_REP_I64);
...
static void test_direct_local_tagged_ref_parameter_index_is_exact_and_fail_closed(void) {
    XiFunc *function = xi_func_new("direct_local_tagged_ref_parameter_index", &scalar_unit);
    REQUIRE(function != NULL);
    XiBlock *entry = xi_block_new(function);
    REQUIRE(entry != NULL);
    XiValue *parameter = xi_param(function, entry, 0, &direct_local_byte_array);
    REQUIRE(parameter != NULL);
    ...
    write->args[2] = element;
    xi_block_set_return(entry, NULL);
    XiModule *module = xi_module_new("fixtures/direct_local_tagged_ref_parameter.xr",
                                     "direct_local_tagged_ref_parameter", function);
    REQUIRE(module != NULL);
    REQUIRE(xi_module_set_identity(module, "memory-module-v1:id=23:tagged-ref-parameter-v1"));
    function->module = module;
    ...
    const XrTargetValueRepRecord *binding = xr_target_plan_value_rep(target, parameter_value);
    REQUIRE(binding && binding->slot < target->slots_count &&
            target->machine_reps[binding->register_rep].kind == XR_MACHINE_REP_RAW_PTR &&
            target->machine_reps[binding->memory_rep].kind == XR_MACHINE_REP_RAW_PTR &&
            target->slots[binding->slot].role == XR_TARGET_SLOT_PARAMETER &&
            target->slots[binding->slot].root_kind == XR_TARGET_ROOT_NONE &&
            target->slots[binding->slot].ownership == XR_TARGET_OWNERSHIP_BORROWED);
    ...
    REQUIRE(xr_c_emission_plan_build(target, xr_target_plan_semantic_plan(target),
                                     profile_fingerprint, &emission, error, sizeof(error)));
    XrCValueEmissionView parameter_view = {0};
    REQUIRE(xr_c_emission_plan_value_view(emission, parameter_value, &parameter_view, error,
                                          sizeof(error)) &&
            parameter_view.materialization ==
                XR_C_VALUE_MATERIALIZATION_DIRECT_LOCAL_TAGGED_REF_PARAMETER &&
            parameter_view.rep == XR_C_VALUE_REP_RAW_PTR &&
            strcmp(parameter_view.c_type, "XrValue *") == 0);
...
static void test_enum_descriptor_adapter_refuses_without_layout_family(void) {
    ...
    REQUIRE(xr_aot_refinement_try_representation_adapter(builder, &protocol, fixture.target_plan,
                                                         &request, &decision, &diag));
    REQUIRE(decision == XR_AOT_REFINEMENT_REFUSED);
    REQUIRE(diag.issue == XR_AOT_REFINEMENT_REPRESENTATION_SCHEMA_UNAVAILABLE);
    xr_aot_refinement_builder_free(builder);
...
static void test_tagged_string_array_copy_refinement_is_exact(void) {
    ...
    char error[512] = {0};
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, copy, &semantic_function, &copy_value,
                                            error, sizeof(error)));
    ...
    REQUIRE(layout_index != XR_SEMANTIC_INDEX_NONE &&
            ...
            target->layouts[layout_index].array_element_storage == XR_TARGET_ARRAY_STORAGE_TAGGED);
    ...
    xi_opt_refresh_representations_with_policy(function, &policy);
    REQUIRE(xr_aot_representation_materialization_verify(&refinement_view, function, target,
                                                         &policy, &diag));
...
static void check_array_allocation_storage_is_exact_and_fail_closed(XrType *array_type,
    ...
    if (tagged_element) {
        ...
        XiValue *index = xi_const_int(function, entry, 0, &scalar_int);
        XiValue *element = xi_const_int(function, entry, 7, element_type);
        XiValue *write = xi_value_new(function, entry, XI_INDEX_SET, &scalar_unit, 3);
        XiValue *read = xi_value_new(function, entry, XI_INDEX_GET, element_type, 2);
        REQUIRE(index && element && write && read);
        write->args[0] = array;
        write->args[1] = index;
        write->args[2] = element;
        read->args[0] = array;
    ...
    char error[512] = {0};
    REQUIRE(xr_aot_scalar_semantic_value_id(target, function, array, &semantic_function,
                                            &array_value, error, sizeof(error)));
    const XrTargetValueRepRecord *binding = xr_target_plan_value_rep(target, array_value);
    const XrSemanticOperationRecord *operation = NULL;
    uint32_t operation_index = XR_SEMANTIC_INDEX_NONE;
    for (uint32_t i = 0; i < (uint32_t) xr_semantic_plan_operation_count(semantic); i++) {
        const XrSemanticOperationRecord *candidate = xr_semantic_plan_operation(semantic, i);
    ...
    REQUIRE(layout_index != XR_SEMANTIC_INDEX_NONE &&
            target->layouts[layout_index].kind == XR_TARGET_LAYOUT_DYNAMIC &&
            target->layouts[layout_index].array_element_storage == target_storage);

    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *refinement = NULL;
    if (!xr_aot_representation_refinement_build_from_authority(
            target, xr_target_plan_semantic_plan(target), &policy, &refinement, &diag)) {
        fprintf(stderr, "Array allocation refinement failed: kind=%u issue=%s value=%u op=%u\n",
                element_type->kind, xr_aot_refinement_issue_name(diag.issue), diag.semantic_value,
                diag.semantic_operation);
        abort();
    }
    ...
    REQUIRE(xr_c_emission_plan_value_view(emission, array_value, &view, error, sizeof(error)) &&
            ...
            view.recipe_operand_value != UINT32_MAX && view.recipe_argument_value == UINT32_MAX &&
            view.recipe_discriminant == target_storage && view.recipe_symbol &&
    ...
    REQUIRE(!xr_c_emission_plan_verify(emission, target, xr_target_plan_semantic_plan(target),
                                       xr_target_profile_fingerprint(profile), error,
                                       sizeof(error)));
    emission->values[emission_index].recipe_discriminant = target_storage;
    REQUIRE(xr_c_emission_plan_verify(emission, target, xr_target_plan_semantic_plan(target),
                                      xr_target_profile_fingerprint(profile), error,
                                      sizeof(error)));
    xr_c_emission_plan_free(emission);
    ...
    target->layouts[layout_index].array_element_storage = XR_TARGET_ARRAY_STORAGE_I64;
    xr_target_layout_compute_fingerprint(target, layout_index,
                                         &target->layouts[layout_index].fingerprint);
    xr_target_plan_compute_fingerprint(target, &target->fingerprint);
    REQUIRE(!xr_target_plan_verify(target, error, sizeof(error)) &&
...
static void test_array_allocation_storage_is_exact_and_fail_closed(void) {
...
static void test_array_parameter_storage_includes_variadic_carriers(void) {
    static XrType element = {
        .kind = XR_KIND_FLOAT,
        .id = 9211,
        .frozen = true,
        .scalar_rep = XR_NATIVE_F64,
    ...
    static XrType array = {
        ...
        .frozen = true,
        .scalar_rep = XR_SCALAR_REP_NONE,
        .container = {.element_type = &element},
    };
    for (unsigned combination = 0; combination < 4; ++combination) {
        bool variadic = (combination & 1u) != 0;
        bool owns = (combination & 2u) != 0;
        XiFunc *function = xi_func_new("array_parameter_storage", &element);
        XiBlock *entry = function ? xi_block_new(function) : NULL;
        XiValue *parameter = entry ? xi_param(function, entry, 0, &array) : NULL;
        REQUIRE(function && entry && parameter);
        function->nparams = function->min_params = variadic ? 0 : 1;
        function->is_vararg = variadic != 0;
        function->params = xr_calloc(1u, sizeof(*function->params));
        REQUIRE(function->params);
        function->params[0] = parameter;
        function->arc_borrow_sig = xi_func_arena_alloc(function, sizeof(*function->arc_borrow_sig));
        REQUIRE(function->arc_borrow_sig);
        *function->arc_borrow_sig = (XiBorrowSig) {.nparams = 1, .valid = true};
        function->arc_borrow_sig->param_own[0] = owns ? XI_OWN_OWNED : XI_OWN_BORROWED;
        XiValue *index = xi_const_int(function, entry, 0, &scalar_int);
        XiValue *read = xi_value_new(function, entry, XI_INDEX_GET, &element, 2);
        REQUIRE(index && read);
        read->args[0] = parameter;
        read->args[1] = index;
        if (owns) {
        ...
        XrTargetPlan *target = build_attached_target_plan(function, &profile);
        const XrSemanticPlan *semantic = xr_target_plan_semantic_plan(target);
        const XrSemanticParameterRecord *formal = xr_semantic_plan_parameter(semantic, 0);
        REQUIRE(formal && ((formal->flags & XR_SEM_PARAMETER_VARIADIC) != 0) == (variadic != 0));
        XrSemanticParameterRecord corrupt = *formal;
        corrupt.flags = XR_SEM_PARAMETER_VARIADIC | XR_SEM_PARAMETER_REQUIRED;
        REQUIRE(!xr_semantic_direct_local_reference_parameter_is_exact(semantic, &corrupt, NULL));
        corrupt = *formal;
        corrupt.flags = XR_SEM_PARAMETER_VARIADIC;
        corrupt.ordinal = 1;
        REQUIRE(!xr_semantic_direct_local_reference_parameter_is_exact(semantic, &corrupt, NULL));
        corrupt = *formal;
        corrupt.mode = XR_PARAM_REF;
        REQUIRE(!xr_semantic_direct_local_reference_parameter_is_exact(semantic, &corrupt, NULL));
        corrupt = *formal;
...
static void test_array_intrinsic_index_storage_is_exact_and_fail_closed(void) {
    ...
    XiValue *array = xi_value_new(function, entry, XI_CALL_BUILTIN, &direct_local_int_array, 2);
    ...
    REQUIRE(array_operation != XR_SEMANTIC_INDEX_NONE &&
            write_operation != XR_SEMANTIC_INDEX_NONE && read_value != XR_SEMANTIC_INDEX_NONE);
    ...
    uint32_t index_value = semantic_operands[write_semantic->operand_begin + 1u].value;
    uint32_t element_value = semantic_operands[write_semantic->operand_begin + 2u].value;
    const XrTargetValueRepRecord *array_binding =
        xr_target_plan_value_rep(target, array_semantic->result_value);
    const XrTargetValueRepRecord *read_binding = xr_target_plan_value_rep(target, read_value);
    REQUIRE(array_binding && read_binding &&
            target->machine_reps[array_binding->register_rep].kind == XR_MACHINE_REP_DYN_VALUE &&
            target->machine_reps[array_binding->register_rep].ownership ==
                XR_TARGET_OWNERSHIP_OWNED &&
            target->machine_reps[read_binding->register_rep].kind == XR_MACHINE_REP_I64);
    ...
    REQUIRE(index_identity && semantic_function && index_identity->source_value == index_value &&
            ...
            xr_stable_id_equal(index_identity->source_function_id, semantic_function->id) &&
            xr_stable_id_equal(index_identity->use_operation_id, write_semantic->id) &&
            index_identity->use_operation == write_operation && index_identity->use_operand == 1u &&
            ...
            target->machine_reps[index_identity->target_register_rep].kind == XR_MACHINE_REP_I64 &&
            target->machine_reps[index_identity->target_memory_rep].kind == XR_MACHINE_REP_I64);
    ...
    REQUIRE(xr_c_emission_plan_value_view(emission, array_semantic->result_value, &array_view,
                                          error, sizeof(error)) &&
            xr_c_emission_plan_value_view(emission, read_value, &read_view, error, sizeof(error)) &&
            array_view.rep == XR_C_VALUE_REP_TAGGED &&
            array_view.materialization == XR_C_VALUE_MATERIALIZATION_ARRAY_FILLED_NEW &&
    ...
    XrFingerprint saved_plan_fingerprint = target->fingerprint;
    target->calls[intrinsic_call_index].array_element_storage = XR_TARGET_ARRAY_STORAGE_U8;
    xr_target_call_compute_fingerprint(target, intrinsic_call_index,
...
static void test_array_fill_scalar_authority_is_exact_and_fail_closed(void) {
    ...
    XiValue *array = xi_value_new(function, entry, XI_ARRAY_NEW, &direct_local_int_array, 1);
    XiValue *fill = xi_const_int(function, entry, 6, &scalar_int);
    XiValue *filled = xi_value_new(function, entry, XI_CALL_METHOD, &direct_local_int_array, 2);
    XiValue *index = xi_const_int(function, entry, 0, &scalar_int);
    XiValue *read = xi_value_new(function, entry, XI_INDEX_GET, &scalar_int, 2);
    XiValue *release = xi_value_new(function, entry, XI_RELEASE, &scalar_unit, 1);
    ...
    for (uint32_t i = 0; i < (uint32_t) xr_semantic_plan_operation_count(semantic); i++) {
        const XrSemanticOperationRecord *operation = xr_semantic_plan_operation(semantic, i);
        if (operation && operation->intrinsic_kind == XR_SEM_INTRINSIC_ARRAY_FILL_SCALAR) {
    ...
    REQUIRE(fill_semantic && fill_operation != XR_SEMANTIC_INDEX_NONE &&
            fill_semantic->opcode == XI_CALL_METHOD && fill_semantic->operand_count == 2 &&
    ...
    REQUIRE(call->calling_convention == XR_TARGET_CALL_CONVENTION_ARRAY_FILL_SCALAR &&
            ...
            target->call_arguments[call->argument_begin].ownership == XR_TARGET_CALL_BORROW &&
            target->call_arguments[call->argument_begin + 1u].ordinal == 1 &&
            target->call_arguments[call->argument_begin + 1u].ownership == XR_TARGET_CALL_CONSUME);
    ...
    REQUIRE(xr_c_emission_plan_value_view(emission, fill_semantic->result_value, &fill_view, error,
            ...
            fill_view.materialization == XR_C_VALUE_MATERIALIZATION_ARRAY_FILL_SCALAR &&
    ...
    xr_target_call_compute_fingerprint(target, call_index, &call->fingerprint);
    xr_target_plan_compute_fingerprint(target, &target->fingerprint);
    REQUIRE(!xr_target_plan_verify(target, error, sizeof(error)) &&
            strstr(error, "XR_TARGET_1003") != NULL);
    refinement = NULL;
...
static void test_scalar_array_range_fill_refinement_is_exact_and_fail_closed(void) {
    XiFunc *function = xi_func_new("scalar_array_range_fill_refinement", &scalar_int);
    REQUIRE(function != NULL);
    XiBlock *entry = xi_block_new(function);
    REQUIRE(entry != NULL);
    XiValue *count = xi_const_int(function, entry, 6, &scalar_int);
    XiValue *array = xi_value_new(function, entry, XI_ARRAY_NEW, &direct_local_int_array, 1);
    XiValue *element = xi_const_int(function, entry, 9, &scalar_int);
    XiValue *start = xi_const_int(function, entry, 2, &scalar_int);
    XiValue *end = xi_const_int(function, entry, 5, &scalar_int);
    XiValue *fill = xi_value_new(function, entry, XI_CALL_METHOD, &direct_local_int_array, 4);
    XiValue *index = xi_const_int(function, entry, 3, &scalar_int);
    XiValue *read = xi_value_new(function, entry, XI_INDEX_GET, &scalar_int, 2);
    XiValue *release = xi_value_new(function, entry, XI_RELEASE, &scalar_unit, 1);
    REQUIRE(count && array && element && start && end && fill && index && read && release);
    array->args[0] = count;
    array->array_element_storage = XR_ELEM_I64;
    fill->args[0] = array;
    fill->args[1] = element;
    ...
    REQUIRE(operation != NULL && operation->opcode == XI_CALL_METHOD &&
    ...
    REQUIRE(result && result->slot < target->slots_count &&
            target->machine_reps[result->register_rep].kind == XR_MACHINE_REP_DYN_VALUE &&
            target->machine_reps[result->memory_rep].kind == XR_MACHINE_REP_DYN_VALUE &&
            target->slots[result->slot].root_kind == XR_TARGET_ROOT_DYNAMIC &&
            target->slots[result->slot].ownership == XR_TARGET_OWNERSHIP_OWNED);
    bool exact_layout = false;
    for (uint32_t i = 0; i < target->layouts_count; i++)
        if (target->layouts[i].semantic_type == operation->result_type) {
            REQUIRE(!exact_layout);
            exact_layout = target->layouts[i].kind == XR_TARGET_LAYOUT_DYNAMIC &&
                           target->layouts[i].array_element_storage == XR_TARGET_ARRAY_STORAGE_I64;
        }
    REQUIRE(exact_layout);
    ...
    REQUIRE(view.frozen && view.verified && view.record_count == 0);
    xi_opt_refresh_representations_with_policy(function, &policy);
    REQUIRE(array->rep == XR_REP_TAGGED && element->rep == XR_REP_I64 && start->rep == XR_REP_I64 &&
            end->rep == XR_REP_I64 && fill->rep == XR_REP_TAGGED &&
            xr_aot_representation_materialization_verify(&view, function, target, &policy, &diag));
...
static void check_imported_class_field_store(bool owned_string) {
    XiFunc *roots[2] = {xi_func_new("field_owner", &scalar_unit),
                        xi_func_new("field_writer", &scalar_unit)};
    XiModule *modules[2] = {0};
    const char *identities[2] = {"memory-module-v1:id=11:field-owner",
                                 "memory-module-v1:id=12:field-writer"};
    XiClassData declaration = {.class_info = &source_fill_class_info,
                               .class_name = "FinalRefinementWorker",
                               .explicit_final = true,
                               .needs_runtime_type = true};
    for (uint32_t i = 0; i < 2; i++) {
        REQUIRE(roots[i]);
        modules[i] = xi_module_new(identities[i], roots[i]->name, roots[i]);
        REQUIRE(modules[i] && xi_module_set_identity(modules[i], identities[i]));
        roots[i]->module = modules[i];
        roots[i]->is_module_initializer = true;
        roots[i]->stage = XI_STAGE_OPTIMIZED;
    }
    modules[0]->classes = (XiClassData **) xr_malloc(sizeof(*modules[0]->classes));
    REQUIRE(modules[0]->classes);
    modules[0]->classes[0] = &declaration;
    modules[0]->nclasses = 1;
    XiBlock *owner_entry = xi_block_new(roots[0]);
    XiBlock *writer_entry = xi_block_new(roots[1]);
    REQUIRE(owner_entry && writer_entry);
    xi_block_set_return(owner_entry, NULL);
    XiFunc *writer = roots[1];
    writer->nparams = writer->min_params = owned_string ? 2 : 1;
    writer->params = (XiValue **) xr_calloc(writer->nparams, sizeof(*writer->params));
    REQUIRE(writer->params);
    writer->params[0] = xi_param(writer, writer_entry, 0, &source_fill_instance);
    writer->arc_borrow_sig =
        (XiBorrowSig *) xi_func_arena_alloc(writer, (uint32_t) sizeof(*writer->arc_borrow_sig));
    REQUIRE(writer->params[0] && writer->arc_borrow_sig);
    writer->arc_borrow_sig->nparams = writer->nparams;
    writer->arc_borrow_sig->param_own[0] = XI_OWN_BORROWED;
    writer->arc_borrow_sig->valid = true;
    XiValue *value = owned_string ? xi_param(writer, writer_entry, 1, &scalar_string)
                                 : xi_const_int(writer, writer_entry, 37, &scalar_int);
    if (owned_string) {
        writer->params[1] = value;
        writer->arc_borrow_sig->param_own[1] = XI_OWN_OWNED;
    }
    XiValue *store = xi_value_new(writer, writer_entry, XI_STORE_FIELD, &scalar_unit, 2);
    REQUIRE(value && store);
    store->args[0] = writer->params[0];
    store->args[1] = value;
    store->aux = (void *) "value";
    if (owned_string) {
        XiValue *read = xi_value_new(writer, writer_entry, XI_LOAD_FIELD, &scalar_string, 1);
        XiValue *length = xi_value_new(writer, writer_entry, XI_LEN, &scalar_int, 1);
        REQUIRE(read && length);
        read->args[0] = writer->params[0];
        read->aux = (void *) "value";
        read->xg_class_field_id = 47;
        length->args[0] = read;
    }
    xi_block_set_return(writer_entry, NULL);
    char error[512] = {0};
    REQUIRE(build_fixture_semantic_plan_and_attach(roots[0], error, sizeof(error)));
    bool semantic_built =
        xr_semantic_plan_build_and_attach_module_set(writer, modules, 1, error, sizeof(error));
    if (!semantic_built)
        fprintf(stderr, "imported field semantic fixture: %s\n", error);
    REQUIRE(semantic_built);
    const XrSemanticPlan *semantics[2] = {roots[0]->semantic_plan, writer->semantic_plan};
    const XrSemanticParameterRecord *parameter = xr_semantic_plan_parameter(semantics[1], 0);
    const XrSemanticTypeRecord *type = xr_semantic_plan_type(semantics[1], parameter->type);
    REQUIRE(xr_semantic_external_class_instance_type_is_exact(type));
    REQUIRE(xr_stable_id_equal(type->source_class_identity,
                               xr_semantic_plan_source_class(semantics[0], 0)->id));
    const XrSemanticOperationRecord *write = NULL;
    for (uint32_t i = 0; i < xr_semantic_plan_operation_count(semantics[1]); i++) {
        const XrSemanticOperationRecord *candidate = xr_semantic_plan_operation(semantics[1], i);
        if (candidate->opcode == XI_STORE_FIELD)
            write = candidate;
        if (candidate->opcode == XI_LOAD_FIELD) {
            REQUIRE(xr_semantic_source_class_field_read_shape_is_exact(semantics[1], candidate));
            REQUIRE(!xr_semantic_source_class_field_read_is_exact(semantics[1], candidate, NULL));
            XrSemanticOperationRecord *mutable_read = &writer->semantic_plan->operations[i];
            XrSemanticOperationRecord saved_read = *mutable_read;
            mutable_read->evidence[5] = 0;
            REQUIRE(!xr_semantic_source_class_field_read_shape_is_exact(semantics[1], mutable_read));
            *mutable_read = saved_read;
            mutable_read->result_ownership = XI_GEN_RESULT_OWNERSHIP_OWNED;
            REQUIRE(!xr_semantic_source_class_field_read_shape_is_exact(semantics[1], mutable_read));
            *mutable_read = saved_read;
            REQUIRE(xr_semantic_source_class_field_read_shape_is_exact(semantics[1], mutable_read));
        }
    }
    REQUIRE(write && xr_semantic_class_field_store_receiver_is_exact(semantics[1], write));
    XrSemanticOperationRecord forged = *write;
    forged.effects = 0;
    REQUIRE(!xr_semantic_class_field_store_receiver_is_exact(semantics[1], &forged));
    XrSemanticPlan *mutable_semantic = writer->semantic_plan;
    XrSemanticOperandRecord *receiver = &mutable_semantic->operands[write->operand_begin];
    XrSemanticOperandRecord *stored = receiver + 1;
    uint8_t saved = receiver->ownership_action;
    receiver->ownership_action = XR_SEM_OPERAND_CONSUME;
    REQUIRE(!xr_semantic_class_field_store_receiver_is_exact(semantics[1], write));
    receiver->ownership_action = saved;
    saved = stored->ownership_action;
    stored->ownership_action = XR_SEM_OPERAND_BORROW;
    REQUIRE(!xr_semantic_class_field_store_receiver_is_exact(semantics[1], write));
    stored->ownership_action = saved;
    XrTargetProfile *profile = build_target_profile();
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    for (uint32_t include_owner = 0; include_owner < 2; include_owner++) {
        XrTargetPlan *target = NULL;
        const XrSemanticPlan *const *selected = include_owner ? semantics : &semantics[1];
        bool target_built = xr_target_plan_build_program_module_set(
            selected, include_owner + 1u, semantics[1], profile, &target, error, sizeof(error));
        if (!target_built)
            fprintf(stderr, "field-store target owner=%u: %s\n", include_owner, error);
        REQUIRE(target_built);
        REQUIRE(xr_target_plan_verify(target, error, sizeof(error)));
        XrAotRefinementPlan *plan = NULL;
        XrAotRefinementDiagnostic diag = {0};
        bool built = xr_aot_representation_refinement_build_from_authority(target, semantics[1],
                                                                           &policy, &plan, &diag);
        if (include_owner) {
            REQUIRE(built && plan);
        } else {
...
static void test_imported_class_field_store_is_exact_and_fail_closed(void) {
    check_imported_class_field_store(false);
    check_imported_class_field_store(true);
}
...
static void test_source_class_array_fill_refinement_is_exact_and_fail_closed(void) {
    ...
    REQUIRE(module != NULL &&
            xi_module_set_identity(module,
                                   "memory-module-v1:id=37:source-class-array-fill-refinement-v1"));
    function->module = module;
    XiClassData declaration = {
    ...
    for (uint16_t ordinal = 0; ordinal < 4; ordinal++) {
        ...
        REQUIRE(argument->ordinal == ordinal &&
                argument->semantic_value == operands[operation->operand_begin + ordinal].value &&
                argument->ownership ==
...
static XrTargetPlan *build_array_hof_refinement_fixture(uint8_t kind, XiFunc **out_function,
    ...
    XiFunc *root = xi_func_new(reduce   ? "array_hof_reduce_refinement"
                               ...
                               &scalar_int);
    XiFunc *callback = xi_func_new("array_hof_refinement_callback", callback_result);
    ...
    callback->params = (XiValue **) xr_calloc(callback->nparams, sizeof(*callback->params));
    REQUIRE(callback->params != NULL);
    for (uint16_t i = 0; i < callback->nparams; i++) {
        callback->params[i] = xi_param(callback, callback_entry, i, &scalar_int);
        REQUIRE(callback->params[i] != NULL);
    }
    if (filter) {
        XiValue *accepted = xi_const_bool(callback, callback_entry, true, &scalar_bool);
        REQUIRE(accepted != NULL);
        xi_block_set_return(callback_entry, accepted);
    } else if (reduce) {
        XiValue *sum = xi_value_new(callback, callback_entry, XI_ADD, &scalar_int, 2);
        REQUIRE(sum != NULL);
    ...
    XiValue *array = xi_value_new(root, entry, XI_ARRAY_NEW, &direct_local_int_array, 1);
    XiValue *closure = xi_value_new(root, entry, XI_CLOSURE_NEW, callback_type, 0);
    XiValue *initial = reduce ? xi_const_int(root, entry, 0, &scalar_int) : NULL;
    XiValue *hof = xi_value_new(root, entry, XI_CALL_METHOD,
                                reduce ? &scalar_int : &direct_local_int_array, reduce ? 3 : 2);
    ...
    if (!reduce) {
        ...
        XiValue *length = xi_value_new(root, entry, XI_LEN, &scalar_int, 1);
        XiValue *index = xi_const_int(root, entry, 0, &scalar_int);
        XiValue *element = xi_value_new(root, entry, XI_INDEX_GET, &scalar_int, 2);
        nonreduce_result = xi_value_new(root, entry, XI_ADD, &scalar_int, 2);
        XiValue *release_result = xi_value_new(root, entry, XI_RELEASE, &scalar_unit, 1);
        REQUIRE(length && index && element && nonreduce_result && release_result);
        length->args[0] = hof;
        element->args[0] = hof;
    ...
    XiValue *release_array = xi_value_new(root, entry, XI_RELEASE, &scalar_unit, 1);
...
static void test_array_hof_refinement_is_exact_and_fail_closed(void) {
    for (uint8_t kind = XR_TARGET_ARRAY_HOF_MAP; kind <= XR_TARGET_ARRAY_HOF_REDUCE; kind++) {
        XiFunc *function = NULL;
        XrTargetProfile *profile = NULL;
        XrTargetPlan *target = build_array_hof_refinement_fixture(kind, &function, &profile);
        const XrSemanticPlan *semantic = xr_target_plan_semantic_plan(target);
        uint32_t operation_index = XR_SEMANTIC_INDEX_NONE;
        const XrSemanticOperationRecord *operation = NULL;
        for (uint32_t i = 0; i < (uint32_t) xr_semantic_plan_operation_count(semantic); i++) {
            const XrSemanticOperationRecord *candidate = xr_semantic_plan_operation(semantic, i);
            if (candidate && candidate->intrinsic_kind == XR_SEM_INTRINSIC_ARRAY_HOF) {
                REQUIRE(operation == NULL);
                operation = candidate;
                operation_index = i;
            }
        ...
        REQUIRE(call->array_hof_kind == kind &&
                ...
                call->argument_count == (kind == XR_TARGET_ARRAY_HOF_REDUCE ? 3 : 2));
        ...
        const XrTargetValueRepRecord *callback_binding =
            xr_target_plan_value_rep(target, callback_argument->semantic_value);
        const XrTargetValueRepRecord *result_binding =
            xr_target_plan_value_rep(target, operation->result_value);
        REQUIRE(callback_binding && result_binding &&
                target->machine_reps[callback_binding->register_rep].kind ==
                    XR_MACHINE_REP_DYN_VALUE &&
                target->slots[callback_binding->slot].root_kind == XR_TARGET_ROOT_DYNAMIC &&
                target->slots[callback_binding->slot].ownership == XR_TARGET_OWNERSHIP_OWNED);
        if (kind == XR_TARGET_ARRAY_HOF_REDUCE) {
            REQUIRE(target->machine_reps[result_binding->register_rep].kind == XR_MACHINE_REP_I64 &&
                    target->slots[result_binding->slot].root_kind == XR_TARGET_ROOT_NONE &&
                    target->slots[result_binding->slot].ownership == XR_TARGET_OWNERSHIP_TRIVIAL);
        } else {
            REQUIRE(target->machine_reps[result_binding->register_rep].kind ==
                        XR_MACHINE_REP_DYN_VALUE &&
                    target->slots[result_binding->slot].root_kind == XR_TARGET_ROOT_DYNAMIC &&
                    target->slots[result_binding->slot].ownership == XR_TARGET_OWNERSHIP_OWNED);
        }
        XiRepPolicy policy = xi_rep_policy_native_boundary();
        XrAotRefinementDiagnostic diag = {0};
        XrAotRefinementPlan *refinement = NULL;
        ...
        if (kind == XR_TARGET_ARRAY_HOF_MAP) {
            ...
            *callback_argument = saved_argument;
            ...
            XrTargetSlotRecord saved_slot = target->slots[result_binding->slot];
            target->slots[result_binding->slot].root_kind = XR_TARGET_ROOT_NONE;
            xr_target_plan_compute_fingerprint(target, &target->fingerprint);
            expect_array_hof_mutation_refused(target, &policy);
...
static void test_string_concat_cleanup_materialization_is_exact(void) {
    XiFunc *function = xi_func_new("string_concat_cleanup_materialization", &scalar_int);
    REQUIRE(function != NULL);
    XiBlock *entry = xi_block_new(function);
    REQUIRE(entry != NULL);
    ...
    XrTargetProfile *profile = NULL;
    XrTargetPlan *target = build_attached_target_plan(function, &profile);
    REQUIRE(target->cleanups_count == 1 && target->cleanups[0].action == XR_TARGET_CLEANUP_RELEASE);
    XiRepPolicy policy = xi_rep_policy_native_boundary();
    XrAotRefinementDiagnostic diag = {0};
    XrAotRefinementPlan *plan = NULL;
    REQUIRE(xr_aot_representation_refinement_build_from_authority(
...
static void test_assertion_plan_and_native_condition_materialization_are_exact(void) {
    ...
    REQUIRE(xr_assertion_plan_build(
                XR_CORE_BUILTIN_ASSERT, 1, source, XR_CORE_INTRINSIC_TARGET_AOT_HOSTED,
                XR_ASSERTION_CAPABILITY_ALL, &assertion_plan) == XR_ASSERTION_PLAN_OK);
...
static XrTargetPlan *build_union_as_conversion_target(uint32_t target_tid, const char *target_name,
                                                      XiFunc **out_function,
                                                      XrTargetProfile **out_profile) {
...
int main(int argc, char **argv) {
    if (argc == 2 && strcmp(argv[1], "imported-class-field-store") == 0) {
        test_imported_class_field_store_is_exact_and_fail_closed();
        puts("Imported class field store tests passed");
        return 0;
    }
    if (argc == 2 && strcmp(argv[1], "module-tagged-storage") == 0) {
        test_tagged_temporary_storage_is_module_scoped();
        puts("Module-scoped tagged storage tests passed");
        return 0;
    }
    ...
    if (argc == 2 && strcmp(argv[1], "native-direct-fresh") == 0) {
        ...
        test_unreachable_native_direct_preserves_frozen_argument_authority();
        puts("Native-direct fresh-result AOT refinement tests passed");
        return 0;
    }
    if (argc == 2 && strcmp(argv[1], "native-yieldable-fresh") == 0) {
        test_native_yieldable_fresh_result_ownership();
        puts("Native-yieldable fresh-result AOT refinement tests passed");
        return 0;
    }
    if (argc == 2 && strcmp(argv[1], "unreachable-native-callee") == 0) {
        test_unreachable_local_callee_preserves_materialized_identity();
        test_unreachable_adapters_follow_closed_program_scope();
    ...
    if (argc == 2 && strcmp(argv[1], "representation-materialization") == 0) {
    ...
    test_representation_build_and_incremental_admission_reject_corrupt_target();
        puts("Representation materialization tests passed");
        return 0;
    }
    if (argc == 2 && strcmp(argv[1], "array-storage") == 0) {
        test_array_parameter_storage_includes_variadic_carriers();
        test_array_allocation_storage_is_exact_and_fail_closed();
        test_array_intrinsic_index_storage_is_exact_and_fail_closed();
        test_scalar_array_range_fill_refinement_is_exact_and_fail_closed();
        test_source_class_array_fill_refinement_is_exact_and_fail_closed();
        puts("Array storage AOT refinement tests passed");
        return 0;
    }
    if (argc != 1) {
    ...
    test_cold_call_result_concat_emission();
    test_emission_literal_identity_is_module_scoped();
    test_scalar_ref_emission_is_module_scoped();
    test_tuple_emission_is_module_scoped();
    test_slice_view_storage_is_module_scoped();
