...
int main(void) { local_cases(fixture_local_entries); numeric_cleanup(fixture_local_entries + 1); phi_cases(fixture_local_entries + 2); puts("Native local ownership passed"); return 0; }
