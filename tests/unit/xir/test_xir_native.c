...
DECLARE(9) DECLARE(10) DECLARE(11) DECLARE(12) DECLARE(13) DECLARE(14) DECLARE(15) DECLARE(16) DECLARE(17) DECLARE(18) DECLARE(19) DECLARE(20) DECLARE(21)
#undef DECLARE
static XrXirRunStatus run(void *owner, uint32_t function, XrXirRunContext *context,
    ...
    const XrXirLeafEntry entries[] = {fixture_f0, fixture_f1, fixture_f2, fixture_f3,
        ...
        fixture_f9, fixture_f10, fixture_f11, fixture_f12, fixture_f13, fixture_f14, fixture_f15, fixture_f16, fixture_f17, fixture_f18, fixture_f19, fixture_f20, fixture_f21};
    (void) owner;
    CHECK(function < 22);
