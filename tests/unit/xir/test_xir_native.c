...
DECLARE(9) DECLARE(10) DECLARE(11) DECLARE(12) DECLARE(13) DECLARE(14) DECLARE(15) DECLARE(16)
#undef DECLARE
static XrXirRunStatus run(void *owner, uint32_t function, XrXirRunContext *context,
    ...
    const XrXirLeafEntry entries[] = {fixture_f0, fixture_f1, fixture_f2, fixture_f3,
        ...
        fixture_f9, fixture_f10, fixture_f11, fixture_f12, fixture_f13, fixture_f14, fixture_f15, fixture_f16};
    (void) owner;
    CHECK(function < 17);
