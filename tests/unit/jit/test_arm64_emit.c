...
static void test_branch(void) {
    ...
    // B +4 (offset 1 instruction) → 0x14000001
    inst = a64_b(1);
    assert(inst == 0x14000001);

    // B.EQ +8 (offset 2 instructions) → 0x54000040
