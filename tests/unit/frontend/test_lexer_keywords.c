...
#define PREFIX_COUNT ((int) (sizeof(kPrefixIdentifiers) / sizeof(kPrefixIdentifiers[0])))
...
TEST(keywords_are_case_sensitive) {
    ...
    static const char *kCaseShifted[] = {
        "Let",    "IF",    "True", "False", "Class", "Fn",
        "Return", "Match", "New",  "Type",  "Const", "Final",
    };
...
TEST(keyword_with_underscore_suffix_is_identifier) {
    ...
    static const char *kUnderscored[] = {
        "if_", "let_",  "for_",   "while_", "match_", "fn_",
        "in_", "true_", "false_", "null_",  "this_",  "super_",
    };
