...
static void test_source_enum_identity_and_mutations(void) {
    ...
    REQUIRE(type != NULL && type->source_enum_key != NULL &&
            strstr(type->source_enum_key,
                   "source-enum-v1:schema=24:owner=13:stdlib/base64:") != NULL &&
            strstr(type->source_enum_key,
...
static void test_typed_entity_identity_table(void) {
    ...
    REQUIRE(strcmp(first_debug_id_hex, "c82c91fc8227ef8c31507c655e0c7553") == 0);
    ...
    REQUIRE(strcmp(loan_id_hex, "156a94cf8265a0c3f9c2b68e649c77be") == 0);
...
static void test_immutable_owned_snapshot(void) {
    ...
    REQUIRE(strcmp(semantic_hex,
                   "b9baaadd76ed8b19d6b22df76d997916c585d963a096c0409196f833575d77d1") == 0);
...
static void test_direct_local_call_target_authority(void) {
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v3:schema=24:operation=") != NULL);
    ...
    REQUIRE(strcmp(target_id_hex, "237600713d805429348b04c60c769756") == 0);
...
static void test_indirect_callable_state_authority(void) {
    ...
    char target_id_hex[XR_STABLE_ID_BYTES * 2 + 1];
    xr_stable_id_hex(target->id, target_id_hex);
    REQUIRE(strcmp(target_id_hex, "8adb8c91d3f768823463845d93d4aaeb") == 0);
...
static void test_source_export_call_target_authority(void) {
    ...
    REQUIRE(strcmp(dependency_id, "1f77f4b52ff8e85df3cc875de0c363d3") == 0);
    REQUIRE(strcmp(export_id, "de322ff6d6dda8f7bda024be7f891b1f") == 0);
    REQUIRE(strcmp(target_id, "3a42f28d7e38703406a966b4b87fc78c") == 0);
...
static void test_native_namespace_yieldable_authority(void) {
    ...
    REQUIRE(target->function == XR_SEMANTIC_INDEX_NONE &&
            ...
            target->source_export == XR_SEMANTIC_INDEX_NONE &&
            target->callable_type == XR_SEMANTIC_INDEX_NONE);
    REQUIRE(strstr(target->canonical_key, "call-target-v5:schema=24:operation=") != NULL);
    REQUIRE(strstr(target->canonical_key, ":native-namespace=time.sleep:kind=5") != NULL);
    char target_id_hex[XR_STABLE_ID_BYTES * 2 + 1];
    xr_stable_id_hex(target->id, target_id_hex);
    REQUIRE(strcmp(target_id_hex, "c32b28e35ab60b30b0c4b031a4fd8e7b") == 0);
    const XrSemanticOperationRecord *import = NULL;
    for (uint32_t i = 0; i < plan->operation_count; i++)
...
static void test_builtin_instance_yieldable_authority(void) {
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v6:schema=24:operation=") != NULL);
    REQUIRE(strstr(target->canonical_key, ":builtin-instance=Semaphore.acquire:type=") != NULL);
    char target_id_hex[XR_STABLE_ID_BYTES * 2 + 1];
    xr_stable_id_hex(target->id, target_id_hex);
    REQUIRE(strcmp(target_id_hex, "38e639c0331fb897cf0f4a01cf154bfa") == 0);
    uint32_t states = 0;
    for (uint32_t index = 0; index < plan->entity_count; index++)
...
static void test_source_instance_method_local_authority(void) {
    ...
    REQUIRE(strstr(source_class->canonical_key, "source-class-v1:schema=24:module=") != NULL);
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v7:schema=24:operation=") != NULL);
...
static void test_source_instance_method_open_authority(void) {
    ...
    REQUIRE(strstr(method->canonical_key, "source-method-v1:schema=24:class=") != NULL);
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v8:schema=24:operation=") != NULL);
    char error[512] = {0};
...
static void test_shared_direct_call_target_authority(void) {
    ...
    char target_id_hex[XR_STABLE_ID_BYTES * 2 + 1];
    xr_stable_id_hex(target->id, target_id_hex);
    REQUIRE(strcmp(target_id_hex, "f99c5c243822b959e49c261fdede482f") == 0);
