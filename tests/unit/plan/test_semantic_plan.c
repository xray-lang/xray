...
static void test_source_enum_identity_and_mutations(void) {
    ...
    REQUIRE(
        ...
        strstr(type->source_enum_key, "source-enum-v1:schema=45:owner=13:stdlib/base64:") != NULL &&
...
static void test_immutable_owned_snapshot(void) {
     ...
     *
     * It moved again when http2 traded its single __request leaf for the four
     * transport leaves __connect/__send/__recv/__close: the registry digest
     * covers the set of declared entries, so replacing one entry with four
     * moves it.
     * Old: 71cc98da6f063685a0ce4b45624aa3d94aa29acf4871cc5764a607393f47d76c. */
    REQUIRE(strcmp(semantic_hex,
                   "a813928bca1b1f5b5a8b97c7855bc63fa3c278d59fc833068b152ac7f07b77a9") == 0);
...
static void test_xsm_program_provenance_roundtrip(void) {
    REQUIRE(XR_SEMANTIC_SCHEMA_VERSION == UINT32_C(45));
...
static void test_direct_local_call_target_authority(void) {
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v3:schema=45:operation=") != NULL);
    ...
    REQUIRE(strcmp(target_id_hex, "ca0f041c2698d81df5b90e1f57d08099") == 0);
...
static void test_source_export_call_target_authority(void) {
     ...
     *
     * Both moved again when http2's __request leaf became __connect/__send/
     * __recv/__close.  export_id did not move, which is the check that the
     * key really is fingerprint-free rather than merely believed to be.
     * Old dependency_id: 1e3473bd3c7bd746dc40f3a0d79c9c55.
     * Old target_id:     9224bbcbb03e730dd6a246927371d9db. */
    REQUIRE(strcmp(dependency_id, "2d44eef3c6bf5e42654fe30bd09c5da5") == 0);
    REQUIRE(strcmp(export_id, "0dfad701bd306712350ea91732781cb5") == 0);
    REQUIRE(strcmp(target_id, "a7e059df3a39ec8f6e1dcd4f9f9b812b") == 0);
...
static void test_native_namespace_yieldable_authority(void) {
    ...
    REQUIRE(target->function == XR_SEMANTIC_INDEX_NONE &&
            ...
            target->source_export == XR_SEMANTIC_INDEX_NONE &&
            target->callable_type == XR_SEMANTIC_INDEX_NONE);
    REQUIRE(strstr(target->canonical_key, "call-target-v5:schema=45:operation=") != NULL);
...
static void test_builtin_instance_yieldable_authority(void) {
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v6:schema=45:operation=") != NULL);
...
static void test_source_instance_method_local_authority(void) {
    ...
    REQUIRE(strstr(source_class->canonical_key, "source-class-v1:schema=45:module=") != NULL);
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v7:schema=45:operation=") != NULL);
...
static void test_source_instance_method_open_authority(void) {
    ...
    REQUIRE(strstr(method->canonical_key, "source-method-v1:schema=45:class=") != NULL);
    ...
    REQUIRE(strstr(target->canonical_key, "call-target-v8:schema=45:operation=") != NULL);
    char error[512] = {0};
...
static void test_shared_direct_call_target_authority(void) {
    ...
    char target_id_hex[XR_STABLE_ID_BYTES * 2 + 1];
    xr_stable_id_hex(target->id, target_id_hex);
    REQUIRE(strcmp(target_id_hex, "5520dfaa6509c7c1cb91ab11981242ed") == 0);
...
static void test_owned_string_coroutine_lifecycle_identity(void) {
    ...
    for (uint32_t role = 0; role < 3; role++) {
        ...
        REQUIRE(entity->parent < plan->entity_count &&
                ...
                strstr(entity->canonical_key, "entity-v1:schema=45:") != NULL &&
