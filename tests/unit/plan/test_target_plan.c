...
static void test_plan_snapshot_and_determinism(void) {
    ...
    REQUIRE(strcmp(target_hex,
                   "396a43e8407978ead1fe209fc5f836fdd8bfd0f677c7a516adb25eeef14cd921") == 0);
...
static void test_channel_close_call_authority(void) {
    ...
    REQUIRE(strcmp(call_hex, "30197ed8569d7b6c7d59f20d66bfb9cd7fbd388d72b5d55ebbea0683984e273c") ==
            0);
...
static void test_source_export_call_authority(void) {
    ...
    XrSemanticPlan *semantic = build_source_export_semantic(&dependency);
    XrTargetProfile *profile = build_profile(0);
    XrTargetPlan *plan = NULL;
    char error[512] = {0};
    REQUIRE(!xr_target_plan_build(semantic, profile, &plan, error, sizeof(error)));
...
static void test_direct_local_call_adapter_family(void) {
    ...
    REQUIRE(strcmp(call_hex, "939f2a648ccbc1d1b245e76642f809a035892a3b20c0cece20d2669cbb866eb3") ==
            0);
...
static void test_coroutine_state_call_family(void) {
    ...
    REQUIRE(strcmp(tail_hex, "edce6ecc08e3fcbee1877f9605f7aab8f84fb4a62cddcda2b4a8c8a59d23b567") ==
            0);
