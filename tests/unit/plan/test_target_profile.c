...
static void test_structured_build_kat_and_exact_gate(void) {
    ...
    static const uint8_t expected_provider_set[XR_FINGERPRINT_BYTES] = {
        0x61, 0xa7, 0xba, 0x44, 0x73, 0x27, 0x5d, 0xd3,
        0xe0, 0x25, 0xac, 0x20, 0x28, 0x0f, 0x7e, 0xde,
        0x74, 0xf2, 0xbe, 0xa1, 0xdc, 0xf1, 0xf5, 0xa6,
        0xea, 0x3a, 0xaf, 0x05, 0x55, 0x8c, 0xac, 0x98,
    };
