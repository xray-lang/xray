...
static void generated_contracts(void) {
    CHECK(xr_stdlib_provider_count() == 11u, "scalar and byte-storage declarations are generated");
...
static void native_authority_consumes_generated_contracts(void) {
    ...
    CHECK(authority.provider_count == 6u, "the registry joins foundations, output and declared providers");
    for (size_t index = 0u; index < xr_stdlib_provider_count(); ++index) {
