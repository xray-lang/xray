 ...
 */
XR_FUNC int xr_h2_ctx_respond(XrH2Context *ctx, int status, const char **names, const char **values,
                              int count);
 ...
 */
XR_FUNC int xr_h2_ctx_send(XrH2Context *ctx, int status, const char *content_type, const void *body,
                           size_t body_len);
 ...
 * len: Data length
 */
XR_FUNC int xr_h2_ctx_push(XrH2Context *ctx, const char *path, const char *content_type,
