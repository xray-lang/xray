 ...
 * Append text field
 */
XR_FUNC void xr_form_data_append(XrFormData *form, const char *name, const char *value,
                                 size_t value_len);
 ...
 * size: File size
 */
XR_FUNC void xr_form_data_append_file(XrFormData *form, const char *name, const char *filename,
 ...
 */
XR_FUNC int xr_form_data_append_file_path(XrFormData *form, const char *name, const char *filepath);
 ...
 * Returns: 0 on success, -1 on failure
 */
XR_FUNC int xr_form_data_build(XrFormData *form, char **out, size_t *out_len, char **content_type);
