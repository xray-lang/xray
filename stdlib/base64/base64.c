...
XR_DEFINE_BUILTIN(base64_decodeUrl, "decodeUrl", "(data: string): string?", "URL-safe base64 decode")
XR_DEFINE_BUILTIN(base64_encodeBytes, "encodeBytes", "(data: Array<uint8>): string", "Encode byte array to Base64")
XR_DEFINE_BUILTIN(base64_decodeToBytes, "decodeToBytes", "(data: string): Array<uint8>?", "Decode Base64 to byte array")
