...
verified TargetPlan. It accepts exactly TargetPlan schema 10 with the complete
scalar, aggregate, direct-local call, closure-storage, minimal coroutine
state-call, String-literal-storage, and direct-local-callee-storage family
mask. Schema 10 is a breaking hard cutover: schema 9 and a plan missing any required family fact are rejected
