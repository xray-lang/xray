...
addition has checked signed overflow; equality returns bool. Branch conditions
must be bool. All ordinary call, generic, string, resource, and borrowing operations
