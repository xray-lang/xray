...
4. The required TargetPlan family mask is exactly scalar, aggregate,
   direct-local call, closure storage, and minimal coroutine state-call. The
...
5. Runtime loading accepts only an XTP v7 match, decodes a bounded candidate,
   binds its identity to the authority, materializes typed rows, and invokes
   independent TargetPlan verification. V7 is a breaking hard cutover from v6:
   it requires both closure-storage and coroutine-state-call family completion,
   and v6 is rejected rather than reinterpreted. V7 also
...
anchor-sha256: src/plan/target/xr_target_profile.h 97b8940a378dc9e53cdcac648b93cf36f0b384db942f744113e72c4527cebff6
...
anchor-sha256: src/runtime/xr_target_plan_load.c 1ca2b1509d5efc1c0ae0767c8c4459410471bb66a640cfa001153ed5c859f731
anchor-sha256: src/app/cli/xcmd_run.c f26673c206a831e53f65a08d7c6ff2086e94a0d2076823e8242b1c973195979c
...
anchor-sha256: tests/unit/plan/test_target_plan.c 6fef5978aab78fb6ca6e37358db17e710c4c2cd2f5abc7a6346b9eb60bc8cecb
...
anchor-sha256: tests/cli/run_target_artifact_boundary_tests.py e58c02eb7e5d77d6ad8ca1ab3d23961a03321cd910b056653d7a5363af26b67f
