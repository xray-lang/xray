...
4. The required TargetPlan family mask is exactly scalar, aggregate,
   direct-local call, and closure storage. The closure-storage family covers
...
5. Runtime loading accepts only an XTP v6 match, decodes a bounded candidate,
   binds its identity to the authority, materializes typed rows, and invokes
   independent TargetPlan verification. V6 is a breaking hard cutover from v5:
   it requires closure-storage family completion and exact dynamic closure
   value/layout rows, and v5 is rejected rather than reinterpreted. V6 also
...
anchor-sha256: src/plan/target/xr_target_profile.h c957b81646698570f19f003e6bcf1c744447d66baed77e045fad35e464e08ff8
...
anchor-sha256: src/runtime/xr_target_plan_load.c f5356a399b0eb90acb81f3b57de8ff4df84425c9c6e7c9ddae7680eac042da44
anchor-sha256: src/app/cli/xcmd_run.c 66674e5c7337f6d74539c0830dcf70995263e9af440a79d692bffe18775d5273
...
anchor-sha256: tests/unit/plan/test_target_plan.c 8155aacb1158358601188740daad54d70ceaea5b35b4d907fa8ab28772c43fd8
...
anchor-sha256: tests/cli/run_target_artifact_boundary_tests.py 8442f3b2cef599a76442c9e98faf03bf9fecf15c581bb8ec55986462bf94e80e
