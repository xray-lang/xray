...
polling. C emission schema 25 adds the separate native-rune `next` recipe only
...
The C emission projection schema 25 mechanically spells all verified dynamic
