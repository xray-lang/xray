...
TargetPlan schema 11 may carry a canonical per-function instruction table.
...
Schema 11 is a hard cutover from v10. It preserves the closure-storage,
...
Channel-allocation storage. Its receiver is a dispatch target,
...
object authority.
The C emission projection schema 7 mechanically spells all verified dynamic
...
semantic-value recipe. CGen consumes those recipes mechanically and has no
Xi/type fallback.
