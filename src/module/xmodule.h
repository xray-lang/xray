...
*/
XR_FUNC void xr_module_system_init_with_script(struct XrayIsolate *isolate, const char *script_path);
...
*/
XR_FUNC void xr_module_register_native(struct XrayIsolate *isolate, const char *name, NativeModuleLoader loader);
...
XR_FUNC XrValue xr_module_import_member(struct XrayIsolate *isolate, const char *module_name, const char *member_name);
XR_FUNC void xr_module_add_current_export(struct XrayIsolate *isolate, const char *name, XrValue value, bool is_const);
XR_FUNC bool xr_module_is_export_const(struct XrayIsolate *isolate, struct XrModule *module, const char *name);

/* ========== Module Object Operations ========== */

XR_FUNC XrModule* xr_module_create_native(struct XrayIsolate *isolate, const char *name);
XR_FUNC XrModule* xr_module_create_script(struct XrayIsolate *isolate, const char *name, const char *path);
XR_FUNC void xr_module_add_export(struct XrayIsolate *isolate, XrModule *module, const char *name, XrValue value);
XR_FUNC void xr_module_add_export_sym(struct XrayIsolate *isolate, XrModule *module, SymbolId sym, XrValue value, bool is_const);
XR_FUNC XrValue xr_module_get_export(struct XrayIsolate *isolate, XrModule *module, const char *name);
