...
void xr_module_add_export_sym(XrayIsolate *isolate, XrModule *module, SymbolId sym, XrValue value, bool is_const) {
    ...
    if (module->export_count >= module->export_capacity) {
        ...
        module->export_values = xr_realloc(module->export_values, new_cap * sizeof(XrValue));
        module->export_symbols = xr_realloc(module->export_symbols, new_cap * sizeof(SymbolId));
        module->export_flags = xr_realloc(module->export_flags, new_cap * sizeof(uint8_t));
