...
XR_FUNC void* xr_isolate_get_symbol_table(void *isolate);  // void* to avoid circular header dependency
...
struct XrProto;
struct AstNode;
XR_FUNC XrProto* xr_compile_ast_with_source(XrayIsolate *isolate, struct AstNode *ast, const char *source_file);
XR_FUNC XrProto* xr_compile_source_with_path(XrayIsolate *isolate, const char *source, const char *source_file);
