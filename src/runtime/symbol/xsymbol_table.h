...
enum {
    ...
    SYMBOL_APPEND_FROM_UNCHECKED,
    SYMBOL_REPEAT_FROM_UNCHECKED,
    SYMBOL_COMMON_PREFIX_UNCHECKED,
    SYMBOL_WRITE_FROM_UNCHECKED,
    SYMBOL_REPEAT_AT_UNCHECKED,
    SYMBOL_SET_LENGTH_UNCHECKED,
    SYMBOL_WILD_COPY_FROM_NONOVERLAPPING_UNCHECKED,
    SYMBOL_WILD_REPEAT_AT_UNCHECKED,
    SYMBOL_LOCK,
    SYMBOL_UNLOCK,
    SYMBOL_TRYLOCK,
    SYMBOL_RDLOCK,
    ...
    SYMBOL_ROTATE_LEFT,
    SYMBOL_ROTATE_RIGHT,
    // Int overflow predicates (moved from mem.*; src/shared/xr_arith_core.h).
    SYMBOL_ADD_OVERFLOWS,
    SYMBOL_SUB_OVERFLOWS,
    SYMBOL_MUL_OVERFLOWS,
    SYMBOL_AS_SPAN,
    SYMBOL_PTR_UNCHECKED,
    SYMBOL_APPEND_FROM,
...
// Takes void* to avoid circular header dependency with XrVMRuntime.
