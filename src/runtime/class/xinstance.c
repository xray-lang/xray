...
static XrClass *xr_class_transition_get_or_create_impl(XrayIsolate *X, XrClass *klass, int symbol,
...
static XrClass *xr_class_build_dynamic_chain(XrayIsolate *X, XrClass *root,
...
XrClass *xr_class_build_record_chain(XrayIsolate *X, const char *const *names, int count,
                                     bool sealed) {
