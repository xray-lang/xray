...
XR_FUNC XrReflectCache *xr_reflect_cache_create(XrVMRuntime *X, XrClass *klass);
...
XR_FUNC XrArray *xr_reflect_cache_get_all_fields(XrVMRuntime *X, XrReflectCache *cache);
XR_FUNC XrArray *xr_reflect_cache_get_all_methods(XrVMRuntime *X, XrReflectCache *cache);
