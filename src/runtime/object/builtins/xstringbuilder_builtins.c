...
XrValue xr_builtin_stringbuilder_append(XrVMRuntime *isolate, XrValue self, XrValue *args,
                                        int argc) {
...
// sb.toString()
XrValue xr_builtin_stringbuilder_toString(XrVMRuntime *isolate, XrValue self, XrValue *args,
                                          int argc) {
    (void) args;
    (void) argc;
    XrStringBuilder *sb = xr_to_stringbuilder(self);
...
// sb.clear()
XrValue xr_builtin_stringbuilder_clear(XrVMRuntime *isolate, XrValue self, XrValue *args,
                                       int argc) {
    (void) isolate;
    (void) args;
    (void) argc;
...
// sb.length
XrValue xr_builtin_stringbuilder_length(XrVMRuntime *isolate, XrValue self, XrValue *args,
                                        int argc) {
    (void) isolate;
    (void) args;
    (void) argc;
...
void xr_stringbuilder_register_class(XrVMRuntime *X) {
