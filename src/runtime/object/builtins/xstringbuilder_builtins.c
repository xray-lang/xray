...
XrClass* xr_stringbuilder_create_class(XrayIsolate *X, XrClass *objectClass) {
    ...
    // Instance methods
    xr_class_builder_add_method(builder, "append",
        (XrCFunctionPtr)xr_builtin_stringbuilder_append, 1, 0);
    ...
    xr_class_builder_add_method(builder, "clear",
        (XrCFunctionPtr)xr_builtin_stringbuilder_clear, 0, 0);
    xr_class_builder_add_method(builder, "length",
        (XrCFunctionPtr)xr_builtin_stringbuilder_length, 0, 0);
