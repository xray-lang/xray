...
static XrValue xr_set_method_delete(XrVMRuntime *iso, XrValue self, XrValue *args, int argc) {
    (void) iso;
    if (argc < 1)
        return xr_bool(0);
...
static XrValue xr_set_method_clear(XrVMRuntime *iso, XrValue self, XrValue *args, int argc) {
    (void) iso;
    (void) args;
    (void) argc;
    XrSet *s = set_self(self);
...
static XrValue xr_set_method_to_string(XrVMRuntime *iso, XrValue self, XrValue *args, int argc) {
    (void) args;
    (void) argc;
