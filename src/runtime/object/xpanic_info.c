...
XrValue xr_panic_info_newf(XrVMRuntime *X, XrErrorCode code, const char *fmt, ...) {
...
XrValue xr_panic_info_from_error(XrVMRuntime *X, XrError *error) {
...
XrValue xr_panic_info_from_value(XrVMRuntime *X, XrValue value) {
...
void xr_register_panic_info_class(XrVMRuntime *X) {
