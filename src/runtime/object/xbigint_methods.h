...
static inline XrValue xr_bigint_to_string_method(XrayIsolate *iso,
                                                 XrValue self,
                                                 XrValue *args,
                                                 int argc) {
    (void)args;
...
static inline XrValue xr_bigint_abs_method(XrayIsolate *iso,
                                           XrValue self,
                                           XrValue *args,
                                           int argc) {
    (void)args;
    ...
    XrBigInt *result = xr_bigint_abs(xr_current_coro(iso),
                                     xr_bigint_method_self(self));
    return XR_FROM_PTR(result);
}

/* bigint.sign() -> -1 / 0 / 1. Pure, no GC. */
static inline XrValue xr_bigint_sign_method(XrayIsolate *iso,
                                            XrValue self,
                                            XrValue *args,
                                            int argc) {
    (void)iso;
    ...
    (void)argc;
    XrBigInt *bi = xr_bigint_method_self(self);
    if (xr_bigint_is_zero(bi)) return xr_int(0);
    return xr_int(bi->sign);
}

/* bigint.isZero() -> bool. Pure, no GC. */
static inline XrValue xr_bigint_is_zero_method(XrayIsolate *iso,
                                               XrValue self,
                                               XrValue *args,
                                               int argc) {
    (void)iso;
...
static inline XrValue xr_bigint_is_negative_method(XrayIsolate *iso,
                                                   XrValue self,
                                                   XrValue *args,
                                                   int argc) {
    (void)iso;
...
static inline XrValue xr_bigint_is_positive_method(XrayIsolate *iso,
                                                   XrValue self,
                                                   XrValue *args,
                                                   int argc) {
    (void)iso;
...
static inline XrValue xr_bigint_to_int_method(XrayIsolate *iso,
                                              XrValue self,
                                              XrValue *args,
                                              int argc) {
    (void)iso;
...
static inline XrValue xr_bigint_to_float_method(XrayIsolate *iso,
                                                XrValue self,
                                                XrValue *args,
                                                int argc) {
    (void)iso;
