 ...
 *   XR_ELEM_U8   -> data is uint8_t[], no object references (Array<u8>)
...
/* ====== Byte-array Convenience API (Array<u8>) ====== */

static inline XrArray *xr_byte_array_new(struct XrCoroutine *coro, int32_t size) {
