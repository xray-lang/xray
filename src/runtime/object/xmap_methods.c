...
static XrValue xr_map_method_is_empty(XrayIsolate *iso, XrValue self,
                               XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    return xr_bool(xr_map_is_empty(map_self(self)));
}

static XrValue xr_map_method_has(XrayIsolate *iso, XrValue self,
                          XrValue *args, int argc) {
    (void)iso;
...
static XrValue xr_map_method_get(XrayIsolate *iso, XrValue self,
                          XrValue *args, int argc) {
    (void)iso;
...
static XrValue xr_map_method_set(XrayIsolate *iso, XrValue self,
                          XrValue *args, int argc) {
...
static XrValue xr_map_method_delete(XrayIsolate *iso, XrValue self,
                             XrValue *args, int argc) {
    (void)iso;
    if (argc < 1) return xr_bool(0);
...
static XrValue xr_map_method_clear(XrayIsolate *iso, XrValue self,
                            XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
    xr_map_clear(m);
    return xr_null();
}

static XrValue xr_map_method_keys(XrayIsolate *iso, XrValue self,
                           XrValue *args, int argc) {
    (void)args; (void)argc;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
...
static XrValue xr_map_method_values(XrayIsolate *iso, XrValue self,
                             XrValue *args, int argc) {
    (void)args; (void)argc;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
...
static XrValue xr_map_method_entries(XrayIsolate *iso, XrValue self,
                              XrValue *args, int argc) {
    (void)args; (void)argc;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
...
static XrValue xr_map_method_has_value(XrayIsolate *iso, XrValue self,
                                XrValue *args, int argc) {
    (void)iso;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
...
static XrValue xr_map_method_iterator(XrayIsolate *iso, XrValue self,
                               XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
...
static XrValue xr_map_method_entries_iterator(XrayIsolate *iso, XrValue self,
                                       XrValue *args, int argc) {
    (void)args; (void)argc;
    XrMap *m = map_self(self);
    if (map_is_weak(m)) return XR_NOTFOUND;
...
static XrValue xr_map_method_to_string(XrayIsolate *iso, XrValue self,
                                XrValue *args, int argc) {
    (void)args; (void)argc;
...
const XrMethodSlot xr_map_method_table[SYMBOL_BUILTIN_COUNT] = {
    ...
    [SYMBOL_ITERATOR]         = { xr_map_method_iterator,         0, 0,
                                   XR_METHOD_FLAG_PURE | XR_METHOD_FLAG_NO_GC },
    [SYMBOL_ENTRIES_ITERATOR] = { xr_map_method_entries_iterator, 0, 0, 0 },
    [SYMBOL_TOSTRING]         = { xr_map_method_to_string,        0, 0,
                                   XR_METHOD_FLAG_MAY_THROW },
};
