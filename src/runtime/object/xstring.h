...
XR_FUNC XrString* xr_global_pool_lookup(XrGlobalStringPool *pool,
                                 const char *chars, size_t len, uint32_t hash);
...
XR_FUNC XrString* xr_string_intern(XrayIsolate *iso, const char *chars, size_t length, uint32_t hash);
...
XR_FUNC XrString* xr_string_substring(XrayIsolate *iso, XrString *str, xr_Integer start, xr_Integer end);
XR_FUNC XrString* xr_string_slice(XrayIsolate *iso, XrString *str, xr_Integer start, xr_Integer end);
...
XR_FUNC XrString* xr_string_pad_start(XrayIsolate *iso, XrString *str, size_t target_len, XrString *pad_str);
XR_FUNC XrString* xr_string_pad_end(XrayIsolate *iso, XrString *str, size_t target_len, XrString *pad_str);
...
XR_FUNC XrString* xr_string_replace(XrayIsolate *iso, XrString *str, XrString *old_str, XrString *new_str);
XR_FUNC XrString* xr_string_replace_all(XrayIsolate *iso, XrString *str, XrString *old_str, XrString *new_str);
...
XR_FUNC XrString* xr_string_substring_by_char(XrayIsolate *iso, XrString *str, 
