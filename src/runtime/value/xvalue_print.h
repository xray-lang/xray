...
XR_FUNC void xr_value_print_with_isolate(XrVMRuntime *isolate, XrValue value);
XR_FUNC void xr_value_println_with_isolate(XrVMRuntime *isolate, XrValue value);
XR_FUNC void xr_value_fprint_with_isolate(FILE *stream, XrVMRuntime *isolate, XrValue value);

/* ========== Formatted Dump ========== */

XR_FUNC void xr_value_dump(XrValue value, int indent);
XR_FUNC void xr_value_dump_with_isolate(XrVMRuntime *isolate, XrValue value, int indent);
