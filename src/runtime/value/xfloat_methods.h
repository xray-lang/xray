...
static inline XrValue xr_float_to_string_method(XrayIsolate *iso,
                                                XrValue self,
                                                XrValue *args,
                                                int argc) {
    (void)args;
...
static inline XrValue xr_float_to_fixed_method(XrayIsolate *iso,
                                               XrValue self,
                                               XrValue *args,
                                               int argc) {
...
static inline XrValue xr_float_floor_method(XrayIsolate *iso, XrValue self,
...
static inline XrValue xr_float_ceil_method(XrayIsolate *iso, XrValue self,
                                           XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
...
static inline XrValue xr_float_round_method(XrayIsolate *iso, XrValue self,
                                            XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
...
static inline XrValue xr_float_abs_method(XrayIsolate *iso, XrValue self,
                                          XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
...
static inline XrValue xr_float_sqrt_method(XrayIsolate *iso, XrValue self,
                                           XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    xr_Number value = XR_TO_FLOAT(self);
    if (value < 0) return xr_float(NAN);
    return xr_float(sqrt(value));
}

/* float.toInt() -> int (truncation). Pure, no GC. */
static inline XrValue xr_float_to_int_method(XrayIsolate *iso, XrValue self,
                                             XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
...
static inline XrValue xr_float_pow_method(XrayIsolate *iso, XrValue self,
                                          XrValue *args, int argc) {
    (void)iso;
    xr_Number value = XR_TO_FLOAT(self);
