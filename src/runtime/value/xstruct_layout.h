...
typedef enum {
    ...
    XR_NATIVE_ARRAY_REF = 14,  // reserved for reference aggregate layouts
    XR_NATIVE_MAP_REF = 15,    // reserved for reference aggregate layouts
    XR_NATIVE_SET_REF = 16,    // reserved for reference aggregate layouts
} XrNativeType;
