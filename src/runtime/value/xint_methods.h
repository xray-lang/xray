...
static inline XrValue xr_int_to_bigint_method(XrayIsolate *iso, XrValue self,
                                              XrValue *args, int argc) {
    (void)args; (void)argc;
...
static inline XrValue xr_int_max_method(XrayIsolate *iso, XrValue self,
                                        XrValue *args, int argc) {
    (void)iso;
    xr_Integer v = XR_TO_INT(self);
    if (argc < 1) return xr_int(v);
    if (XR_IS_INT(args[0])) {
...
static inline XrValue xr_int_min_method(XrayIsolate *iso, XrValue self,
                                        XrValue *args, int argc) {
    (void)iso;
    xr_Integer v = XR_TO_INT(self);
    if (argc < 1) return xr_int(v);
...
static inline XrValue xr_int_to_float_method(XrayIsolate *iso, XrValue self,
                                             XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
...
static inline XrValue xr_int_to_hex_method(XrayIsolate *iso, XrValue self,
                                           XrValue *args, int argc) {
    (void)args; (void)argc;
...
static inline XrValue xr_int_floor_method(XrayIsolate *iso, XrValue self,
                                          XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    return self;
}
...
static inline XrValue xr_int_ceil_method(XrayIsolate *iso, XrValue self,
                                         XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    return self;
}
...
static inline XrValue xr_int_round_method(XrayIsolate *iso, XrValue self,
                                          XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    return self;
}
...
static inline XrValue xr_int_sqrt_method(XrayIsolate *iso, XrValue self,
                                         XrValue *args, int argc) {
    (void)iso; (void)args; (void)argc;
    xr_Integer v = XR_TO_INT(self);
    if (v < 0) return xr_float(NAN);
    return xr_float(sqrt((xr_Number)v));
}

/* int.pow(exponent) -> float. Pure, no GC. */
static inline XrValue xr_int_pow_method(XrayIsolate *iso, XrValue self,
                                        XrValue *args, int argc) {
    (void)iso;
...
extern const XrMethodSlot xr_int_method_table[SYMBOL_BUILTIN_COUNT];
