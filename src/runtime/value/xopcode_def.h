...
#define KOP_NONE                                                              \
    XR_OPF_NONE, XR_OPF_NONE, XR_OPF_NONE
#define KOP_A_LOAD                                                            \
    XR_OPF_REG_OUT, XR_OPF_NONE, XR_OPF_NONE
#define KOP_A_USE                                                             \
    XR_OPF_REG_IN, XR_OPF_NONE, XR_OPF_NONE
#define KOP_A_INOUT                                                           \
    XR_OPF_REG_INOUT, XR_OPF_NONE, XR_OPF_NONE
#define KOP_A_LIT                                                             \
    XR_OPF_LIT, XR_OPF_NONE, XR_OPF_NONE
#define KOP_AB_UNARY                                                          \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_NONE
#define KOP_AB_INPLACE                                                        \
    XR_OPF_REG_INOUT, XR_OPF_REG_IN, XR_OPF_NONE
#define KOP_AB_INOUT_IN                                                       \
    XR_OPF_REG_INOUT, XR_OPF_REG_IN, XR_OPF_NONE
#define KOP_AB_NEW_LIT                                                        \
    XR_OPF_REG_OUT, XR_OPF_LIT, XR_OPF_NONE
#define KOP_AB_BASE_LIT                                                       \
    XR_OPF_REG_BASE, XR_OPF_LIT, XR_OPF_NONE
#define KOP_AB_RECV                                                           \
    XR_OPF_REG_BASE, XR_OPF_REG_IN, XR_OPF_NONE
#define KOP_ABC_BIN                                                           \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_REG_IN
#define KOP_ABC_INPLACE                                                       \
    XR_OPF_REG_INOUT, XR_OPF_REG_IN, XR_OPF_REG_IN
#define KOP_ABC_BIN_K                                                         \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_K_IDX
#define KOP_ABC_BIN_S                                                         \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_LIT_S
#define KOP_ABC_BIN_LIT                                                       \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_LIT
#define KOP_ABC_INPLACE_K                                                     \
    XR_OPF_REG_INOUT, XR_OPF_K_IDX, XR_OPF_REG_IN
#define KOP_ABC_INPLACE_LIT                                                   \
    XR_OPF_REG_INOUT, XR_OPF_LIT, XR_OPF_REG_IN
#define KOP_AB_TEST                                                           \
    XR_OPF_REG_IN, XR_OPF_REG_IN, XR_OPF_LIT_FLAG
#define KOP_AB_TEST_K                                                         \
    XR_OPF_REG_IN, XR_OPF_K_IDX, XR_OPF_LIT_FLAG
#define KOP_AB_TEST_S                                                         \
    XR_OPF_REG_IN, XR_OPF_LIT_S, XR_OPF_LIT_FLAG
#define KOP_A_TEST                                                            \
    XR_OPF_REG_IN, XR_OPF_NONE, XR_OPF_LIT_FLAG
#define KOP_ABx_K                                                             \
    XR_OPF_REG_OUT, XR_OPF_K_IDX, XR_OPF_NONE
#define KOP_AsBx_LITS                                                         \
    XR_OPF_REG_OUT, XR_OPF_LIT_S, XR_OPF_NONE
#define KOP_PROTO                                                             \
    XR_OPF_REG_OUT, XR_OPF_PROTO_IDX, XR_OPF_NONE
#define KOP_GLOBAL_GET                                                        \
    XR_OPF_REG_OUT, XR_OPF_GLOBAL_IDX, XR_OPF_NONE
#define KOP_GLOBAL_SET                                                        \
...
#define KOP_CALL_KEEP                                                         \
    XR_OPF_REG_BASE, XR_OPF_LIT, XR_OPF_REG_OUT
#define KOP_RETURN                                                            \
    XR_OPF_REG_BASE, XR_OPF_LIT, XR_OPF_NONE
#define KOP_INVOKE_K                                                          \
    XR_OPF_REG_BASE, XR_OPF_K_IDX, XR_OPF_LIT
#define KOP_INVOKE_SYM                                                        \
    XR_OPF_REG_BASE, XR_OPF_SYMBOL_IDX, XR_OPF_LIT
#define KOP_ABC_BIN_SYM                                                       \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_SYMBOL_IDX
#define KOP_ABC_INPLACE_SYM                                                   \
    XR_OPF_REG_INOUT, XR_OPF_SYMBOL_IDX, XR_OPF_REG_IN
#define KOP_AB_K                                                              \
    XR_OPF_REG_IN, XR_OPF_K_IDX, XR_OPF_NONE
#define KOP_AB_FLAG                                                           \
    XR_OPF_REG_IN, XR_OPF_LIT_FLAG, XR_OPF_NONE
#define KOP_PRINT                                                             \
    XR_OPF_REG_IN, XR_OPF_LIT_FLAG, XR_OPF_LIT
#define KOP_INVOKE_DIRECT                                                     \
    XR_OPF_REG_BASE, XR_OPF_REG_IN, XR_OPF_LIT
#define KOP_INVOKE_BUILTIN                                                    \
    XR_OPF_REG_BASE, XR_OPF_BUILTIN_IDX, XR_OPF_LIT
#define KOP_DUMP                                                              \
    XR_OPF_REG_IN, XR_OPF_LIT, XR_OPF_NONE
#define KOP_AB_UNARY_HINT                                                     \
    XR_OPF_REG_OUT, XR_OPF_REG_IN, XR_OPF_LIT
#define KOP_NEW_CONTAINER                                                     \
    XR_OPF_REG_OUT, XR_OPF_LIT, XR_OPF_LIT
#define KOP_SPECIAL                                                           \
    XR_OPF_SPECIAL, XR_OPF_SPECIAL, XR_OPF_SPECIAL
...
#define XR_OPCODE_TABLE(_) \
    ...
    _(GO                          , FMT_ABC   , KOP_SPECIAL         , "R[A] = go R[B](R[B+1]..R[B+C])") \
    _(GO_INVOKE                   , FMT_ABC   , KOP_SPECIAL         , "R[A] = go R[B].method(args)") \
    _(SPAWN_CONT                  , FMT_ABC   , KOP_ABC_BIN_LIT     , "spawn continuation: R[A]=task, R[B]=fn, C=nargs|flags") \
    ...
    _(SELECT_BLOCK                , FMT_ABC   , KOP_ABC_BIN_LIT     , "select block wait: A=ch_base, B=ch_count, C=case_count") \
    _(GETSHARED                   , FMT_GLOBAL, KOP_GLOBAL_GET      , "R[A] = shared[Bx]") \
    _(SETSHARED                   , FMT_GLOBAL, KOP_GLOBAL_SET      , "shared[Bx] = R[A]") \
    _(TARRAY_GET                  , FMT_ABC   , KOP_ABC_BIN         , "R[A].i = R[B]:TypedArray[R[C]]") \
    _(TARRAY_GETC                 , FMT_ABC   , KOP_ABC_BIN_LIT     , "R[A].i = R[B]:TypedArray[C]") \
    _(TARRAY_SET                  , FMT_ABC   , KOP_ABC_INPLACE     , "R[A]:TypedArray[R[B]] = R[C].i") \
    ...
    _(INST_TYPE_ARGS              , FMT_ABx   , KOP_ABx_LAYOUT      , "R[A]:Instance.gc.extra = packed type args from Bx") \
    _(LOOP_BACK                   , FMT_ABC   , KOP_SPECIAL         , "tail recursion: R[0..B-1]=R[A+1..A+B]; PC=entry") \
    _(NEW_STRUCT                  , FMT_ABC   , KOP_ABC_BIN_LIT     , "R[A] = alloc struct in struct_area (B=class reg, C=slot offset)") \
