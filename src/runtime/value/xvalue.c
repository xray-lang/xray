...
bool xr_value_deep_eq(XrValue a, XrValue b) {
    ...
    if (a.tag == b.tag && a.i == b.i) {
        ...
        if (a.tag == XR_TAG_F64 && isnan(a.f)) return false;
    ...
    switch (a.tag) {
        ...
        case XR_TAG_I64:   return a.i == b.i;
        case XR_TAG_F64: {
            if (isnan(a.f) && isnan(b.f)) return false;
            return a.f == b.f;
        }
        case XR_TAG_PTR:
            goto deep_compare;
...
static const XrTypeId tag_to_typeid[8] = {
    ...
    [XR_TAG_BOOL]       = XR_TID_BOOL,
    [XR_TAG_I64]        = XR_TID_INT,
    [XR_TAG_F64]        = XR_TID_FLOAT,
    [XR_TAG_PTR]        = XR_TID_NULL,
    [XR_TAG_STRUCT_REF] = XR_TID_NULL,
...
XrTypeId xr_value_typeid(XrValue v) {
    ...
    if (v.tag <= XR_TAG_F64) return tag_to_typeid[v.tag];
...
uint8_t xr_type_to_tid(const XrType *type) {
    ...
    case XR_KIND_MAP:            return XR_TID_MAP;
    case XR_KIND_SET:            return XR_TID_SET;
    case XR_KIND_CHANNEL:        return XR_TID_CHANNEL;
    case XR_KIND_JSON:           return XR_TID_JSON;
    case XR_KIND_INSTANCE:       return XR_TID_INSTANCE;
    case XR_KIND_FUNCTION:       return XR_TID_FUNCTION;
    case XR_KIND_ENUM:           return XR_TID_ENUM_VALUE;
    default:                     return 0;
    }
}
