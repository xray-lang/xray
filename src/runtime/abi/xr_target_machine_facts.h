...
typedef enum XrTargetArchitecture {
    ...
    XR_TARGET_ARCH_X86_64 = XR_TARGET_QUERY_VALUE_ARCH_X86_64,
    XR_TARGET_ARCH_AARCH64 = XR_TARGET_QUERY_VALUE_ARCH_AARCH64,
    XR_TARGET_ARCH_POWERPC64 = XR_TARGET_QUERY_VALUE_ARCH_POWERPC64,
    XR_TARGET_ARCH_LOONGARCH64 = XR_TARGET_QUERY_VALUE_ARCH_LOONGARCH64,
    XR_TARGET_ARCH_WASM32 = XR_TARGET_QUERY_VALUE_ARCH_WASM32,
    XR_TARGET_ARCH_COUNT = XR_TARGET_QUERY_VALUE_ARCH_COUNT,
} XrTargetArchitecture;

typedef enum XrTargetOperatingSystem {
    XR_TARGET_OS_NONE = 0,
    XR_TARGET_OS_WINDOWS = XR_TARGET_QUERY_VALUE_OS_WINDOWS,
    XR_TARGET_OS_LINUX = XR_TARGET_QUERY_VALUE_OS_LINUX,
    XR_TARGET_OS_MACOS = XR_TARGET_QUERY_VALUE_OS_MACOS,
    XR_TARGET_OS_WASI = XR_TARGET_QUERY_VALUE_OS_WASI,
    XR_TARGET_OS_FREESTANDING = XR_TARGET_QUERY_VALUE_OS_FREESTANDING,
    XR_TARGET_OS_COUNT = XR_TARGET_QUERY_VALUE_OS_COUNT,
...
typedef enum XrTargetNativeAbi {
    ...
    XR_TARGET_ABI_WIN64_X86_64 = XR_TARGET_QUERY_VALUE_ABI_WIN64_X86_64,
    XR_TARGET_ABI_WIN64_AARCH64 = XR_TARGET_QUERY_VALUE_ABI_WIN64_AARCH64,
    XR_TARGET_ABI_SYSV_X86_64 = XR_TARGET_QUERY_VALUE_ABI_SYSV_X86_64,
    XR_TARGET_ABI_AAPCS64 = XR_TARGET_QUERY_VALUE_ABI_AAPCS64,
    XR_TARGET_ABI_DARWIN_X86_64 = XR_TARGET_QUERY_VALUE_ABI_DARWIN_X86_64,
    XR_TARGET_ABI_DARWIN_AARCH64 = XR_TARGET_QUERY_VALUE_ABI_DARWIN_AARCH64,
    XR_TARGET_ABI_PPC64_ELFV2 = XR_TARGET_QUERY_VALUE_ABI_PPC64_ELFV2,
    XR_TARGET_ABI_LOONGARCH_LP64D = XR_TARGET_QUERY_VALUE_ABI_LOONGARCH_LP64D,
    XR_TARGET_ABI_WASM = XR_TARGET_QUERY_VALUE_ABI_WASM,
    XR_TARGET_ABI_COUNT = XR_TARGET_QUERY_VALUE_ABI_COUNT,
} XrTargetNativeAbi;
