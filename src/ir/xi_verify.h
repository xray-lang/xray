 ...
 *   8. All value args reference existing values (no dangling ptrs
 *      check is best-effort: verifies op != 0 and type != NULL).
 *   9. SSA dominance: each use is dominated by its def (optional,
