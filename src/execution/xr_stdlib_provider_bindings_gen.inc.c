...
static const XrProviderOperationBinding xr_stdlib_provider_bindings[] = {
    {
        ...
        .entry.i64_nullary = xr_stdlib_provider_call_0,
    },
    {
    ...
    },
    {
        ...
        .entry.bool_i64_unary = xr_stdlib_provider_call_5,
    },
    {
