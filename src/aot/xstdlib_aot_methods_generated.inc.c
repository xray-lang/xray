...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"io", "__dirOpen", 1, "xrt_io_dir_open", "p", ".", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"io", "__dirNext", 1, "xrt_io_dir_next", "i", ".", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"io", "__dirClose", 1, "xrt_io_dir_close", "i", ".", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"mem", "__bufferLength", 1, "xrt_mem_buffer_length", "v", ".", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"mem", "__bufferAsBytes", 1, "xrt_mem_buffer_as_bytes", "v", ".", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"mem", "__bufferBorrowPtr", 1, "xrt_mem_buffer_borrow_ptr", "v", ".", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"mem", "__bufferResize", 2, "xrt_mem_buffer_resize", "vv", "..", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"net", "__accept", 1, "xrt_net_accept", "v", "w", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__readInto", 3, "xrt_net_read_into", "vvv", "w..", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__writeBytes", 2, "xrt_net_write_bytes", "vv", "w.", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__shutdownDirection", 2, "xrt_net_shutdown_direction", "vv", "w.", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__closeConn", 1, "xrt_net_close", "v", "w", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__closeListener", 1, "xrt_net_close", "v", "w", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"net", "__connLastCode", 1, "xrt_net_last_code", "v", "w", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__listenerLastCode", 1, "xrt_net_last_code", "v", "w", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"net", "__newTlsClientContext", 5, "xrt_net_tls_client_context_new", "sssvv", ".....", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__newTlsServerContext", 5, "xrt_net_tls_server_context_new", "sssvv", ".....", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__tlsClientHandshakeWithContext", 4, "xrt_net_tls_client_handshake_context", "vvsv", ".w..", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
