...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"net", "__dial", 2, "xrt_net_dial_default", "sv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__dial", 3, "xrt_net_dial", "svv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__listen", 1, "xrt_net_listen_default", "v", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__listen", 2, "xrt_net_listen", "vv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"net", "__lastError", 1, "xrt_net_last_error", "v", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__lastErrno", 1, "xrt_net_last_errno", "v", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__lookup", 1, "xrt_net_lookup", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__hasTLS", 0, "xrt_net_has_tls", "", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__dialTLS", 2, "xrt_net_dial_tls_default", "sv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"net", "__dialTLS", 3, "xrt_net_dial_tls", "svv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
