...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"io", "readDir", 1, "xrt_io_read_dir", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "readDirRecursive", 1, "xrt_io_read_dir_recursive", "p", CG_AOT_RET_VALUE, NULL},
    ...
    {"io", "readlink", 1, "xrt_io_readlink", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "realpath", 1, "xrt_io_realpath", "p", CG_AOT_RET_VALUE, NULL},
