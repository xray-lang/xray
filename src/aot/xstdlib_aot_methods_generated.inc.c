...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"sys", "OsMutex", 0, "xrt_sys_mutex_new", "", CG_AOT_RET_VALUE, NULL},
    {"sys", "__osMutexNew", 0, "xrt_sys_mutex_new", "", CG_AOT_RET_VALUE, NULL},
    {"sys", "OsRwLock", 0, "xrt_sys_rwlock_new", "", CG_AOT_RET_VALUE, NULL},
    {"sys", "OsCondvar", 0, "xrt_sys_condvar_new", "", CG_AOT_RET_VALUE, NULL},
    {"sys", "OsBarrier", 1, "xrt_sys_barrier_new", "v", CG_AOT_RET_VALUE, NULL},
    {"sys", "OsOnce", 0, "xrt_sys_once_new", "", CG_AOT_RET_VALUE, NULL},
    {"sys", "cpuCount", 0, "xrt_sys_cpu_count", "", CG_AOT_RET_VALUE, NULL},
    ...
    {"sys", "__dylibOpen", 1, "xrt_sys_dylib_open", "p", CG_AOT_RET_VALUE, NULL},
    ...
    {"sys", "__pipeOpen", 0, "xrt_sys_pipe_open", "", CG_AOT_RET_VALUE, NULL},
    {"sys", "__pipeRead", 2, "xrt_sys_pipe_read", "vv", CG_AOT_RET_VALUE, NULL},
    {"sys", "__pipeWrite", 2, "xrt_sys_pipe_write", "vv", CG_AOT_RET_VALUE, NULL},
    {"sys", "__pipeClose", 1, "xrt_sys_pipe_close", "v", CG_AOT_RET_VALUE, NULL},
    ...
    {"io", "appendFile", 2, "xrt_io_append_file", "ps", CG_AOT_RET_VALUE, NULL},
    {"io", "chmod", 2, "xrt_io_chmod_value", "pv", CG_AOT_RET_VALUE, NULL},
    {"io", "chdir", 1, "xrt_io_chdir", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "copyFile", 2, "xrt_io_copy_file", "pp", CG_AOT_RET_VALUE, NULL},
    {"io", "__cwd", 0, "xrt_io_cwd", "", CG_AOT_RET_VALUE, NULL},
    {"io", "exists", 1, "xrt_io_exists", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "fileSize", 1, "xrt_io_file_size", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "isDir", 1, "xrt_io_is_dir", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "isFile", 1, "xrt_io_is_file", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "isSymlink", 1, "xrt_io_is_symlink", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "mkdir", 1, "xrt_io_mkdir", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "mkdirp", 1, "xrt_io_mkdirp", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "__readDir", 1, "xrt_io_read_dir", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "__readDirRecursive", 1, "xrt_io_read_dir_recursive", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "readFile", 1, "xrt_io_read_file", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "readFileBytes", 1, "xrt_io_read_file_bytes", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "readLines", 1, "xrt_io_read_lines", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "readStdin", 0, "xrt_io_read_stdin", "", CG_AOT_RET_VALUE, NULL},
    {"io", "__readlink", 1, "xrt_io_readlink", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "__realpath", 1, "xrt_io_realpath", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "remove", 1, "xrt_io_remove", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "removeAll", 1, "xrt_io_remove_all", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "rename", 2, "xrt_io_rename", "pp", CG_AOT_RET_VALUE, NULL},
    {"io", "stat", 1, "xrt_io_stat", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "symlink", 2, "xrt_io_symlink", "pp", CG_AOT_RET_VALUE, NULL},
    {"io", "__tempDir", 0, "xrt_io_temp_dir", "", CG_AOT_RET_VALUE, NULL},
    {"io", "__tempFile", 0, "xrt_io_temp_file", "", CG_AOT_RET_VALUE, NULL},
    {"io", "touch", 1, "xrt_io_touch", "p", CG_AOT_RET_VALUE, NULL},
    {"io", "writeFile", 2, "xrt_io_write_file", "ps", CG_AOT_RET_VALUE, NULL},
    {"io", "writeFileBytes", 2, "xrt_io_write_file_bytes", "pv", CG_AOT_RET_VALUE, NULL},
    ...
    {"mem", "ptr", 1, "xrt_mem_ptr", "v", CG_AOT_RET_VALUE, NULL},
    {"mem", "mutPtr", 1, "xrt_mem_mut_ptr", "v", CG_AOT_RET_VALUE, NULL},
    {"mem", "addr", 1, "xrt_mem_addr", "v", CG_AOT_RET_VALUE, NULL},
    ...
    {"net", "dial", 2, "xrt_net_dial_default", "sv", CG_AOT_RET_VALUE, NULL},
    {"net", "dial", 3, "xrt_net_dial", "svv", CG_AOT_RET_VALUE, NULL},
    {"net", "listen", 1, "xrt_net_listen_default", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "listen", 2, "xrt_net_listen", "vv", CG_AOT_RET_VALUE, NULL},
    {"net", "accept", 1, "xrt_net_accept", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "read", 1, "xrt_net_read_default", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "read", 2, "xrt_net_read", "vv", CG_AOT_RET_VALUE, NULL},
    {"net", "write", 2, "xrt_net_write", "vs", CG_AOT_RET_VALUE, NULL},
    {"net", "shutdownRead", 1, "xrt_net_shutdown_read", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "shutdownWrite", 1, "xrt_net_shutdown_write", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "shutdown", 1, "xrt_net_shutdown", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "close", 1, "xrt_net_close", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "fd", 1, "xrt_net_fd", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "setReadDeadline", 2, "xrt_net_set_read_deadline", "vv", CG_AOT_RET_VALUE, NULL},
    {"net", "setWriteDeadline", 2, "xrt_net_set_write_deadline", "vv", CG_AOT_RET_VALUE, NULL},
    {"net", "setDeadline", 2, "xrt_net_set_deadline", "vv", CG_AOT_RET_VALUE, NULL},
    {"net", "setAcceptDeadline", 2, "xrt_net_set_accept_deadline", "vv", CG_AOT_RET_VALUE, NULL},
    {"net", "lastError", 1, "xrt_net_last_error", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "lastErrno", 1, "xrt_net_last_errno", "v", CG_AOT_RET_VALUE, NULL},
    {"net", "hasTLS", 0, "xrt_net_has_tls", "", CG_AOT_RET_VALUE, NULL},
    {"net", "dialTLS", 2, "xrt_net_dial_tls_default", "sv", CG_AOT_RET_VALUE, NULL},
    {"net", "dialTLS", 3, "xrt_net_dial_tls", "svv", CG_AOT_RET_VALUE, NULL},
};
