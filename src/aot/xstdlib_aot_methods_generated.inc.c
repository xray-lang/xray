...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"regex", "__compile", 1, "xrt_regex_compile_default", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__compile", 2, "xrt_regex_compile_with_flags", "ss", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__test", 2, "xrt_regex_test", "vs", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__count", 2, "xrt_regex_count", "vs", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__findText", 2, "xrt_regex_find_text", "vs", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__findGroup", 3, "xrt_regex_find_group", "vsv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"regex", "__replace", 3, "xrt_regex_replace", "vss", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__replaceAll", 3, "xrt_regex_replace_all", "vss", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__split", 2, "xrt_regex_split", "vs", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__split", 3, "xrt_regex_split_limit", "vsv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__escape", 1, "xrt_regex_escape", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"regex", "__isValid", 1, "xrt_regex_is_valid", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
