...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"os", "__username", 0, "xrt_os_username", "", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"io", "__appendFile", 2, "xrt_io_append_file", "ps", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"io", "__copyFile", 2, "xrt_io_copy_file", "pp", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"io", "__writeStdout", 1, "xrt_io_write_stdout", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    ...
    {"http2", "supported", 0, "xrt_http_h2_supported", "", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"http2", "request", 6, "xrt_http_h2_request_unavailable", "vvvvvv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
