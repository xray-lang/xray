...
static const CgAotStdlibMethod g_aot_stdlib_generated_methods[] = {
    ...
    {"compress", "__inflate", 1, "xrt_compress_inflate", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"compress", "__zlibCompress", 2, "xrt_compress_zlib_compress", "sv", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
    {"compress", "__zlibDecompress", 1, "xrt_compress_zlib_decompress", "s", CG_AOT_RET_VALUE, NULL, UINT32_C(0), NULL, NULL, 0},
