...
static const char *cg_no_alloc_method_alloc_detail(XiCgenCtx *ctx, const XrType *receiver_type,
    ...
    static const struct {
        ...
        /* kind is consulted only for non-class receiver rows. */
        {XR_KIND_INSTANCE, "Buffer", "resize", "Buffer.resize"},
        ...
        {XR_KIND_MAP, NULL, "map", "Map.map"},
        {XR_KIND_MAP, NULL, "filter", "Map.filter"},
        {XR_KIND_MAP, NULL, "toString", "Map.toString"},
        {XR_KIND_SET, NULL, "add", "Set.add"},
        {XR_KIND_SET, NULL, "union", "Set.union"},
        {XR_KIND_SET, NULL, "intersection", "Set.intersection"},
        {XR_KIND_SET, NULL, "difference", "Set.difference"},
        {XR_KIND_SET, NULL, "symmetricDifference", "Set.symmetricDifference"},
        {XR_KIND_SET, NULL, "toArray", "Set.toArray"},
        ...
        {XR_KIND_INSTANCE, "BigInt", "toString", "BigInt.toString"},
        {XR_KIND_INSTANCE, "BigInt", "abs", "BigInt.abs"},
        {XR_KIND_INSTANCE, "Range", "toString", "Range.toString"},
        {XR_KIND_INSTANCE, "Range", "toArray", "Range.toArray"},
        {XR_KIND_INSTANCE, "Range", "values", "Range.values"},
        ...
        {XR_KIND_INSTANCE, "DateTime", "toString", "DateTime.toString"},
        {XR_KIND_INSTANCE, "DateTime", "format", "DateTime.format"},
        {XR_KIND_INSTANCE, "DateTime", "toISOString", "DateTime.toISOString"},
        {XR_KIND_INSTANCE, "DateTime", "add", "DateTime.add"},
        {XR_KIND_INSTANCE, "DateTime", "toUTC", "DateTime.toUTC"},
        {XR_KIND_INSTANCE, "DateTime", "toLocal", "DateTime.toLocal"},
        {XR_KIND_INSTANCE, "Regex", "find", "Regex.find"},
        {XR_KIND_INSTANCE, "Regex", "findText", "Regex.findText"},
        {XR_KIND_INSTANCE, "Regex", "findGroup", "Regex.findGroup"},
        {XR_KIND_INSTANCE, "Regex", "findAll", "Regex.findAll"},
        {XR_KIND_INSTANCE, "Regex", "replace", "Regex.replace"},
        {XR_KIND_INSTANCE, "Regex", "split", "Regex.split"},
        {XR_KIND_INSTANCE, "StringBuilder", "append", "StringBuilder.append"},
        {XR_KIND_INSTANCE, "StringBuilder", "toString", "StringBuilder.toString"},
        {XR_KIND_INSTANCE, "Atomic", "compareExchange", "Atomic.compareExchange"},
        {XR_KIND_INSTANCE, "Atomic", "toString", "Atomic.toString"},
        {XR_KIND_INSTANCE, "PanicInfo", "toString", "PanicInfo.toString"},
    };
