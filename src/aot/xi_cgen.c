...
static const char *cg_no_alloc_method_alloc_detail(const XrType *receiver_type,
    ...
    static const struct {
        ...
        {XR_KIND_ARRAY, NULL, "appendFrom", "Bytes.appendFrom"},
        {XR_KIND_ARRAY, NULL, "repeatFrom", "Bytes.repeatFrom"},
        ...
        {XR_KIND_UNKNOWN, "Atomic", "compareExchange", "Atomic.compareExchange"},
