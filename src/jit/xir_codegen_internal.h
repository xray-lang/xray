 ...
 *
 * xir_codegen_internal.h - Internal shared declarations for XIR codegen
 */

#ifndef XIR_CODEGEN_INTERNAL_H
#define XIR_CODEGEN_INTERNAL_H
...
/* ========== Shared helpers (defined in xir_codegen.c) ========== */

XR_FUNC A64Reg xra_get(CodegenCtx *ctx, XirRef ref);
XR_FUNC A64Reg xra_arg(CodegenCtx *ctx, XirRef ref, A64Reg scratch_reg);
XR_FUNC A64Reg xra_operand(CodegenCtx *ctx, XirRef ref, A64Reg scratch_reg);
XR_FUNC void xra_maybe_spill(CodegenCtx *ctx, XirRef dst_ref);
...
XR_FUNC void emit_load_const(CodegenCtx *ctx, A64Reg rd, XirRef ref);
...
// Epilogue emission (defined in xir_codegen.c, used by XIR_SUSPEND in xir_codegen_mem.c)
