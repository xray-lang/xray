...
_Static_assert(offsetof(XrCoroutine, reductions) == XIR_CORO_REDUCTIONS_OFFSET,
...
_Static_assert(offsetof(XrProto, jit_entry) == XIR_PROTO_JIT_ENTRY_OFFSET,
               "jit_entry offset mismatch");
_Static_assert(offsetof(XrProto, jit_fast_entry) == XIR_PROTO_JIT_FAST_ENTRY_OFFSET,
...
_Static_assert(offsetof(XrCoroGC, totalbytes) == XIR_GC_TOTALBYTES_OFFSET,
               "totalbytes offset mismatch");
_Static_assert(offsetof(XrCoroGC, gc_requested) == XIR_GC_GC_REQUESTED_OFFSET,
               "gc_requested offset mismatch");
_Static_assert(offsetof(XrCoroGC, in_gc) == XIR_GC_IN_GC_OFFSET, "in_gc offset mismatch");
_Static_assert(offsetof(XrCoroGC, gc_disabled) == XIR_GC_GC_DISABLED_OFFSET,
               "gc_disabled offset mismatch");
_Static_assert(offsetof(XrCoroGC, alloc_since_gc) == XIR_GC_ALLOC_SINCE_GC_OFFSET,
               "alloc_since_gc offset mismatch");
_Static_assert(offsetof(XrCoroGC, object_count) == XIR_GC_OBJECT_COUNT_OFFSET,
               "object_count offset mismatch");
_Static_assert(offsetof(XrCoroGC, currentwhite) == XIR_GC_CURRENTWHITE_OFFSET,
               "currentwhite offset mismatch");
_Static_assert(offsetof(XrImmixBlock, local_allgc) == XIR_IMMIX_BLOCK_LOCAL_ALLGC_OFFSET,
               "local_allgc offset mismatch");
_Static_assert(offsetof(XrImmixBlock, alloc_marks) == XIR_IMMIX_BLOCK_ALLOC_MARKS_OFFSET,
               "alloc_marks offset mismatch");
_Static_assert(offsetof(XrImmixBlock, alloc_count) == XIR_IMMIX_BLOCK_ALLOC_COUNT_OFFSET,
               "alloc_count offset mismatch");
_Static_assert(offsetof(XrImmixBlock, alloc_bytes) == XIR_IMMIX_BLOCK_ALLOC_BYTES_OFFSET,
               "alloc_bytes offset mismatch");
_Static_assert(offsetof(XrImmixHeap, cursor) == XIR_IMMIX_CURSOR_OFFSET,
               "ImmixHeap.cursor offset mismatch");
_Static_assert(offsetof(XrImmixHeap, limit) == XIR_IMMIX_LIMIT_OFFSET,
               "ImmixHeap.limit offset mismatch");

// XrGCHeader detailed field checks
_Static_assert(offsetof(XrGCHeader, marked) == XIR_GC_HDR_MARKED_OFFSET,
               "GCHeader.marked offset mismatch");
_Static_assert(offsetof(XrGCHeader, extra) == XIR_GC_HDR_EXTRA_OFFSET,
               "GCHeader.extra offset mismatch");
_Static_assert(offsetof(XrGCHeader, objsize) == XIR_GC_HDR_OBJSIZE_OFFSET,
               "GCHeader.objsize offset mismatch");

// XrValue detailed field checks
_Static_assert(offsetof(XrValue, heap_type) == XIR_XRVALUE_HEAP_TYPE_OFFSET,
               "XrValue.heap_type offset mismatch");
_Static_assert(offsetof(XrValue, i) == XIR_XRVALUE_PAYLOAD_OFFSET,
               "XrValue payload offset mismatch");

// XrClosure / XrCell checks
#include "../runtime/xexec_frame.h"
#include "../runtime/closure/xcell.h"
_Static_assert(offsetof(XrClosure, proto) == XIR_CLOSURE_PROTO_OFFSET,
...
_Static_assert(offsetof(XrArray, length) == XIR_ARRAY_LENGTH_OFFSET,
               "Array.length offset mismatch");
_Static_assert(offsetof(XrArray, elem_type) == XIR_ARRAY_ELEM_TYPE_OFFSET,
               "Array.elem_type offset mismatch");
_Static_assert(offsetof(XrArray, elem_size) == XIR_ARRAY_ELEM_SIZE_OFFSET,
