...
typedef enum {
    ...
    XM_HELPER_call_method_known = 2,
    XM_HELPER_invoke_method = 3,
    XM_HELPER_invoke_direct = 4,
    XM_HELPER_closure_new = 5,
    XM_HELPER_closure_set_upval = 6,
    XM_HELPER_upval_get = 7,
    XM_HELPER_upval_set = 8,
    XM_HELPER_upval_cell_get = 9,
    XM_HELPER_upval_cell_set = 10,
    XM_HELPER_cell_new = 11,
    XM_HELPER_cell_get_direct = 12,
    XM_HELPER_cell_set_direct = 13,
    XM_HELPER_rt_add = 14,
    XM_HELPER_rt_sub = 15,
    XM_HELPER_rt_mul = 16,
    XM_HELPER_rt_div = 17,
    XM_HELPER_rt_mod = 18,
    XM_HELPER_rt_eq = 19,
    XM_HELPER_rt_truthy = 20,
    XM_HELPER_eq_value = 21,
    XM_HELPER_getprop = 22,
    XM_HELPER_setprop = 23,
    XM_HELPER_getfield_ic = 24,
    XM_HELPER_getbuiltin = 25,
    XM_HELPER_index_get = 26,
    XM_HELPER_index_set = 27,
    XM_HELPER_tarray_get = 28,
    XM_HELPER_tarray_set = 29,
    XM_HELPER_map_get = 30,
    XM_HELPER_map_set = 31,
    XM_HELPER_map_increment = 32,
    XM_HELPER_get_shared = 33,
    XM_HELPER_set_shared = 34,
    XM_HELPER_rc_dup = 35,
    XM_HELPER_rc_drop = 36,
    XM_HELPER_throw = 37,
    XM_HELPER_pending_error_tag = 38,
    ...
    XM_HELPER_chan_method_try_send = 79,
    XM_HELPER_chan_method_try_recv = 80,
    XM_HELPER_chan_method_close = 81,
    XM_HELPER_chan_method_is_closed = 82,
    XM_HELPER_chan_method_send = 83,
    XM_HELPER_chan_method_send_block = 84,
    XM_HELPER_chan_method_recv = 85,
    XM_HELPER_chan_method_recv_block = 86,
    XM_HELPER_chan_method_recv_wrap = 87,
    XM_HELPER_chan_method_recv_is_value = 88,
    XM_HELPER_chan_send = 89,
    XM_HELPER_chan_send_block = 90,
    XM_HELPER_chan_recv = 91,
    XM_HELPER_chan_recv_block = 92,
    XM_HELPER_chan_recv_is_value = 93,
    XM_HELPER_scope_enter = 94,
    XM_HELPER_scope_exit = 95,
    XM_HELPER_go = 96,
    XM_HELPER_await = 97,
    XM_HELPER_await_block = 98,
    XM_HELPER__COUNT
} XmHelperId;
...
#define XM_HELPER_RET_REP_call_method_known XR_REP_TAGGED
#define XM_HELPER_NARGS_call_method_known 0
#define XM_HELPER_FLAGS_call_method_known                                                          \
    (XM_HF_GC | XM_HF_DEOPT | XM_HF_ENTER_VM | XM_HF_USER_CODE | XM_HF_STACKMAP)
#define XM_HELPER_POINTER_TRUST_call_method_known XM_HPT_GC
#define XM_HELPER_POST_CALL_call_method_known (XM_HPC_DEOPT)
...
static const XmHelperStaticInfo xm_helper_meta[XM_HELPER__COUNT] = {
    ...
    [XM_HELPER_call_func] = {XR_REP_TAGGED, 0,
                             XM_HF_GC | XM_HF_DEOPT | XM_HF_ENTER_VM | XM_HF_USER_CODE |
                                 XM_HF_STACKMAP,
                             XM_HPT_GC, XM_HPC_DEOPT},
    [XM_HELPER_call_method_known] = {XR_REP_TAGGED, 0,
                                     XM_HF_GC | XM_HF_DEOPT | XM_HF_ENTER_VM | XM_HF_USER_CODE |
                                         XM_HF_STACKMAP,
                                     XM_HPT_GC, XM_HPC_DEOPT},
