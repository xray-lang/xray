 ...
 *
 * xm_x64.c - x86-64 instruction encoding implementation
 *
 * KEY CONCEPT:
 ...
 *   helpers in xm_x64.h. This file implements the typed wrappers.
 *
 * ENCODING REFERENCE:
...
static void x64_sse_prefix_rr(X64Buf *buf, uint8_t prefix, X64Xmm dst, X64Xmm src) {
