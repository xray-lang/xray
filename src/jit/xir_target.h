 ...
 *
 * xir_target.h - Target-independent backend interface
 *
 * KEY CONCEPT:
 ...
 *
 * RELATED MODULES:
 *   - xir_codegen.c: uses XirTarget for register allocation and code emission
 *   - xir_arm64.h: ARM64 instruction encoding (target-specific)
 */
 ...
 */
extern const XirTarget *xir_current_target;
