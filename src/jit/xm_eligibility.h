 ...
 *
 * xm_eligibility.h - Decide whether a bytecode proto can be JIT-compiled.
 *
 * KEY CONCEPT:
 ...
 *   driver (xm_jit.c) and the background compile queue
 ...
 *   - Actual IR construction (xi_to_xm.c)
 *   - Register allocation / codegen refusal (xm_regalloc.c / xm_codegen.c)
 *   - Background queue scheduling / task snapshotting (xjit_compile_queue.c)
 */

#ifndef XM_ELIGIBILITY_H
#define XM_ELIGIBILITY_H
