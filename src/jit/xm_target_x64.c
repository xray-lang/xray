 ...
 *
 * xm_target_x64.c - x86-64 target description for Xm backend
 *
 * KEY CONCEPT:
...
#include "xm_x64.h"
#include "xm_codegen_x64_internal.h" /* X64_NGPR_CALLER_SAVE etc. */
...
const XmTarget *xm_current_target = &xm_target_x64;
