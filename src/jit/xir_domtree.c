 ...
 *
 * xir_domtree.c - Cached dominator tree with DFS numbering.
 *
 * See xir_domtree.h for the public contract.  This file also owns
 * the XirFunc::domtree lifetime (alloc / free via xr_malloc).
 */
...
/*
 * Build a XirDomTree from an already-computed idom[] array.
 *
 * This separates the "who-dominates-whom" computation (Cooper, lives
 * in xir.c) from the tree-materialisation step (DFS numbering + child
