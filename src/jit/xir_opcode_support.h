...
static const JitOpcodeSupport jit_op_support_table[NUM_OPCODES] = {
    ...
    [OP_AWAIT] =
        JIT_OP_SUPPORTED,  // deopt-based: fast path in JIT, slow path deopts to interpreter
...
_Static_assert(sizeof(jit_op_support_table) / sizeof(jit_op_support_table[0]) == NUM_OPCODES,
