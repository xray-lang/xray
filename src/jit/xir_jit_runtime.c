...
bool xir_jit_osr_enter(void *osr_entry, XrCoroutine *coro, int64_t *values, uint8_t return_type,
                       XrValue *result) {
    if (!osr_entry || !result)
        return false;
...
int xir_jit_osr_trigger(XirJitState *jit, XrProto *proto, XrCoroutine *coro, uint32_t bc_pc,
