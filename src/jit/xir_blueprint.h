 ...
 *
 * xir_blueprint.h - Compiler-generated JIT metadata (loop liveness for OSR)
 *
 * KEY CONCEPT:
 ...
 *   - xir_codegen.c: consumes loop live maps for OSR stub generation
 */

#ifndef XIR_BLUEPRINT_H
#define XIR_BLUEPRINT_H
...
// Max live slots per loop header (matches XIR_MAX_OSR_SLOTS)
