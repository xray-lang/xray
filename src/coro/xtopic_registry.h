...
typedef struct XrTopicDeliveryStats {
    int64_t accepted;
    int64_t full;
    int64_t stopped;
    int64_t resource;
} XrTopicDeliveryStats;
...
XR_FUNC XrTopicDeliveryStats xr_topic_registry_deliver(XrTopicRegistry *registry, const char *topic,
