...
XrValue xr_sys_provider_sleep_ms(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
...
XrValue xr_sys_provider_pin_to_cpu(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
...
XrValue xr_sys_provider_thread_local_id(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
    (void) args;
    (void) argc;
...
XrValue xr_sys_provider_thread_local_alive(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
...
XrValue xr_sys_provider_dylib_open(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
...
XrValue xr_sys_provider_dylib_symbol(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
...
XrValue xr_sys_provider_dylib_close(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
    if (argc < 1 || !XR_IS_INT(args[0]))
        return xr_bool(false);
    XrDylib *lib = (XrDylib *) (intptr_t) XR_TO_INT(args[0]);
...
XrValue xr_sys_provider_dylib_last_error(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) args;
    (void) argc;
...
XrValue xr_sys_provider_process_spawn(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
    if (argc < 9)
...
XrCFuncResult xr_sys_provider_process_wait(XrVMRuntime *isolate, XrValue *args, int argc,
                                           XrValue *result) {
    if (argc < 1 || !XR_IS_INT(args[0])) {
        *result = xr_int(-1);
        return XR_CFUNC_DONE;
...
XrValue xr_sys_provider_process_try_wait(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
    if (argc < 1 || !XR_IS_INT(args[0]))
        return xr_int(-1);
...
XrValue xr_sys_provider_process_kill(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
...
XrValue xr_sys_provider_pipe_open(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) args;
    (void) argc;
...
XrCFuncResult xr_sys_provider_pipe_read(XrVMRuntime *isolate, XrValue *args, int argc,
                                        XrValue *result) {
    if (argc < 2 || !XR_IS_INT(args[0]) || !XR_IS_INT(args[1])) {
        *result = xr_null();
        return XR_CFUNC_DONE;
...
XrCFuncResult xr_sys_provider_pipe_write(XrVMRuntime *isolate, XrValue *args, int argc,
                                         XrValue *result) {
...
XrValue xr_sys_provider_pipe_close(XrVMRuntime *isolate, XrValue *args, int argc) {
    (void) isolate;
    if (argc < 1 || !XR_IS_INT(args[0]))
        return xr_bool(false);
...
XrValue xr_sys_provider_on_signal(XrVMRuntime *isolate, XrValue *args, int argc) {
    if (argc < 2 || !XR_IS_INT(args[0]))
        return xr_bool(false);
