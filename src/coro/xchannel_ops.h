...
static inline XrValue xr_chan_prepare_send_transfer(struct XrayIsolate *isolate, XrValue value,
                                                    uint8_t mode) {
...
static inline bool xr_chan_try_send_transfer(struct XrayIsolate *isolate, XrChannel *ch,
