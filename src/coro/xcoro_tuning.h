 ...
 * One lets a blocked peer run immediately, then returns to the fair ready
 * queue before a request/reply pair can monopolize the worker. */
#define XR_FAST_DISPATCH_BUDGET 1
