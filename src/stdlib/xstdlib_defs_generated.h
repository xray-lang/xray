...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"io", "readFileBytes", "(path: string): Array<byte>?", "Read entire file as byte array", "io_readFileBytes", "yieldable", "", "xrt_io_read_file_bytes", "s", "value", "", "", "system", "method", 1, true},
    ...
    {"io", "writeFileBytes", "(path: string, data: Array<byte>): bool", "Write byte array to file", "io_writeFileBytes", "yieldable", "", "xrt_io_write_file_bytes", "sv", "value", "", "", "system", "method", 2, true},
