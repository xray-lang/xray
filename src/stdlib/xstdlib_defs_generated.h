...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"sys", "__dylibSymbol", "(handle: int, name: string): RawPtr<byte>?", "Resolve a dynamic-library symbol to a raw address, or null on failure", "sys_dylib_symbol", "normal", "", "xrt_sys_dylib_symbol", "vs", "value", "", "", "system", "method", 2, true},
    ...
    {"io", "cwd", "(): Path", "Get current working directory", "io_cwd", "normal", "", "xrt_io_cwd", "", "value", "", "", "system", "method", 0, true},
    ...
    {"io", "readDir", "(path: Path): Array<Path>", "List directory entries", "io_readDir", "normal", "", "xrt_io_read_dir", "p", "value", "", "", "system", "method", 1, true},
    {"io", "readDirRecursive", "(path: Path): Array<Path>", "List directory entries recursively", "io_readDirRecursive", "normal", "", "xrt_io_read_dir_recursive", "p", "value", "", "", "system", "method", 1, true},
    ...
    {"io", "readlink", "(path: Path): Path?", "Read symlink target", "io_readlink", "normal", "", "xrt_io_readlink", "p", "value", "", "", "system", "method", 1, true},
    {"io", "realpath", "(path: Path): Path?", "Resolve to absolute path", "io_realpath", "normal", "", "xrt_io_realpath", "p", "value", "", "", "system", "method", 1, true},
    ...
    {"io", "tempDir", "(): Path?", "Create temporary directory", "io_tempDir", "normal", "", "xrt_io_temp_dir", "", "value", "", "", "system", "method", 0, true},
    {"io", "tempFile", "(): Path?", "Create temporary file", "io_tempFile", "normal", "", "xrt_io_temp_file", "", "value", "", "", "system", "method", 0, true},
    ...
    {"mem", "prefetch", "(ptr: RawPtr<byte>, rw: int): ()", "Prefetch a cache line at ptr (performance hint; rw!=0 = write intent). VM no-op, AOT __builtin_prefetch", "mem_prefetch", "normal", "", "xrt_mem_prefetch", "vv", "value", "", "", "core", "method", 2, true},
    {"mem", "cacheFlush", "(ptr: RawPtr<byte>, n: int): ()", "Best-effort data-cache flush for a byte range. VM no-op; AOT emits platform cache maintenance when available", "mem_cache_flush", "normal", "", "xrt_mem_cache_flush", "vv", "value", "", "", "core", "method", 2, true},
    {"mem", "cacheInvalidate", "(ptr: RawPtr<byte>, n: int): ()", "Best-effort data-cache invalidation for a byte range. VM no-op; AOT emits platform cache maintenance when available", "mem_cache_invalidate", "normal", "", "xrt_mem_cache_invalidate", "vv", "value", "", "", "core", "method", 2, true},
    {"mem", "nontemporalStore", "(ptr: RawMut<byte>, v: int, size: int): ()", "Best-effort non-temporal sized store (size in {1,2,4,8}). VM stores normally; AOT emits streaming stores when available", "mem_nontemporal_store", "normal", "", "xrt_mem_nontemporal_store", "vvv", "value", "", "", "core", "method", 3, true},
    ...
    {"mem", "pageAlloc", "(bytes: int, prot?: int): RawMut<byte>", "Allocate zero-filled anonymous pages with read/write protection (mmap/VirtualAlloc). NULL on failure; pair with mem.pageFree", "mem_page_alloc", "normal", "", "xrt_mem_page_alloc_default", "v", "value", "", "", "core", "method", 1, true},
    {"mem", "pageAlloc", "(bytes: int, prot?: int): RawMut<byte>", "Allocate zero-filled anonymous pages with protection bits PROT_READ/PROT_WRITE/PROT_EXEC (mmap/VirtualAlloc). NULL on failure; pair with mem.pageFree", "mem_page_alloc", "normal", "", "xrt_mem_page_alloc", "vv", "value", "", "", "core", "method", 2, true},
    {"mem", "pageProtect", "(ptr: RawMut<byte>, bytes: int, prot: int): bool", "Change anonymous page protection bits; returns false on OS failure", "mem_page_protect", "normal", "", "xrt_mem_page_protect", "vvv", "value", "", "", "core", "method", 3, true},
    {"mem", "pageFree", "(ptr: RawMut<byte>, bytes: int): bool", "Release anonymous pages from mem.pageAlloc; returns false on OS failure", "mem_page_free", "normal", "", "xrt_mem_page_free", "vv", "value", "", "", "core", "method", 2, true},
    {"mem", "fromAddress", "(addr: int): RawMut<byte>", "Construct a raw pointer from a numeric address (MMIO/physical memory; task 147 §7.2). Constructing is safe, dereferencing requires unsafe", "mem_from_address", "normal", "", "xrt_mem_from_address", "v", "value", "", "", "core", "method", 1, true},
    {"mem", "addressOf", "(ptr: RawPtr<byte>): int", "Numeric address of any raw pointer (alignment checks, diagnostics; inverse of mem.fromAddress)", "mem_address_of", "normal", "", "xrt_mem_address_of", "v", "value", "", "", "core", "method", 1, true},
    {"mem", "copy", "(dst: RawMut<byte>, src: RawPtr<byte>, n: int): ()", "Copy n bytes from src to dst (non-overlapping; memcpy)", "mem_copy", "normal", "", "xrt_mem_copy", "vvv", "value", "", "", "core", "method", 3, true},
    {"mem", "move", "(dst: RawMut<byte>, src: RawPtr<byte>, n: int): ()", "Copy n bytes from src to dst (may overlap; memmove)", "mem_move", "normal", "", "xrt_mem_move", "vvv", "value", "", "", "core", "method", 3, true},
    {"mem", "set", "(dst: RawMut<byte>, byte: int, n: int): ()", "Fill n bytes at dst with byte (memset)", "mem_set", "normal", "", "xrt_mem_set", "vvv", "value", "", "", "core", "method", 3, true},
    {"mem", "compare", "(a: RawPtr<byte>, b: RawPtr<byte>, n: int): int", "Compare n bytes at a and b (memcmp: <0, 0, >0)", "mem_compare", "normal", "", "xrt_mem_compare", "vvv", "value", "", "", "core", "method", 3, true},
    {"mem", "volatileLoad", "(ptr: RawPtr<byte>, size: int): int", "Volatile load of size bytes (MMIO; size in {1,2,4,8}, native byte order)", "mem_volatile_load", "normal", "", "xrt_mem_volatile_load", "vv", "value", "", "", "core", "method", 2, true},
    {"mem", "volatileStore", "(ptr: RawMut<byte>, v: int, size: int): ()", "Volatile store of size bytes (MMIO; size in {1,2,4,8}, native byte order)", "mem_volatile_store", "normal", "", "xrt_mem_volatile_store", "vvv", "value", "", "", "core", "method", 3, true},
    ...
    {"net", "readInto", "(conn: NetConn, buffer: Array<byte>, maxlen?: int): int", "Read data into a reusable Array<byte> buffer", "net_read_into_yieldable", "yieldable", "", "", "", "value", "", "", "runtime", "", 3, false},
    ...
    {"net", "writeBytes", "(conn: NetConn, data: Array<byte>): int", "Write Array<byte> data to connection", "net_write_bytes_yieldable", "yieldable", "", "", "", "value", "", "", "runtime", "", 2, false},
...
static const XrStdlibTypeMethodDefEntry xr_stdlib_type_method_def_entries[] = {
    ...
    {"mem", "Buffer", "ptr", "(): RawMut<byte>", "Return the underlying raw pointer; requires unsafe at the call site"},
