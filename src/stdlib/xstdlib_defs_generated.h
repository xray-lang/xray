...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"cluster", "__readPeer", "(peerGeneration: i64, maxFramePayload: i64): Array<u8> | i64", "Suspend for one frame and return owned wire bytes or an orthogonal raw stale, stopped, EOF, socket-I/O, provider, wire-length, capacity, resource, cancellation or caller-limit reason", "cluster_peer_read_fn", "yieldable", "", "", "vv", "value", "", "", "", "runtime", "", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 2, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__writePeer", "(peerGeneration: i64): i64", "Suspend while writing at most one queued batch and return an orthogonal raw stale, stopped, full, resource, socket, socket-I/O, provider or cancellation reason", "cluster_peer_write_fn", "yieldable", "", "", "v", "value", "", "", "", "runtime", "", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 1, XR_STDLIB_TARGET_LEAF_NONE, false},
