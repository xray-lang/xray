...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"mem", "fromAddress", "(addr: int): MutPtr<byte>", "Construct a raw pointer from a numeric address (MMIO/physical memory; task 147 §7.2). Constructing is safe, dereferencing requires unsafe", "mem_from_address", "normal", "", "xrt_mem_from_address", "v", "value", "", "", "core", "method", 1, true},
    {"mem", "addressOf", "(ptr: Ptr<byte>): int", "Numeric address of any raw pointer (alignment checks, diagnostics; inverse of mem.fromAddress)", "mem_address_of", "normal", "", "xrt_mem_address_of", "v", "value", "", "", "core", "method", 1, true},
