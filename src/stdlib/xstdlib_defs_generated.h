...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"cluster", "__start", "(name: string, port: i64, secret: string, tlsEnabled: bool, caFile: string, certFile: string, keyFile: string, insecure: bool, heartbeatIntervalMs: i64, heartbeatTimeoutMs: i64, maxMissedHeartbeats: i64, phiThreshold: f64, topicDeliveryFanoutMax: i64): bool", "Start the backend-neutral cluster runtime from normalized scalar configuration and the health policy cluster.xr decides", "cluster_start_primitive", "normal", "", "xrt_cluster_start", "svsvsssvvvvvv", "value", "", "cluster.__start", "", "runtime", "method", XR_CAP_CHANNEL, 13, XR_STDLIB_TARGET_LEAF_NONE, true},
    ...
    {"cluster", "__monitorNode", "(name: string): Channel<string>?", "Register a node-down monitor for one normalized node target", "cluster_monitor_node_fn", "normal", "", "", "s", "value", "", "", "", "runtime", "", 0, 1, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__monitorCoroutine", "(nodeName: string, coroutineName: string): Channel<string>?", "Register a remote-coroutine monitor for normalized node and coroutine names", "cluster_monitor_coro_fn", "normal", "", "", "ss", "value", "", "", "", "runtime", "", 0, 2, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__discover", "(): bool", "Start LAN auto-discovery", "cluster_discover_fn", "normal", "", "", "", "value", "", "", "", "runtime", "", 0, 0, XR_STDLIB_TARGET_LEAF_NONE, false},
    ...
    {"cluster", "__publishLocal", "(topic: string, envelope: Buffer): i64", "Offer one validated opaque service envelope to the synchronized local subscription registry", "cluster_publish_local_primitive", "normal", "", "xrt_cluster_publish_local", "sv", "i64", "", "cluster.__publishLocal", "", "runtime", "method", XR_CAP_CHANNEL, 2, XR_STDLIB_TARGET_LEAF_NONE, true},
    {"cluster", "__publishRemote", "(topic: string, envelope: move Buffer, hopLimit: i64): i64", "Broadcast one validated opaque service envelope to connected native transports", "cluster_publish_remote_primitive", "normal", "", "xrt_cluster_publish_remote", "svv", "i64", "", "cluster.__publishRemote", "", "runtime", "method", XR_CAP_CHANNEL, 3, XR_STDLIB_TARGET_LEAF_NONE, true},
