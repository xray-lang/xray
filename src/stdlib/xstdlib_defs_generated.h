...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"mem", "slice", "(ptr: Ptr<byte>, count: int, owner: any): Slice<byte>", "Unsafe compiler-verified borrowed Slice over raw memory, rooted in owner", "mem_slice_intrinsic", "normal", "", "", "vvv", "value", "", "", "", "core", "", 3, false},
    ...
    {"mem", "withSliceMut", "(ptr: MutPtr<byte>, count: int, guard: any, callback: any): any", "Unsafe compiler-verified exclusive mutable Slice loan scoped to a no-suspend callback", "mem_with_slice_mut_intrinsic", "normal", "", "", "vvvv", "value", "", "", "", "core", "", 4, false},
