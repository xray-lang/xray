...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"sys", "__dylibOpen", "(path: Path): int", "Open a dynamic library and return an opaque handle token, or 0 on failure", "sys_dylib_open", "normal", "", "xrt_sys_dylib_open", "p", "value", "", "", "", "system", "method", 1, true},
    {"sys", "__dylibSymbol", "(handle: int, name: string): Ptr<byte>?", "Resolve a dynamic-library symbol to a raw address, or null on failure", "sys_dylib_symbol", "normal", "", "xrt_sys_dylib_symbol", "vs", "value", "", "", "", "system", "method", 2, true},
    ...
    {"sys", "__pipeRead", "(handle: int, maxBytes: int): Array<byte>?", "Read one chunk from a pipe endpoint", "sys_pipe_read_yieldable", "yieldable", "", "xrt_sys_pipe_read", "vv", "value", "", "", "", "system", "method", 2, true},
    {"sys", "__pipeWrite", "(handle: int, data: Array<byte>): int", "Write one chunk to a pipe endpoint", "sys_pipe_write_yieldable", "yieldable", "", "xrt_sys_pipe_write", "vv", "value", "", "", "", "system", "method", 2, true},
    ...
    {"os", "chdir", "(path: Path): bool", "Change working directory", "os_chdir", "normal", "", "xrt_os_chdir", "p", "value", "", "", "", "system", "method", 1, true},
    ...
    {"io", "appendFile", "(path: Path, data: string): bool", "Append string to file", "io_appendFile", "normal", "", "xrt_io_append_file", "ps", "value", "", "", "", "system", "method", 2, true},
    {"io", "chmod", "(path: Path, mode: int): bool", "Change file permissions", "io_chmod", "normal", "", "xrt_io_chmod_value", "pv", "value", "", "", "", "system", "method", 2, true},
    {"io", "chdir", "(path: Path): bool", "Change working directory", "io_chdir", "normal", "", "xrt_io_chdir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "copyFile", "(src: Path, dst: Path): bool", "Copy a file", "io_copyFile", "normal", "", "xrt_io_copy_file", "pp", "value", "", "", "", "system", "method", 2, true},
    {"io", "__cwd", "(): string", "Get current working directory (raw string; io.xr wraps as Path)", "io_cwd", "normal", "", "xrt_io_cwd", "", "value", "", "", "", "system", "method", 0, true},
    {"io", "exists", "(path: Path): bool", "Check if path exists", "io_exists", "normal", "", "xrt_io_exists", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__fileClose", "(handle: int): bool", "Close an owned binary file handle", "io_fileClose", "normal", "", "xrt_io_file_close", "i", "value", "", "", "", "system", "method", 1, true},
    {"io", "__fileOpen", "(path: Path): int", "Open a file for binary reading and return an opaque handle", "io_fileOpen", "normal", "", "xrt_io_file_open", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__fileRead", "(handle: int, maxBytes: int): Array<byte>?", "Read at most maxBytes from an opaque binary stream; empty means EOF", "io_fileRead", "normal", "", "xrt_io_read_handle_chunk", "ii", "value", "", "", "", "system", "method", 2, true},
    {"io", "fileSize", "(path: Path): int", "Get file size in bytes", "io_fileSize", "normal", "", "xrt_io_file_size", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "isDir", "(path: Path): bool", "Check if path is a directory", "io_isDir", "normal", "", "xrt_io_is_dir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "isFile", "(path: Path): bool", "Check if path is a file", "io_isFile", "normal", "", "xrt_io_is_file", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "isSymlink", "(path: Path): bool", "Check if path is a symlink", "io_isSymlink", "normal", "", "xrt_io_is_symlink", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "mkdir", "(path: Path): bool", "Create directory", "io_mkdir", "normal", "", "xrt_io_mkdir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "mkdirp", "(path: Path): bool", "Create directory recursively", "io_mkdirp", "normal", "", "xrt_io_mkdirp", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__readDir", "(path: Path): Array<string>", "List directory entries (raw strings; io.xr wraps as Path)", "io_readDir", "normal", "", "xrt_io_read_dir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__readDirRecursive", "(path: Path): Array<string>", "List directory entries recursively (raw strings; io.xr wraps as Path)", "io_readDirRecursive", "normal", "", "xrt_io_read_dir_recursive", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "readFile", "(path: Path): string?", "Read entire file as string", "io_readFile", "yieldable", "", "xrt_io_read_file", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "readFileBytes", "(path: Path): Array<byte>?", "Read entire file as byte array", "io_readFileBytes", "yieldable", "", "xrt_io_read_file_bytes", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "readLines", "(path: Path): Array<string>", "Read file as lines", "io_readLines", "normal", "", "xrt_io_read_lines", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "readStdin", "(): string?", "Read all data from standard input", "io_readStdin", "normal", "", "xrt_io_read_stdin", "", "value", "", "", "", "system", "method", 0, true},
    {"io", "readStdinBytes", "(): Array<byte>?", "Read all standard input as binary bytes", "io_readStdinBytes", "normal", "", "xrt_io_read_stdin_bytes", "", "value", "", "", "", "system", "method", 0, true},
    {"io", "__readlink", "(path: Path): string?", "Read symlink target (raw string; io.xr wraps as Path)", "io_readlink", "normal", "", "xrt_io_readlink", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__realpath", "(path: Path): string?", "Resolve to absolute path (raw string; io.xr wraps as Path)", "io_realpath", "normal", "", "xrt_io_realpath", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "remove", "(path: Path): bool", "Remove a file", "io_remove", "normal", "", "xrt_io_remove", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "removeAll", "(path: Path): bool", "Remove directory recursively", "io_removeAll", "normal", "", "xrt_io_remove_all", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "rename", "(old: Path, new: Path): bool", "Rename a file", "io_rename", "normal", "", "xrt_io_rename", "pp", "value", "", "", "", "system", "method", 2, true},
    {"io", "stat", "(path: Path): FileStat?", "Get file stat info", "io_stat", "normal", "", "xrt_io_stat", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "symlink", "(target: Path, link: Path): bool", "Create symbolic link", "io_symlink", "normal", "", "xrt_io_symlink", "pp", "value", "", "", "", "system", "method", 2, true},
    {"io", "__tempDir", "(): string?", "Create temporary directory (raw string; io.xr wraps as Path)", "io_tempDir", "normal", "", "xrt_io_temp_dir", "", "value", "", "", "", "system", "method", 0, true},
    {"io", "__tempFile", "(): string?", "Create temporary file (raw string; io.xr wraps as Path)", "io_tempFile", "normal", "", "xrt_io_temp_file", "", "value", "", "", "", "system", "method", 0, true},
    {"io", "touch", "(path: Path): bool", "Create or update file timestamp", "io_touch", "normal", "", "xrt_io_touch", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "writeFile", "(path: Path, data: string): bool", "Write string to file", "io_writeFile", "yieldable", "", "xrt_io_write_file", "ps", "value", "", "", "", "system", "method", 2, true},
    {"io", "writeFileBytes", "(path: Path, data: Array<byte>): bool", "Write byte array to file", "io_writeFileBytes", "yieldable", "", "xrt_io_write_file_bytes", "pv", "value", "", "", "", "system", "method", 2, true},
    {"io", "writeStderr", "(data: string): bool", "Write text to standard error without adding a newline", "io_writeStderr", "normal", "", "xrt_io_write_stderr", "s", "value", "", "", "", "system", "method", 1, true},
    ...
    {"runtime", "collectCycles", "(): int", "Run cycle collection + whole-block reclaim, return cycle collection count", "runtime_collect_cycles", "normal", "", "xr_aot_runtime_collect_cycles", "", "value", "", "", "", "runtime", "", 0, false},
    {"runtime", "disableCycleCollection", "(): ()", "Pause the automatic cycle collector", "runtime_disable_cycle_collection", "normal", "", "xr_aot_runtime_disable_cycle_collection", "", "value", "", "", "", "runtime", "", 0, false},
    {"runtime", "enableCycleCollection", "(): ()", "Resume the automatic cycle collector", "runtime_enable_cycle_collection", "normal", "", "xr_aot_runtime_enable_cycle_collection", "", "value", "", "", "", "runtime", "", 0, false},
    {"runtime", "isCycleCollectionEnabled", "(): bool", "Check if automatic cycle collection is enabled", "runtime_is_cycle_collection_enabled", "normal", "", "xr_aot_runtime_is_cycle_collection_enabled", "", "value", "", "", "", "runtime", "", 0, false},
    ...
    {"runtime", "info", "(): RuntimeInfo", "Get a typed snapshot of the current coroutine heap and cycle collector", "runtime_info", "normal", "", "xr_aot_runtime_info", "", "value", "", "", "", "runtime", "", 0, false},
    ...
    {"mem", "compilerGuard", "(value: u64): u64", "Return value unchanged while creating a best-effort native compiler scheduling barrier", "mem_compiler_guard_u64", "normal", "", "xrt_mem_compiler_guard_u64", "v", "value", "", "", "", "core", "method", 1, true},
    {"mem", "compilerOpaque", "(value: u64): u64", "Return value unchanged while hiding its concrete bits from native constant propagation; not a memory barrier", "mem_compiler_opaque_u64", "normal", "", "xrt_mem_compiler_opaque_u64", "v", "value", "", "", "", "core", "method", 1, true},
    ...
    {"mem", "cacheInvalidate", "(ptr: Ptr<byte>, n: int): ()", "Best-effort data-cache invalidation for a byte range. VM no-op; AOT emits platform cache maintenance when available", "mem_cache_invalidate", "normal", "", "xrt_mem_cache_invalidate", "vv", "value", "", "", "", "core", "method", 2, true},
    {"mem", "nontemporalStore", "(ptr: MutPtr<byte>, v: int, size: int): ()", "Best-effort non-temporal sized store (size in {1,2,4,8}). VM stores normally; AOT emits streaming stores when available", "mem_nontemporal_store", "normal", "", "xrt_mem_nontemporal_store", "vvv", "value", "", "", "", "core", "method", 3, true},
    ...
    {"mem", "slice", "(ptr: Ptr<byte>, count: int, owner: any): Slice<byte>", "Unsafe caller-proven borrowed Slice over raw memory, rooted in owner; pointer, count, alignment, and range are unchecked", "mem_slice_intrinsic", "normal", "", "", "vvv", "value", "", "", "", "core", "", 3, false},
    {"mem", "assumeInitialized", "(buffer: Buffer): any", "Unsafe compiler-verified materialization of a completely initialized native output Buffer as T", "mem_assume_initialized_intrinsic", "normal", "", "", "v", "value", "", "", "", "core", "", 1, false},
    ...
    {"mem", "pageAlloc", "(bytes: int, prot?: int): MutPtr<byte>", "Allocate zero-filled anonymous pages with read/write protection (mmap/VirtualAlloc). NULL on failure; pair with mem.pageFree", "mem_page_alloc", "normal", "", "xrt_mem_page_alloc_default", "v", "value", "", "", "", "core", "method", 1, true},
    {"mem", "pageAlloc", "(bytes: int, prot?: int): MutPtr<byte>", "Allocate zero-filled anonymous pages with protection bits PROT_READ/PROT_WRITE/PROT_EXEC (mmap/VirtualAlloc). NULL on failure; pair with mem.pageFree", "mem_page_alloc", "normal", "", "xrt_mem_page_alloc", "vv", "value", "", "", "", "core", "method", 2, true},
    {"mem", "pageProtect", "(ptr: MutPtr<byte>, bytes: int, prot: int): bool", "Change anonymous page protection bits; returns false on OS failure", "mem_page_protect", "normal", "", "xrt_mem_page_protect", "vvv", "value", "", "", "", "core", "method", 3, true},
    {"mem", "pageFree", "(ptr: MutPtr<byte>, bytes: int): bool", "Release anonymous pages from mem.pageAlloc; returns false on OS failure", "mem_page_free", "normal", "", "xrt_mem_page_free", "vv", "value", "", "", "", "core", "method", 2, true},
    {"mem", "ptr", "(addr: int): Ptr<byte>", "Construct Ptr<T> from a numeric address; constructing is safe, dereferencing requires unsafe", "mem_ptr", "normal", "", "xrt_mem_ptr", "v", "value", "", "", "", "core", "method", 1, true},
    {"mem", "withSliceMut", "(ptr: MutPtr<byte>, count: int, guard: any, callback: any): any", "Unsafe caller-proven exclusive mutable Slice loan scoped to a no-suspend callback; pointer, count, alignment, and range are unchecked", "mem_with_slice_mut_intrinsic", "normal", "", "", "vvvv", "value", "", "", "", "core", "", 4, false},
    {"mem", "mutPtr", "(addr: int): MutPtr<byte>", "Construct MutPtr<T> from a numeric address; constructing is safe, dereferencing requires unsafe", "mem_mut_ptr", "normal", "", "xrt_mem_mut_ptr", "v", "value", "", "", "", "core", "method", 1, true},
    {"mem", "addr", "(ptr: Ptr<byte>): int", "Numeric address of any Ptr<T> or MutPtr<T>", "mem_addr", "normal", "", "xrt_mem_addr", "v", "value", "", "", "", "core", "method", 1, true},
    {"mem", "load", "(ptr: Ptr<byte>, offset?: int, endian?: Endian): int", "Unsafe unaligned load of scalar or pointer T from ptr plus a byte offset", "mem_load_intrinsic", "normal", "", "", "vvv", "value", "", "", "", "core", "", 3, false},
    {"mem", "store", "(ptr: MutPtr<byte>, offset: int, value: any, endian?: Endian): ()", "Unsafe unaligned store of scalar or pointer T at ptr plus a byte offset", "mem_store_intrinsic", "normal", "", "", "vvvv", "value", "", "", "", "core", "", 4, false},
    {"mem", "copy", "(dst: MutPtr<byte>, src: Ptr<byte>, n: int): ()", "Copy n bytes from src to dst (non-overlapping; memcpy)", "mem_copy", "normal", "", "xrt_mem_copy", "vvv", "value", "", "", "", "core", "method", 3, true},
    {"mem", "move", "(dst: MutPtr<byte>, src: Ptr<byte>, n: int): ()", "Copy n bytes from src to dst (may overlap; memmove)", "mem_move", "normal", "", "xrt_mem_move", "vvv", "value", "", "", "", "core", "method", 3, true},
    {"mem", "set", "(dst: MutPtr<byte>, byte: int, n: int): ()", "Fill n bytes at dst with byte (memset)", "mem_set", "normal", "", "xrt_mem_set", "vvv", "value", "", "", "", "core", "method", 3, true},
    ...
    {"net", "readInto", "(conn: NetConn, buffer: Array<byte>, maxlen?: int): int", "Read data into a reusable Array<byte> buffer", "net_read_into_yieldable", "yieldable", "", "xrt_net_read_into", "vvv", "value", "", "", "", "runtime", "method", 3, true},
    ...
    {"net", "writeBytes", "(conn: NetConn, data: Array<byte>): int", "Write Array<byte> data to connection", "net_write_bytes_yieldable", "yieldable", "", "xrt_net_write_bytes", "vv", "value", "", "", "", "runtime", "method", 2, true},
    ...
    {"net", "copyBidirectional", "(a: NetConn, b: NetConn): CopyBidirectionalResult", "Copy two TCP/TLS streams in both directions", "net_copy_bidirectional_yieldable", "yieldable", "", "xrt_net_copy_bidirectional", "vv", "i64_pair_result", "NetError", "", "", "runtime", "method", 2, true},
    ...
    {"http", "__h2Supported", "(): bool", "Whether this backend provides the internal HTTP/2 data plane", "h2_supported", "normal", "", "xrt_http_h2_supported", "", "value", "", "", "", "runtime", "method", 0, true},
    {"http", "__h2Request", "(url: string, method: string, headerNames: Array<string>, headerValues: Array<string>, body: Array<byte>, timeoutMs: int): (int, Array<string>, Array<string>, Array<byte>)?", "Internal typed HTTP/2 data-plane request", "h2_request_typed", "normal", "", "xrt_http_h2_request_unavailable", "vvvvvv", "value", "", "", "", "runtime", "method", 6, true},
