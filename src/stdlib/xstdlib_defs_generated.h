...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"runtime", "sharedBytes", "(): int", "Live bytes held by SYNC_SHARED system-heap objects (process-wide); a monotonic rise is the cheap production signal of a shared-domain cycle leak", "runtime_shared_bytes", "normal", "", "xr_aot_runtime_shared_bytes", "", "value", "", "", "", "runtime", "", 0, false},
    {"runtime", "staticBytes", "(): int", "Bytes allocated into the MODULE_STATIC class/module arena (process-wide, grows only)", "runtime_static_bytes", "normal", "", "xr_aot_runtime_static_bytes", "", "value", "", "", "", "runtime", "", 0, false},
