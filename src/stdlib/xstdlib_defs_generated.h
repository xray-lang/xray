...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"sys", "RwLock", "(): RwLock", "Create an OS-domain read-write lock", "sys_rwlock_new", "normal", "", "xrt_sys_rwlock_new", "", "value", "", "", "system", "method", 0, true},
    {"sys", "Condvar", "(): Condvar", "Create an OS-domain condition variable", "sys_condvar_new", "normal", "", "xrt_sys_condvar_new", "", "value", "", "", "system", "method", 0, true},
    {"sys", "Barrier", "(parties: int): Barrier", "Create a reusable OS-domain barrier", "sys_barrier_new", "normal", "", "xrt_sys_barrier_new", "v", "value", "", "", "system", "method", 1, true},
    {"sys", "Once", "(): Once", "Create an OS-domain once gate", "sys_once_new", "normal", "", "xrt_sys_once_new", "", "value", "", "", "system", "method", 0, true},
    ...
    {"mem", "alloc", "(n: int): RawMut<uint8>", "Allocate n uninitialized bytes (malloc). NULL on OOM; pair with mem.free", "mem_alloc", "normal", "", "xrt_mem_alloc", "v", "value", "", "", "core", "method", 1, true},
    {"mem", "allocZeroed", "(n: int): RawMut<uint8>", "Allocate n zero-initialized bytes (calloc). NULL on OOM; pair with mem.free", "mem_alloc_zeroed", "normal", "", "xrt_mem_alloc_zeroed", "v", "value", "", "", "core", "method", 1, true},
...
static const XrStdlibTypeMethodDefEntry xr_stdlib_type_method_def_entries[] = {
    ...
    {"sys", "RwLock", "rdlock", "(): ()", "Acquire the read side of the read-write lock"},
    {"sys", "RwLock", "rdunlock", "(): ()", "Release the read side of the read-write lock"},
    {"sys", "RwLock", "wrlock", "(): ()", "Acquire the write side of the read-write lock"},
    {"sys", "RwLock", "wrunlock", "(): ()", "Release the write side of the read-write lock"},
    {"sys", "Condvar", "wait", "(m: Mutex): ()", "Wait on the condition variable with an already-locked mutex"},
    {"sys", "Condvar", "waitFor", "(m: Mutex, timeoutNs: int): bool", "Wait on the condition variable until signalled or timeout elapses"},
    {"sys", "Condvar", "signal", "(): ()", "Wake one waiter"},
    {"sys", "Condvar", "broadcast", "(): ()", "Wake all waiters"},
    {"sys", "Barrier", "wait", "(): bool", "Wait until all parties have arrived"},
    {"sys", "Once", "call", "(body: fn(): ()): ()", "Run the closure exactly once"},
...
static const XrStdlibNativeClassDefEntry xr_stdlib_native_class_def_entries[] = {
    ...
    {"sys", "RwLock", "objectClass", "sysRwLockClass", "&g_sys_rwlock_body_desc", "XR_CLASS_BUILTIN | XR_CLASS_HAS_NATIVE_BODY", "XR_BK_SYSRWLOCK"},
    {"sys", "Condvar", "objectClass", "sysCondvarClass", "&g_sys_condvar_body_desc", "XR_CLASS_BUILTIN | XR_CLASS_HAS_NATIVE_BODY", "XR_BK_SYSCONDVAR"},
    {"sys", "Barrier", "objectClass", "sysBarrierClass", "&g_sys_barrier_body_desc", "XR_CLASS_BUILTIN | XR_CLASS_HAS_NATIVE_BODY", "XR_BK_SYSBARRIER"},
    {"sys", "Once", "objectClass", "sysOnceClass", "&g_sys_once_body_desc", "XR_CLASS_BUILTIN | XR_CLASS_HAS_NATIVE_BODY", "XR_BK_SYSONCE"},
...
static const XrStdlibClassMethodDefEntry xr_stdlib_class_method_def_entries[] = {
    ...
    {"sys", "RwLock", "rdlock", "sys_rwlock_rdlock", 0, "0"},
    {"sys", "RwLock", "rdunlock", "sys_rwlock_rdunlock", 0, "0"},
    {"sys", "RwLock", "wrlock", "sys_rwlock_wrlock", 0, "0"},
    {"sys", "RwLock", "wrunlock", "sys_rwlock_wrunlock", 0, "0"},
    {"sys", "Condvar", "wait", "sys_condvar_wait", 1, "0"},
    {"sys", "Condvar", "waitFor", "sys_condvar_wait_for", 2, "0"},
    {"sys", "Condvar", "signal", "sys_condvar_signal", 0, "0"},
    {"sys", "Condvar", "broadcast", "sys_condvar_broadcast", 0, "0"},
    {"sys", "Barrier", "wait", "sys_barrier_wait", 0, "0"},
    {"sys", "Once", "call", "sys_once_call", 1, "0"},
