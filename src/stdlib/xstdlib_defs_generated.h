...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"runtime", "staticBytes", "(): int", "Memory allocated into the MODULE_STATIC class/module arena (process-wide, grows only)", "runtime_static_bytes", "normal", "", "xr_aot_runtime_static_bytes", "", "value", "", "", "", "runtime", "", 0, false},
    ...
    {"cluster", "publish", "(topic: string, value: JSON.Value): bool", "Publish to topic", "cluster_publish_fn", "normal", "", "", "", "value", "", "", "", "runtime", "", 2, false},
