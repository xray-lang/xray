...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"cluster", "__start", "(name: string, port: i64, secret: string, tlsEnabled: bool, caFile: string, certFile: string, keyFile: string, insecure: bool, queueAndTopicLimits: i64, tombstoneRetentionMs: i64): bool", "Open cluster TLS contexts and synchronized registries from source-normalized scalar configuration", "cluster_start_primitive", "normal", "", "", "svsvsssvvv", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 10, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__healthSnapshot", "(heartbeatWire: Array<u8>, heartbeatSentAtMs: i64): Array<__ClusterHealthPeerSnapshot>?", "Enqueue one source-encoded heartbeat and snapshot locked peer detector storage", "cluster_health_snapshot_fn", "normal", "", "", "vv", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 2, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__applyHealthDecision", "(peerGeneration: i64, expectedLastReceivedAtMs: i64, expectedMissedHeartbeats: i64, nextMissedHeartbeats: i64, disconnect: bool, markedAtMs: i64): bool", "Compare and apply one source-owned health decision to the locked peer generation", "cluster_health_apply_fn", "normal", "", "", "vvvvvv", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 6, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__trackListener", "(listener: NetListener): bool", "Borrow the source-owned listener so native stop can wake its pending accept", "cluster_track_listener_fn", "normal", "", "", "v", "value", "", "", "", "runtime", "", XR_CAP_NETPOLL, 1, XR_STDLIB_TARGET_LEAF_NONE, false},
    ...
    {"cluster", "__adoptPeer", "(conn: move NetConn, name: string, host: string, port: i64, flags: i64, heartbeatIntervalMs: i64, inbound: fn(peerGeneration: i64): (), outbound: fn(peerGeneration: i64): ()): bool", "Transfer an authenticated socket into the locked cluster node registry and start generation-keyed source transport loops", "cluster_adopt_peer_fn", "normal", "", "", "vssvvvvv", "value", "", "", "", "runtime", "", XR_CAP_COROUTINE | XR_CAP_CHANNEL, 8, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__readPeer", "(peerGeneration: i64, maxFramePayload: i64): Array<u8> | i64", "Suspend for one frame and return owned wire bytes or an orthogonal raw stale, stopped, EOF, I/O, wire-length, capacity, resource, cancellation or caller-limit reason", "cluster_peer_read_fn", "yieldable", "", "", "vv", "value", "", "", "", "runtime", "", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 2, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"cluster", "__writePeer", "(peerGeneration: i64): i64", "Suspend while writing at most one queued batch and return an orthogonal raw stale, stopped, full, resource, socket, I/O or cancellation reason", "cluster_peer_write_fn", "yieldable", "", "", "v", "value", "", "", "", "runtime", "", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 1, XR_STDLIB_TARGET_LEAF_NONE, false},
    ...
    {"cluster", "__deliverInbound", "(topic: string, envelope: Array<u8>): ()", "Offer one source-decoded envelope to the synchronized topic registry and discard delivery observations", "cluster_deliver_inbound_fn", "normal", "", "", "sv", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 2, XR_STDLIB_TARGET_LEAF_NONE, false},
    ...
    {"cluster", "__notifyNodeDown", "(name: string): ()", "Publish a source-selected node-down notification through the synchronized monitor registry", "cluster_notify_node_down_fn", "normal", "", "", "s", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 1, XR_STDLIB_TARGET_LEAF_NONE, false},
    ...
    {"cluster", "__registerCoroutineMonitor", "(nodeName: string, coroutineName: string, notifications: Channel<string>): i64", "Register one source-constructed channel for a connected peer and return its generation", "cluster_register_coro_monitor_fn", "normal", "", "", "ssv", "value", "", "", "", "runtime", "", 0, 3, XR_STDLIB_TARGET_LEAF_NONE, false},
    ...
    {"cluster", "__publishLocal", "(topic: string, envelope: Buffer): __ClusterDeliveryStats?", "Return raw channel admission outcomes for one validated local publication", "cluster_publish_local_primitive", "normal", "", "", "sv", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 2, XR_STDLIB_TARGET_LEAF_NONE, false},
...
static const XrStdlibHandleFieldDefEntry xr_stdlib_object_fields_cluster___ClusterRuntimeSnapshot[] = {
    ...
    {"cluster", "__ClusterRuntimeSnapshot", "listeners", "i64", true},
...
static const XrStdlibHandleFieldDefEntry xr_stdlib_object_fields_cluster___ClusterHealthPeerSnapshot[] = {
    ...
    {"cluster", "__ClusterHealthPeerSnapshot", "missedHeartbeats", "i64", true},
    {"cluster", "__ClusterHealthPeerSnapshot", "samples", "i64", true},
    {"cluster", "__ClusterHealthPeerSnapshot", "mean", "f64", true},
    {"cluster", "__ClusterHealthPeerSnapshot", "variance", "f64", true},
