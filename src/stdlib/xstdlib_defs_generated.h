...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"sys", "__processSpawn", "(program: string, args: Array<string>, cwd: string?): int", "Spawn a process and return an opaque process handle token, or -1 on failure", "sys_process_spawn", "normal", "", "xrt_sys_process_spawn", "svv", "value", "", "", "system", "method", 3, true},
