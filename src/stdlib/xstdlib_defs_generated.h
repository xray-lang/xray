...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"os", "__getenv", "(name: string): string?", "Get environment variable", "os_getenv", "normal", "", "xrt_os_getenv", "s", "value", "", "", "", "system", "method", 1, true},
    {"os", "__setenv", "(name: string, value: string): bool", "Set environment variable", "os_setenv", "normal", "", "xrt_os_setenv", "ss", "value", "", "", "", "system", "method", 2, true},
    {"os", "__unsetenv", "(name: string): bool", "Unset environment variable", "os_unsetenv", "normal", "", "xrt_os_unsetenv", "s", "value", "", "", "", "system", "method", 1, true},
    {"os", "__environ", "(): Map<string, string>", "Get all environment variables", "os_environ", "normal", "", "xrt_os_environ", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__exit", "(code?: int): ()", "Exit process", "os_exit", "normal", "", "xrt_os_exit", "v", "value", "", "", "", "system", "method", 1, true},
    {"os", "__getpid", "(): int", "Get process ID", "os_getpid", "normal", "", "xrt_os_getpid", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__getcwd", "(): string", "Get current working directory", "os_getcwd", "normal", "", "xrt_os_getcwd", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__hostname", "(): string", "Get hostname", "os_hostname", "normal", "", "xrt_os_hostname", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__tmpdir", "(): string", "Get temporary directory path", "os_tmpdir", "normal", "", "xrt_os_tmpdir", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__username", "(): string?", "Get current user name", "os_username", "normal", "", "xrt_os_username", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__homedir", "(): string?", "Get user home directory", "os_homedir", "normal", "", "xrt_os_homedir", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__uid", "(): int", "Get user ID", "os_uid", "normal", "", "xrt_os_uid", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__gid", "(): int", "Get group ID", "os_gid", "normal", "", "xrt_os_gid", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__cpuCount", "(): int", "Get number of CPU cores", "os_cpuCount", "normal", "", "xrt_os_cpu_count", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__ppid", "(): int", "Get parent process ID", "os_ppid", "normal", "", "xrt_os_ppid", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__kill", "(pid: int, signal?: int): bool", "Send signal to process", "os_kill", "normal", "", "xrt_os_kill", "v", "value", "", "", "", "system", "method", 1, true},
    {"os", "__kill", "(pid: int, signal?: int): bool", "Send signal to process", "os_kill", "normal", "", "xrt_os_kill_signal", "vv", "value", "", "", "", "system", "method", 2, true},
    {"os", "__totalMemory", "(): int", "Get total system memory in bytes", "os_totalMemory", "normal", "", "xrt_os_total_memory", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__freeMemory", "(): int", "Get available system memory in bytes", "os_freeMemory", "normal", "", "xrt_os_free_memory", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__uptime", "(): float", "Get system uptime in seconds", "os_uptime", "normal", "", "xrt_os_uptime", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__loadavg", "(): Array<float>", "Get system load averages (1, 5, 15 min)", "os_loadavg", "normal", "", "xrt_os_loadavg", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__clock", "(): float", "Get process CPU time in seconds", "os_clock", "normal", "", "xrt_os_clock", "", "value", "", "", "", "system", "method", 0, true},
    {"os", "__sleep", "(ms: int): ()", "Sleep for milliseconds", "os_sleep", "yieldable", "", "xrt_os_sleep", "v", "value", "", "", "", "system", "method", 1, true},
    {"os", "__exec", "(cmd: string): __ExecResult?", "Execute shell command", "os_exec", "normal", "", "xrt_os_exec", "s", "value", "", "", "", "system", "method", 1, true},
    {"os", "__spawn", "(program: string, args: Array<string>): __ExecResult?", "Execute a program without a shell (injection-safe argv)", "os_spawn", "normal", "", "", "sv", "value", "", "", "", "system", "", 2, false},
    {"io", "__appendFile", "(path: Path, data: string): bool", "Append string to file", "io_appendFile", "normal", "", "xrt_io_append_file", "ps", "value", "", "", "", "system", "method", 2, true},
    {"io", "__chmod", "(path: Path, mode: int): bool", "Change file permissions", "io_chmod", "normal", "", "xrt_io_chmod_value", "pv", "value", "", "", "", "system", "method", 2, true},
    {"io", "__chdir", "(path: Path): bool", "Change working directory", "io_chdir", "normal", "", "xrt_io_chdir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__copyFile", "(src: Path, dst: Path): bool", "Copy a file", "io_copyFile", "normal", "", "xrt_io_copy_file", "pp", "value", "", "", "", "system", "method", 2, true},
    ...
    {"io", "__exists", "(path: Path): bool", "Check if path exists", "io_exists", "normal", "", "xrt_io_exists", "p", "value", "", "", "", "system", "method", 1, true},
    ...
    {"io", "__fileSize", "(path: Path): int", "Get file size in bytes", "io_fileSize", "normal", "", "xrt_io_file_size", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__isDir", "(path: Path): bool", "Check if path is a directory", "io_isDir", "normal", "", "xrt_io_is_dir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__isFile", "(path: Path): bool", "Check if path is a file", "io_isFile", "normal", "", "xrt_io_is_file", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__isSymlink", "(path: Path): bool", "Check if path is a symlink", "io_isSymlink", "normal", "", "xrt_io_is_symlink", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__mkdir", "(path: Path): bool", "Create directory", "io_mkdir", "normal", "", "xrt_io_mkdir", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__mkdirp", "(path: Path): bool", "Create directory recursively", "io_mkdirp", "normal", "", "xrt_io_mkdirp", "p", "value", "", "", "", "system", "method", 1, true},
    ...
    {"io", "__readFile", "(path: Path): string?", "Read entire file as string", "io_readFile", "yieldable", "", "xrt_io_read_file", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__readFileBytes", "(path: Path): Array<byte>?", "Read entire file as byte array", "io_readFileBytes", "yieldable", "", "xrt_io_read_file_bytes", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__readLines", "(path: Path): Array<string>", "Read file as lines", "io_readLines", "normal", "", "xrt_io_read_lines", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__readStdin", "(): string?", "Read all data from standard input", "io_readStdin", "normal", "", "xrt_io_read_stdin", "", "value", "", "", "", "system", "method", 0, true},
    {"io", "__readStdinBytes", "(): Array<byte>?", "Read all standard input as binary bytes", "io_readStdinBytes", "normal", "", "xrt_io_read_stdin_bytes", "", "value", "", "", "", "system", "method", 0, true},
    ...
    {"io", "__remove", "(path: Path): bool", "Remove a file", "io_remove", "normal", "", "xrt_io_remove", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__removeAll", "(path: Path): bool", "Remove directory recursively", "io_removeAll", "normal", "", "xrt_io_remove_all", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__rename", "(old: Path, new: Path): bool", "Rename a file", "io_rename", "normal", "", "xrt_io_rename", "pp", "value", "", "", "", "system", "method", 2, true},
    {"io", "__stat", "(path: Path): __FileStat?", "Get file stat info", "io_stat", "normal", "", "xrt_io_stat", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__symlink", "(target: Path, link: Path): bool", "Create symbolic link", "io_symlink", "normal", "", "xrt_io_symlink", "pp", "value", "", "", "", "system", "method", 2, true},
    ...
    {"io", "__touch", "(path: Path): bool", "Create or update file timestamp", "io_touch", "normal", "", "xrt_io_touch", "p", "value", "", "", "", "system", "method", 1, true},
    {"io", "__writeFile", "(path: Path, data: string): bool", "Write string to file", "io_writeFile", "yieldable", "", "xrt_io_write_file", "ps", "value", "", "", "", "system", "method", 2, true},
    {"io", "__writeFileBytes", "(path: Path, data: Array<byte>): bool", "Write byte array to file", "io_writeFileBytes", "yieldable", "", "xrt_io_write_file_bytes", "pv", "value", "", "", "", "system", "method", 2, true},
    {"io", "__writeStderr", "(data: string): bool", "Write text to standard error without adding a newline", "io_writeStderr", "normal", "", "xrt_io_write_stderr", "s", "value", "", "", "", "system", "method", 1, true},
    {"io", "__writeStdout", "(data: string): bool", "Write text to standard output without adding a newline", "io_writeStdout", "normal", "", "xrt_io_write_stdout", "s", "value", "", "", "", "system", "method", 1, true},
    ...
    {"net", "__readExactInto", "(conn: NetConn, buffer: Array<byte>, length: int): int", "Fill a reusable Array<byte> buffer up to an exact length", "net_read_exact_into_yieldable", "yieldable", "", "xrt_net_read_exact_into", "vvv", "value", "", "", "", "runtime", "method", 3, true},
    ...
    {"net", "__copy", "(src: NetConn, dst: NetConn, bufferSize?: int): int", "Copy a TCP/TLS stream using a reusable native buffer", "net_copy_yieldable", "yieldable", "", "", "", "value", "", "", "", "runtime", "", 3, false},
    ...
    {"net", "__upgradeTLS", "(conn: NetConn, hostname: string, timeout?: int): NetConn?", "Upgrade connection to TLS", "net_upgrade_tls_yieldable", "yieldable", "XR_ENABLE_TLS", "", "", "value", "", "", "", "runtime", "", 3, false},
    {"net", "__udpBind", "(port: int, addr?: string): NetConn?", "Bind a UDP socket", "net_udp_bind_handle", "normal", "", "", "", "value", "", "", "", "runtime", "", 2, false},
    {"net", "__sendTo", "(handle: NetConn, data: string, host: string, port: int): int", "Send UDP datagram", "net_send_to_yieldable", "yieldable", "", "", "", "value", "", "", "", "runtime", "", 4, false},
