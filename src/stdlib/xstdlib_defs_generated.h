...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"net", "__newTlsClientContext", "(caFile: string, certFile: string, keyFile: string, verifyPeer: bool): __TlsContextStorage?", "Create one immutable client TLS policy resource from source-validated paths and verification policy", "net_tls_client_context_new", "normal", "", "", "sssv", "value", "", "", "", "runtime", "", 0, 4, XR_STDLIB_TARGET_LEAF_NONE, false},
    {"net", "__newTlsServerContext", "(certFile: string, keyFile: string, caFile: string, requireClientCertificate: bool): __TlsContextStorage?", "Create one immutable server TLS policy resource, optionally requiring a CA-verified client certificate", "net_tls_server_context_new", "normal", "", "", "sssv", "value", "", "", "", "runtime", "", 0, 4, XR_STDLIB_TARGET_LEAF_NONE, false},
