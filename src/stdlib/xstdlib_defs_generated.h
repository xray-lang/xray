...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"sys", "__processSpawn", "(program: string, args: Array<string>, cwd: string?, envKeys: Array<string>?, envValues: Array<string>?): int", "Spawn a process and return an opaque process handle token, or -1 on failure", "sys_process_spawn", "normal", "", "xrt_sys_process_spawn", "svvvv", "value", "", "", "system", "method", 5, true},
