...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"sys", "__pipeRead", "(handle: int, maxBytes: int): Bytes?", "Read one chunk from a pipe endpoint", "sys_pipe_read", "normal", "", "xrt_sys_pipe_read", "vv", "value", "", "", "system", "method", 2, true},
    {"sys", "__pipeWrite", "(handle: int, data: Bytes): int", "Write one chunk to a pipe endpoint", "sys_pipe_write", "normal", "", "xrt_sys_pipe_write", "vv", "value", "", "", "system", "method", 2, true},
