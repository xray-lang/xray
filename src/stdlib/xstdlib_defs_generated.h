...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"cluster", "__start", "(name: string, port: i64, secret: string, tlsEnabled: bool, caFile: string, certFile: string, keyFile: string, insecure: bool, outputQueueHighWatermark: i64, tombstoneRetentionMs: i64): bool", "Open cluster TLS contexts and synchronized provider registries from source-normalized scalar configuration", "cluster_start_primitive", "normal", "", "", "svsvsssvvv", "value", "", "", "", "runtime", "", XR_CAP_CHANNEL, 10, XR_STDLIB_TARGET_LEAF_NONE, false},
...
static const XrStdlibObjectShapeDefEntry xr_stdlib_object_shape_def_entries[] = {
    ...
    {"cluster", "__ClusterRuntimeSnapshot", "Private snapshot of mutable native peer state and tombstone counters", xr_stdlib_object_fields_cluster___ClusterRuntimeSnapshot, 2, true},
