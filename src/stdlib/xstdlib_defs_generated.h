...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"mem", "view", "(ptr: Ptr<byte>): Ptr<byte>", "Unsafe zero-cost typed projection of a raw pointer onto an extern C struct or union T", "mem_view_intrinsic", "normal", "", "", "v", "value", "", "", "", "core", "", 1, false},
