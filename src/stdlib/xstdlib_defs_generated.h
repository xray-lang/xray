...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"cluster", "__publishRemote", "(topic: string, envelope: move Buffer, hopLimit: i64): i64", "Broadcast one validated opaque service envelope to connected native transports", "cluster_publish_remote_primitive", "normal", "", "", "svv", "i64", "", "", "", "runtime", "", XR_CAP_CHANNEL, 3, XR_STDLIB_TARGET_LEAF_NONE, false},
