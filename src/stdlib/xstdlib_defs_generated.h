...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"cluster", "__start", "(name: string, port: i64, secret: string, tlsEnabled: bool, caFile: string, certFile: string, keyFile: string, insecure: bool, heartbeatIntervalMs: i64, heartbeatTimeoutMs: i64, maxMissedHeartbeats: i64, phiThreshold: f64): bool", "Start the backend-neutral cluster runtime from normalized scalar configuration and the health policy cluster.xr decides", "cluster_start_primitive", "normal", "", "xrt_cluster_start", "svsvsssvvvvv", "value", "", "cluster.__start", "", "runtime", "method", XR_CAP_CHANNEL, 12, XR_STDLIB_TARGET_LEAF_NONE, true},
