...
static const XrStdlibDefEntry xr_stdlib_def_entries[] = {
    ...
    {"http2", "__connect", "(host: string, port: i64, timeoutMs: i64): i64", "Open one TLS connection that negotiated ALPN h2 and answer its handle, or -1", "h2_connect", "yieldable", "", "xrt_http_h2_connect_unavailable", "vvv", "value", "", "", "", "runtime", "method", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 3, XR_STDLIB_TARGET_LEAF_NONE, true},
    {"http2", "__send", "(handle: i64, data: Array<u8>): bool", "Write one buffer to an open HTTP/2 connection", "h2_send", "yieldable", "", "xrt_http_h2_send_unavailable", "vv", "value", "", "", "", "runtime", "method", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 2, XR_STDLIB_TARGET_LEAF_NONE, true},
    {"http2", "__recv", "(handle: i64, maxBytes: i64, timeoutMs: i64): Array<u8>?", "Read up to maxBytes from an open HTTP/2 connection; null on error or EOF", "h2_recv", "yieldable", "", "xrt_http_h2_recv_unavailable", "vvv", "value", "", "", "", "runtime", "method", XR_CAP_COROUTINE | XR_CAP_NETPOLL, 3, XR_STDLIB_TARGET_LEAF_NONE, true},
    {"http2", "__close", "(handle: i64): bool", "Close an HTTP/2 connection and release its handle", "h2_close", "normal", "", "xrt_http_h2_close_unavailable", "v", "value", "", "", "", "runtime", "method", 0, 1, XR_STDLIB_TARGET_LEAF_NONE, true},
