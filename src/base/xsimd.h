...
XR_FUNC const char *xr_simd_find_range_sse42(const char *s, size_t len, const char *ranges,
                                             int range_len);
XR_FUNC const char *xr_simd_skip_range_sse42(const char *s, size_t len, const char *ranges,
                                             int range_len);
...
XR_FUNC const char *xr_simd_find_range_neon(const char *s, size_t len, const char *ranges,
                                            int range_len);
XR_FUNC const char *xr_simd_skip_range_neon(const char *s, size_t len, const char *ranges,
                                            int range_len);
