...
XR_FUNC XrExprDesc compile_binary(XrCompilerContext *ctx, XrCompiler *c, BinaryNode *node, AstNodeType type);
XR_FUNC XrExprDesc compile_comparison(XrCompilerContext *ctx, XrCompiler *c, BinaryNode *node, AstNodeType type);
...
XR_FUNC XrExprDesc compile_unary(XrCompilerContext *ctx, XrCompiler *c, UnaryNode *node, AstNodeType type);
...
XR_FUNC XrExprDesc compile_array_literal(XrCompilerContext *ctx, XrCompiler *c, ArrayLiteralNode *node);
XR_FUNC XrExprDesc compile_object_literal(XrCompilerContext *ctx, XrCompiler *c, ObjectLiteralNode *node);
...
XR_FUNC XrExprDesc compile_struct_literal(XrCompilerContext *ctx, XrCompiler *c, StructLiteralNode *node);
XR_FUNC XrExprDesc compile_member_access(XrCompilerContext *ctx, XrCompiler *c, MemberAccessNode *node);

XR_FUNC XrExprDesc compile_enum_access(XrCompilerContext *ctx, XrCompiler *c, EnumAccessNode *node);
XR_FUNC XrExprDesc compile_enum_convert(XrCompilerContext *ctx, XrCompiler *c, EnumConvertNode *node);
