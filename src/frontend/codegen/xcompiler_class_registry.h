...
XR_FUNC ClassInfo* xr_class_registry_register(ClassRegistry *registry, 
                                       const char *class_name);

XR_FUNC ClassInfo* xr_class_registry_lookup(ClassRegistry *registry, 
                                     const char *class_name);

XR_FUNC int xr_class_add_instance_field(ClassInfo *class_info, 
                                 const char *field_name, 
                                 int index);

XR_FUNC int xr_class_add_instance_field_typed(ClassInfo *class_info,
                                      const char *field_name,
                                      int index,
                                      uint8_t slot_type);

XR_FUNC int xr_class_find_instance_field_index(ClassInfo *class_info, 
                                        const char *field_name);

XR_FUNC uint8_t xr_class_get_field_slot_type(ClassInfo *class_info,
                                     const char *field_name);

XR_FUNC bool xr_class_registry_is_class(ClassRegistry *registry, 
                                 const char *name);

XR_FUNC int xr_class_add_method(ClassInfo *class_info,
                        const char *method_name,
                        int index);

XR_FUNC int xr_class_find_method_index(ClassInfo *class_info,
                               const char *method_name);
