...
XR_FUNC XrCompilerContext* xr_compiler_context_new(void);
...
XR_FUNC void xr_compiler_ctx_add_const_string(XrCompilerContext *ctx, XrString *name, XrString *value);
