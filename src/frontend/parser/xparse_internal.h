...
XR_FUNC AstNode *xr_parse_parallel_expr(Parser *parser);
...
XR_FUNC AstNode *xr_parse_parallel_for_statement(Parser *parser);
XR_FUNC AstNode *xr_parse_parallel_range_statement(Parser *parser);
