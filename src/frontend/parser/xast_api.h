...
XR_FUNC AstNode *xr_ast_literal_regex(XrayIsolate *X, const char *pattern, const char *flags, int line);
...
XR_FUNC AstNode *xr_ast_compound_assignment(XrayIsolate *X, const char *name,
...
XR_FUNC AstNode *xr_ast_for_in_stmt(XrayIsolate *X, const char *item_name,
...
XR_FUNC AstNode *xr_ast_call_expr_generic(XrayIsolate *X, AstNode *callee,
...
XR_FUNC AstNode *xr_ast_as_expr(XrayIsolate *X, AstNode *expr, XrType *type, bool is_safe, int line);
...
XR_FUNC AstNode *xr_ast_map_literal(XrayIsolate *X, AstNode **keys, AstNode **values, int count, int line);
...
XR_FUNC AstNode *xr_ast_index_set(XrayIsolate *X, AstNode *array, AstNode *index, AstNode *value, int line);

// Create slice expression node
XR_FUNC AstNode *xr_ast_slice_expr(XrayIsolate *X, AstNode *source, AstNode *start, AstNode *end, int line);
...
XR_FUNC AstNode *xr_ast_struct_decl(XrayIsolate *X, const char *name,
                            AstNode **fields, int field_count,
                            AstNode **methods, int method_count, int line);

// Create struct literal node: Point{x: 1.0, y: 2.0}
XR_FUNC AstNode *xr_ast_struct_literal(XrayIsolate *X, const char *name,
                                char **field_names, AstNode **field_values,
                                int field_count, int line);

// Create interface declaration node
XR_FUNC AstNode *xr_ast_interface_decl(XrayIsolate *X, const char *name,
                               char **extends, int extends_count,
                               AstNode **methods, int method_count, int line);

// Create interface method signature node
XR_FUNC AstNode *xr_ast_interface_method(XrayIsolate *X, const char *name,
...
XR_FUNC AstNode *xr_ast_method_decl(XrayIsolate *X, const char *name,
                            char **parameters, XrType **param_types, int param_count,
...
XR_FUNC AstNode *xr_ast_super_call(XrayIsolate *X, const char *method_name,
                           AstNode **arguments, int arg_count, int line);
...
XR_FUNC AstNode *xr_ast_enum_index(XrayIsolate *X, AstNode *collection,
                           AstNode *index_expr, int line);

// Create try-catch-finally statement node
XR_FUNC AstNode *xr_ast_try_catch(XrayIsolate *X, AstNode *try_body,
...
XR_FUNC AstNode *xr_ast_export_stmt(XrayIsolate *X, AstNode *declaration, const char *export_name, int line);
...
XR_FUNC XrDestructurePattern* xr_pattern_array(XrayIsolate *X, XrDestructurePattern **elements, int count);
XR_FUNC XrDestructurePattern* xr_pattern_object(XrayIsolate *X, char **fields, XrDestructurePattern **patterns, int count, bool use_shorthand);
...
XR_FUNC AstNode *xr_ast_type_alias(XrayIsolate *X, const char *name,
...
XR_FUNC AstNode *xr_ast_go_expr(XrayIsolate *X, AstNode *expr, const char *name, AstNode *priority, uint8_t link_mode, int line);

// Create await expression node
XR_FUNC AstNode *xr_ast_await_expr(XrayIsolate *X, AstNode *expr, AstNode *timeout, bool is_any, bool is_all, bool is_any_success, int line);
