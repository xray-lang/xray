...
XR_FUNC XaAllocationContractKind
xa_builtin_get_module_func_abi_allocation_contract(const char *module_name,
                                                    const char *func_name);
XR_FUNC XaBuiltinReturnOwnership
...
XR_FUNC const XaBuiltinObjectShape *
xa_builtin_find_object_shape_by_name(const char *object_shape_name);
