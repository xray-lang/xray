...
XR_FUNC void xa_analyzer_invalidate_range(XaAnalyzer *analyzer,
                                          const char *file,
                                          uint32_t start_line,
                                          uint32_t end_line);
...
// the field had).
XR_FUNC void xa_analyzer_set_node_type(XaAnalyzer *analyzer,
                                       struct AstNode *node,
                                       struct XrType *type);
XR_FUNC struct XrType *xa_analyzer_get_node_type(XaAnalyzer *analyzer,
