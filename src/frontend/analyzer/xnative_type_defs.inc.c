...
static const char xr_native_def_array[] =
    ...
    "string.toBytes(). Other element types render the \"[a, b]\" form.\n    toString() -> string\n "
    "   // Iteration protocol — used by for-in lowering. Users can also\n    // call them "
    "directly; iterator()/next() yields elements, while\n    // entriesIterator()/next() yields "
...
static const char xr_native_def_string[] =
    ...
    "Map<string, string>) -> string\n    // Iteration protocol — iterator() yields each character, "
    "while\n    // entriesIterator() yields (charIndex, character) tuples. Both\n    // are used "
    "by for-in lowering and may be called directly.\n    iterator() -> Iterator<char>\n    "
