...
static const char xr_native_def_bigint[] =
    "// Built-in BigInt type — implementation in src/runtime/object/xbigint_methods.c\nclass "
    "BigInt {\n    abs() -> BigInt\n    toString() -> string\n    sign() -> int\n    isZero() -> "
    "bool\n    isNegative() -> bool\n    isPositive() -> bool\n    toInt() -> int?\n    toFloat() "
    "-> float\n}\n";
...
static const char xr_native_def_float[] =
    "// Built-in float type — implementation in src/runtime/value/xfloat_methods.c\nclass float "
...
static const char xr_native_def_map[] =
    ...
    "@receiver_write\n    delete(key: K) -> bool\n    // @receiver_write\n    clear()\n    keys() "
    "-> Array<K>\n    values() -> Array<V>\n    entries() -> Array<(K, V)>\n    forEach(fn: (key: "
    "K, value: V) -> ()) -> ()\n    // Iteration protocol — iterator() yields each key K (used "
    "by\n    // single-variable `for (k in m)`); entriesIterator() yields each\n    // (key, "
    "value) tuple (used by `for (k, v in m)`).\n    iterator() -> Iterator<K>\n    "
...
static const char xr_native_def_rune[] =
    "// Built-in Unicode scalar type. A rune is always a valid Unicode scalar value.\nclass rune "
    "{\n    toUInt32() -> uint32\n    toString() -> string\n    isLetter() -> bool\n    isNumber() "
    "-> bool\n    isAlphanumeric() -> bool\n    isWhitespace() -> bool\n}\n";
...
static const char xr_native_def_set[] =
    "// Built-in Set<T> type — implementation in src/runtime/object/xset_methods.c\nclass Set<T: "
    ...
    "yields each element T (used by for-in).\n    iterator() -> Iterator<T>\n    toString() -> "
    "string\n}\n";
...
static const char xr_native_def_workqueue[] =
    ...
    "accepted count.\n    // @receiver_write\n    pushRange(start: int, count: int, shardStart?: "
    "int) -> int\n    // @receiver_write\n    pop(workerId?: int): T?\n    // @receiver_write\n    "
