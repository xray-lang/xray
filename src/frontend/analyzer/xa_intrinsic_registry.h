...
typedef enum XaIntrinsicLowering {
    ...
    XA_INTRINSIC_LOWERING_CODEGEN_OPAQUE,
    XA_INTRINSIC_LOWERING_CODEGEN_COMPILER_FENCE,
...
enum {
    ...
    XA_INTRINSIC_FLAG_SCALABLE = 1u << 8,
    XA_INTRINSIC_FLAG_SCALABLE_STATIC_RECEIVER =
        XA_INTRINSIC_FLAG_SCALABLE | XA_INTRINSIC_FLAG_STATIC_RECEIVER,
    XA_INTRINSIC_FLAG_SCALABLE_ODD_LANES = XA_INTRINSIC_FLAG_SCALABLE | XA_INTRINSIC_FLAG_ODD_LANES,
    XA_INTRINSIC_FLAG_SCALABLE_SWAP_ADJACENT =
        XA_INTRINSIC_FLAG_SCALABLE | XA_INTRINSIC_FLAG_SWAP_ADJACENT,
