...
typedef enum XaIntrinsicLowering {
    ...
    XA_INTRINSIC_LOWERING_SPAN_REINTERPRET,
    XA_INTRINSIC_LOWERING_SPAN_DATA_PTR,
    XA_INTRINSIC_LOWERING_SPAN_WINDOW,
    XA_INTRINSIC_LOWERING_SPAN_AS_BYTES,
    XA_INTRINSIC_LOWERING_SPAN_FILL,
    XA_INTRINSIC_LOWERING_SPAN_COPY,
    XA_INTRINSIC_LOWERING_SPAN_COMPARE,
    XA_INTRINSIC_LOWERING_SPAN_GET,
