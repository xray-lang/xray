...
typedef enum XaIntrinsicLowering {
    ...
    XA_INTRINSIC_LOWERING_MEM_SIZE_OF,
    XA_INTRINSIC_LOWERING_MEM_ALIGN_OF,
    XA_INTRINSIC_LOWERING_MEM_OFFSET_OF,
    XA_INTRINSIC_LOWERING_MEM_PTR,
    XA_INTRINSIC_LOWERING_MEM_MUT_PTR,
    XA_INTRINSIC_LOWERING_MEM_ADDR,
    XA_INTRINSIC_LOWERING_MEM_LOAD,
    XA_INTRINSIC_LOWERING_MEM_STORE,
    XA_INTRINSIC_LOWERING_MEM_SLICE,
    XA_INTRINSIC_LOWERING_MEM_WITH_SLICE_MUT,
    XA_INTRINSIC_LOWERING_MEM_ASSUME_INITIALIZED,
    ...
    XA_INTRINSIC_LOWERING_MATH_SQRT,
    XA_INTRINSIC_LOWERING_MATH_POW,
    XA_INTRINSIC_LOWERING_MATH_ABS,
    XA_INTRINSIC_LOWERING_MATH_FLOOR,
    XA_INTRINSIC_LOWERING_MATH_CEIL,
    XA_INTRINSIC_LOWERING_MATH_ROUND,
    XA_INTRINSIC_LOWERING_MATH_TRUNC,
    XA_INTRINSIC_LOWERING_MATH_SIN,
    XA_INTRINSIC_LOWERING_MATH_COS,
    XA_INTRINSIC_LOWERING_MATH_TAN,
    XA_INTRINSIC_LOWERING_MATH_ASIN,
    XA_INTRINSIC_LOWERING_MATH_ACOS,
    XA_INTRINSIC_LOWERING_MATH_ATAN,
    XA_INTRINSIC_LOWERING_MATH_ATAN2,
    XA_INTRINSIC_LOWERING_MATH_LOG,
    XA_INTRINSIC_LOWERING_MATH_LOG10,
    XA_INTRINSIC_LOWERING_MATH_LOG2,
    XA_INTRINSIC_LOWERING_MATH_EXP,
    XA_INTRINSIC_LOWERING_MATH_SINH,
    XA_INTRINSIC_LOWERING_MATH_COSH,
    XA_INTRINSIC_LOWERING_MATH_TANH,
    XA_INTRINSIC_LOWERING_MATH_HYPOT,
    XA_INTRINSIC_LOWERING_MATH_CBRT,
    XA_INTRINSIC_LOWERING_MATH_FMOD,
    XA_INTRINSIC_LOWERING_MATH_LOG1P,
    XA_INTRINSIC_LOWERING_MATH_EXPM1,
    XA_INTRINSIC_LOWERING_MATH_LERP,
    XA_INTRINSIC_LOWERING_MATH_DEG_TO_RAD,
    XA_INTRINSIC_LOWERING_MATH_RAD_TO_DEG,
    XA_INTRINSIC_LOWERING_MATH_SIGN,
    XA_INTRINSIC_LOWERING_MATH_IS_NAN,
    XA_INTRINSIC_LOWERING_MATH_IS_FINITE,
    XA_INTRINSIC_LOWERING_MATH_MIN,
    XA_INTRINSIC_LOWERING_MATH_MAX,
    XA_INTRINSIC_LOWERING_MATH_CLAMP,
} XaIntrinsicLowering;
...
enum {
    ...
    /* The operation emits without libm, so the freestanding profile admits it. */
    XA_INTRINSIC_FLAG_FREESTANDING = 1u << 9,
