...
// cluster.__ClusterOutboundEvent object fields
static const XaBuiltinObjectField g_gen_cluster___clusteroutboundevent_object_fields[] = {
    {"peerGeneration", "i64"},
    {"status", "i64"},
};
...
static const XaBuiltinObjectShape g_gen_cluster_object_shapes[] = {
    ...
    {"__ClusterInboundFrame", "Private projection of one complete frame or terminal reader event", g_gen_cluster___clusterinboundframe_object_fields, 4, true},
    {"__ClusterOutboundEvent", "Private projection of one slow-consumer or terminal writer event", g_gen_cluster___clusteroutboundevent_object_fields, 2, true},
};
...
static const XaBuiltinMember g_gen_cluster_functions[] = {
    ...
    {"__healthTick", "(heartbeatWire: Array<u8>, heartbeatSentAtMs: i64, heartbeatTimeoutMs: i64, maxMissedHeartbeats: i64, phiMinSamples: i64, phiThreshold: f64): bool", "Enqueue one source-encoded heartbeat and project its health tick onto the locked peer registry", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__adoptPeer", "(conn: move NetConn, name: string, host: string, port: i64, flags: i64, heartbeatIntervalMs: i64, inbound: fn(): (), outbound: fn(): ()): bool", "Transfer an authenticated socket into the locked cluster node registry and start framed transport with source dispatchers", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__takeOutboundEvent", "(): __ClusterOutboundEvent?", "Project the terminal event owned by the current writer callback", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_FRESH},
    ...
    {"__forwardInbound", "(peerGeneration: i64, wire: Array<u8>): i64", "Broadcast one source-encoded frame while excluding its peer generation", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__disconnectPeer", "(peerGeneration: i64): bool", "Detach and close the peer generation selected by Xray transport policy", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__registerCoroutineMonitor", "(nodeName: string, coroutineName: string, notifications: Channel<string>): i64", "Register one source-constructed channel for a connected peer and return its generation", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__publishRemote", "(wire: Array<u8>): i64", "Broadcast one source-encoded transport frame to connected native transports", true, false, true, false, false, {XA_EFFECT_CONTRACT_NOTHROW, NULL, 0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
...
#define GEN_CLUSTER_FUNCTION_COUNT 24
