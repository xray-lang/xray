...
static const XaBuiltinMember g_gen_http_functions[] = {
    ...
    {"route", "(method: string, path: string, handler: fn): ()", "Register a route handler", true, false},
    {"static", "(prefix: string, dir: string): ()", "Serve static files from directory", true, false},
    ...
    {"formDataAppend", "(form: Json, name: string, value: string): ()", "Append field to form data", true, false},
    {"formDataAppendFile", "(form: Json, name: string, path: string, filename?: string): ()", "Append file to form data", true, false},
