...
static const XaBuiltinMember g_gen_io_functions[] = {
    ...
    {"__symlink", "(source: Path, link: Path): bool", "Create symbolic link", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
