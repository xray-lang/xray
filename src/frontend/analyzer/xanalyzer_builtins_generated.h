...
// cluster.__ClusterDeliveryStats object fields
static const XaBuiltinObjectField g_gen_cluster___clusterdeliverystats_object_fields[] = {
    {"accepted", "i64"},
    {"full", "i64"},
    {"stopped", "i64"},
    {"resource", "i64"},
...
static const XaBuiltinMember g_gen_cluster_functions[] = {
    ...
    {"__writePeer", "(peerGeneration: i64): i64", "Suspend while writing at most one queued batch and return an orthogonal raw stale, stopped, full, resource, socket, socket-I/O, provider or cancellation reason", true, false, true, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__notifyNodeDown", "(name: string): ()", "Publish a source-selected node-down notification through the synchronized monitor registry", true, false, true, false, false, {XA_EFFECT_CONTRACT_NOTHROW, NULL, 0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, XR_PARAM_READ, XA_BUILTIN_RETURN_UNKNOWN},
