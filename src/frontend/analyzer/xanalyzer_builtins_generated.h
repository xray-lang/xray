...
static const XaBuiltinMember g_gen_cluster_functions[] = {
    ...
    {"__readPeer", "(peerGeneration: i64, maxFramePayload: i64): Array<u8> | i64", "Suspend for one frame and return owned wire bytes or an orthogonal raw stale, stopped, EOF, I/O, header, capacity, resource or cancellation reason", true, false, true, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, XR_PARAM_READ, XA_BUILTIN_RETURN_FRESH},
