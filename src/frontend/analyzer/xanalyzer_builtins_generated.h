...
static const XaBuiltinMember g_gen_cluster_functions[] = {
    ...
    {"self", "(): string", "Get own node name", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"nodes", "(): Array<string>", "List cluster node names", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"monitor", "(name: string, coro_name?: string): Channel", "Monitor node or remote coroutine", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"info", "(): ClusterInfo?", "Get cluster status info", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"subscribe", "(pattern: string): Channel", "Subscribe to topic pattern", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
};
...
static const XaBuiltinMember g_gen_compress_functions[] = {
    ...
    {"gzip", "(data: string, level?: int): string?", "Gzip compress", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"gunzip", "(data: string): string", "Gzip decompress", true, false, false, false, false, {XA_EFFECT_CONTRACT_ERRORS, g_gen_compress_gunzip_3_errors, 1}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"deflate", "(data: string, level?: int): string?", "Deflate compress", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"inflate", "(data: string): string", "Inflate decompress", true, false, false, false, false, {XA_EFFECT_CONTRACT_ERRORS, g_gen_compress_inflate_5_errors, 1}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"zlibCompress", "(data: string, level?: int): string?", "Zlib compress", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"zlibDecompress", "(data: string): string", "Zlib decompress", true, false, false, false, false, {XA_EFFECT_CONTRACT_ERRORS, g_gen_compress_zlibdecompress_7_errors, 1}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
...
static const XaBuiltinMember g_gen_crypto_functions[] = {
    {"md5", "(data: string): string", "Compute MD5 hash", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"sha1", "(data: string): string", "Compute SHA-1 hash", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"sha256", "(data: string): string", "Compute SHA-256 hash", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"sha512", "(data: string): string", "Compute SHA-512 hash", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"hmac", "(algo: string, key: string, data: string): string?", "Compute HMAC", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"randomBytes", "(n: int): string", "Generate random bytes", true, false, false, false, false, {XA_EFFECT_CONTRACT_ERRORS, g_gen_crypto_randombytes_5_errors, 1}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"uuid", "(): string", "Generate UUID v4", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"encrypt", "(key: string, plaintext: string): string", "AES-256-CBC encrypt", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"decrypt", "(key: string, ciphertext: string): string?", "AES-256-CBC decrypt", true, false, false, false, false, {XA_EFFECT_CONTRACT_ERRORS, g_gen_crypto_decrypt_8_errors, 1}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
...
static const XaBuiltinMember g_gen_http_functions[] = {
    ...
    {"__h2Request", "(url: string, method: string, headerNames: Array<string>, headerValues: Array<string>, body: Array<byte>, timeoutMs: int): (int, Array<string>, Array<string>, Array<byte>)?", "Internal typed HTTP/2 data-plane request", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
};
...
static const XaBuiltinMember g_gen_io_functions[] = {
    ...
    {"__readDir", "(path: Path): Array<string>", "List directory entries (raw strings; io.xr wraps as Path)", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"__readDirRecursive", "(path: Path): Array<string>", "List directory entries recursively (raw strings; io.xr wraps as Path)", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"readFile", "(path: Path): string?", "Read entire file as string", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"stat", "(path: Path): FileStat?", "Get file stat info", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__tempDir", "(): string?", "Create temporary directory (raw string; io.xr wraps as Path)", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"__tempFile", "(): string?", "Create temporary file (raw string; io.xr wraps as Path)", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
...
static const XaBuiltinMember g_gen_mem_functions[] = {
    ...
    {"allocAligned", "(n: int, align: int): Buffer", "Allocate n managed bytes aligned to align (power-of-two >= sizeof(void*))", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
...
static const XaBuiltinMember g_gen_net_functions[] = {
    ...
    {"read", "(conn: NetConn, maxlen?: int): string?", "Read data from connection", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"lastError", "(handle: NetConn | NetListener): string?", "Return the last network error name", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"lookup", "(hostname: string): string?", "DNS lookup", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"dialTLS", "(host: string, port: int, timeout?: int): NetConn?", "Dial a TLS connection", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"upgradeTLS", "(conn: NetConn, hostname: string, timeout?: int): NetConn?", "Upgrade connection to TLS", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"udpBind", "(port: int, addr?: string): NetConn?", "Bind a UDP socket", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"recvFrom", "(handle: NetConn, maxlen?: int): UdpPacket?", "Receive UDP datagram (returns flat handle: data, host, port)", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
};
...
static const XaBuiltinMember g_gen_os_functions[] = {
    {"getenv", "(name: string): string?", "Get environment variable", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"environ", "(): Map<string, string>", "Get all environment variables", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"getcwd", "(): string", "Get current working directory", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"chdir", "(path: Path): bool", "Change working directory", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"hostname", "(): string", "Get hostname", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"tmpdir", "(): string", "Get temporary directory path", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"username", "(): string?", "Get current user name", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"homedir", "(): string?", "Get user home directory", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"loadavg", "(): Array<float>", "Get system load averages (1, 5, 15 min)", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"exec", "(cmd: string): ExecResult?", "Execute shell command", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"spawn", "(program: string, args: Array<string>): ExecResult?", "Execute a program without a shell (injection-safe argv)", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    // Module constants (is_method=false)
...
static const XaBuiltinMember g_gen_regex_functions[] = {
    {"compile", "(pattern: string, flags?: string): Regex", "Compile regex pattern", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"findText", "(pattern: Regex, s: string): string?", "Find first matching text", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"findGroup", "(pattern: Regex, s: string, index: int): string?", "Find capture group", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"find", "(pattern: Regex, s: string, offset?: int): RegexMatch?", "Find first match", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"fullFind", "(pattern: Regex, s: string): RegexMatch?", "Find full match", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"findAll", "(pattern: Regex, s: string, limit?: int): Array<RegexMatch>", "Find all matches", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"replace", "(pattern: Regex, s: string, repl: string): string", "Replace first match", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"replaceAll", "(pattern: Regex, s: string, repl: string): string", "Replace all matches", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"split", "(pattern: Regex, s: string, limit?: int): Array<string>", "Split string by regex", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MAY_HEAP, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"escape", "(s: string): string", "Escape regex special chars", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
...
static const XaBuiltinMember g_gen_sys_functions[] = {
    {"OsMutex", "(): OsMutex", "Create an OS-domain mutex", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"__osMutexNew", "(): OsMutex", "Create an OS-domain mutex for sys module internals", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"OsRwLock", "(): OsRwLock", "Create an OS-domain read-write lock", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"OsCondvar", "(): OsCondvar", "Create an OS-domain condition variable", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"OsBarrier", "(parties: int): OsBarrier", "Create a reusable OS-domain barrier", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"OsOnce", "(): OsOnce", "Create an OS-domain once gate", true, false, false, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__dylibLastError", "(): string", "Return the platform dynamic-loader error message for the current thread", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"__pipeOpen", "(): Array<int>?", "Create an anonymous pipe and return read/write endpoint tokens", true, false, true, false, false, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    {"__pipeRead", "(handle: int, maxBytes: int): Array<byte>?", "Read one chunk from a pipe endpoint", true, false, true, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
...
static const XaBuiltinMember g_gen_ws_functions[] = {
    {"connect", "(url: string, options?: WsConnectOptions?): WsConn?", "Connect to a WebSocket server", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
    ...
    {"recv", "(conn: WsConn, timeout?: int?): WsMessage?", "Receive data from WebSocket connection", true, false, false, false, true, {0}, XA_ALLOCATION_CONTRACT_MISSING, false, XA_BUILTIN_RETURN_UNKNOWN},
