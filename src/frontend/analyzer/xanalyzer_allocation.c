...
static XaAllocationContractKind alloc_intrinsic_contract(const char *name) {
    static const XaAllocIntrinsicContract contracts[] = {
        ...
        {"u8", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"u16", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"u32", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"u64", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"i8", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"i16", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"i32", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"i64", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"f32", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"f64", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"isize", XA_ALLOCATION_CONTRACT_NO_HEAP},
        {"usize", XA_ALLOCATION_CONTRACT_NO_HEAP},
...
static bool alloc_publish_canonical_effect(XaAllocPass *pass, XaAllocFunctionRow *row) {
    ...
    xa_effect_summary_reset_semantic_effects(&summary, XA_SEM_EFFECT_ALLOC);
