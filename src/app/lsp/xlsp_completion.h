...
XR_FUNC XrJsonValue *xlsp_analyze_completion(XrLspServer *server, XrLspDocument *doc,
                                             XrLspPosition pos);

// Infer variable type from declaration (also used by hover)
XR_FUNC XlspBuiltinType xlsp_infer_variable_type(XrLspServer *server, XrLspDocument *doc,
                                                 const char *var_name);
