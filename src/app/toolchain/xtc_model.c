...
static const XtcTargetRecord xtc_targets[] = {
    ...
    {"aarch64-linux-gnu", "aarch64-linux-gnu", NULL, "", XR_TOOLCHAIN_TARGET_ARCH_AARCH64,
     XR_TOOLCHAIN_TARGET_OS_LINUX, XR_TOOLCHAIN_TARGET_ABI_GNU, XR_TOOLCHAIN_TARGET_ENDIAN_LITTLE,
     64},
    {"i386-linux-musl", "x86-linux-musl", NULL, "", XR_TOOLCHAIN_TARGET_ARCH_X86,
    ...
    {"x86_64-linux-musl", "x86_64-linux-musl", NULL, "", XR_TOOLCHAIN_TARGET_ARCH_X86_64,
     XR_TOOLCHAIN_TARGET_OS_LINUX, XR_TOOLCHAIN_TARGET_ABI_MUSL, XR_TOOLCHAIN_TARGET_ENDIAN_LITTLE,
     64},
    {"arm-linux-gnueabi", "arm-linux-gnueabi", NULL, "", XR_TOOLCHAIN_TARGET_ARCH_ARM,
     XR_TOOLCHAIN_TARGET_OS_LINUX, XR_TOOLCHAIN_TARGET_ABI_GNU, XR_TOOLCHAIN_TARGET_ENDIAN_LITTLE,
     32},
    {"aarch64-linux-musl", "aarch64-linux-musl", NULL, "", XR_TOOLCHAIN_TARGET_ARCH_AARCH64,
     XR_TOOLCHAIN_TARGET_OS_LINUX, XR_TOOLCHAIN_TARGET_ABI_MUSL, XR_TOOLCHAIN_TARGET_ENDIAN_LITTLE,
     64},
    {"powerpc64-linux-musl", "powerpc64-linux-musl", NULL, "", XR_TOOLCHAIN_TARGET_ARCH_POWERPC64,
     XR_TOOLCHAIN_TARGET_OS_LINUX, XR_TOOLCHAIN_TARGET_ABI_MUSL, XR_TOOLCHAIN_TARGET_ENDIAN_BIG,
     64},
    {"powerpc64le-linux-musl", "powerpc64le-linux-musl", NULL, "",
     XR_TOOLCHAIN_TARGET_ARCH_POWERPC64, XR_TOOLCHAIN_TARGET_OS_LINUX, XR_TOOLCHAIN_TARGET_ABI_MUSL,
     XR_TOOLCHAIN_TARGET_ENDIAN_LITTLE, 64},
    {"loongarch64-linux-musl", "loongarch64-linux-musl", NULL, "",
     XR_TOOLCHAIN_TARGET_ARCH_LOONGARCH64, XR_TOOLCHAIN_TARGET_OS_LINUX,
     XR_TOOLCHAIN_TARGET_ABI_MUSL, XR_TOOLCHAIN_TARGET_ENDIAN_LITTLE, 64},
