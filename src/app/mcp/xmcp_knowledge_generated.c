...
XR_DATADEF const XmcpGeneratedTopic xmcp_generated_topics[] = {
    ...
    },
    {
        ...
        .body =
            ...
            "```\n"
            "`var ch = new Channel<int>(10)` is a **compile error** for coroutine sharing.\n"
            "\n"
            "### Operations\n"
            "```xray\n"
    ...
    },
    {
        ...
        .body =
            ...
            "\n"
            "### Sharing model\n"
            "- `shared` is a stable shared identity stored on the global heap; it can be shared across coroutines without copying\n"
            "- `shared` bindings cannot be reassigned or moved; mutable sharing safety is defined by the value type\n"
            "- ordinary local `var` / `const` values cannot be captured by `go` closures; pass data explicitly\n"
            "- exclusive local ownership is transferred with `move` from a local `var`\n"
    ...
    },
    {
        .id = "variables",
        .title = "Variables",
        .aliases_csv = "var,const,shared,declaration",
        .body =
...
XR_DATADEF const char xmcp_generated_cheatsheet[] =
    ...
    "- `shared`: stable shared identity stored on the global heap; cannot be moved\n"
    ...
    "- `move`: explicit ownership transfer from a local `var`\n"
