...
#define XR_ERROR_CORE_BYTE_SLICE_LOAD_U16_OOB_MSG "Slice<byte>.load<uint16>() offset out of bounds"
...
#define XR_ERROR_CORE_BYTE_SLICE_LOAD_U32_OOB_MSG "Slice<byte>.load<uint32>() offset out of bounds"
