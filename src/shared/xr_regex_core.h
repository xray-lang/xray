 ...
 *
 * xr_regex_core.h - Shared regex flag and boundary utilities
 */
...
/* These helpers define flag spelling and representation-independent scalar
 * bounds only. stdlib/regex/regex.xr is the compile/match semantic owner. */
