...
static inline bool xr_semantic_string_runes_result_type_is_exact(const XrSemanticPlan *plan,
    ...
    const XrSemanticTypeRecord *element =
        type && type->child_count == 1 && type->child_begin < child_count
            ...
            : NULL;
    const char expected[] = "type-v3:11:0:0:0:0:0:0:0:0:255:0:;named:8:Iterator[1;"
...
static inline bool xr_semantic_string_runes_is_exact(const XrSemanticPlan *plan,
    ...
    if (!receiver_type || receiver_type->kind != XR_KIND_STRING ||
        ...
        (receiver_type->flags & (XR_SEM_TYPE_NULLABLE | XR_SEM_TYPE_VALUE |
