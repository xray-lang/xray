...
static inline bool xr_semantic_rune_to_uint32_receiver_is_exact(
...
static inline bool xr_semantic_rune_to_uint32_is_exact(
    const XrSemanticPlan *plan, const XrSemanticOperationRecord *operation,
    uint32_t *receiver_value) {
    ...
    if (!receiver_type || receiver_type->kind != XR_KIND_RUNE ||
        ...
        result_type->scalar_rep != XR_NATIVE_U32 ||
        ...
        !xr_semantic_rune_to_uint32_receiver_is_exact(
