 ...
 * no reference-count obligation behind the call. SOURCE_CLASS_CONSTRUCTOR names
 * the construction of a declared class through its own class object, taken from
 * the SemanticPlan call target of the same name; it names no callee function
 * and carries no argument, and it never suspends. */
