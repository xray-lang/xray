...
typedef enum XrTargetExecutionFamily {
    ...
    /* One exact managed mutation: tagged Array.push for the closed String,
     * frozen source-class, and compiler-owned Array element roster. The
     * receiver is borrowed, the tagged element is consumed, and the unit
     * result occupies no slot. */
...
typedef enum XrTargetCallConvention {
    ...
    XR_TARGET_CALL_CONVENTION_ITERATOR_RUNE_NTH,
    XR_TARGET_CALL_CONVENTION_RUNE_TO_UINT32,
    XR_TARGET_CALL_CONVENTION_RUNE_TO_STRING,
...
typedef enum XrTargetCallTargetKind {
    ...
    XR_TARGET_CALL_TARGET_ITERATOR_RUNE_NTH,
    XR_TARGET_CALL_TARGET_RUNE_TO_UINT32,
    XR_TARGET_CALL_TARGET_RUNE_TO_STRING,
