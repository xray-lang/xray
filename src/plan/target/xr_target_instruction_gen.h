...
typedef enum XrTargetInstructionOpcode {
    ...
    XR_TARGET_INSTRUCTION_CALL_NATIVE_LEAF_I64 = 44,
    XR_TARGET_INSTRUCTION_COUNT = 45
} XrTargetInstructionOpcode;

#define XR_TARGET_INSTRUCTION_CONTRACT_COUNT 44u
#define XR_TARGET_INSTRUCTION_MAX_STABLE_ID 44u
...
xr_target_instruction_contract(uint16_t opcode) {
    static const XrTargetInstructionContract contracts[] = {
        ...
        {"i64.overflow.predicate", NULL, 2,
         ...
         XR_TARGET_INSTRUCTION_DISPATCH_OVERFLOW,
         XR_TARGET_INSTRUCTION_DISPATCH_ARGUMENT_NONE},
        {"call.native-leaf.i64", "xi.call", 0,
         false, XR_TARGET_INSTRUCTION_REP_I64,
         {XR_TARGET_INSTRUCTION_REP_NONE,
          XR_TARGET_INSTRUCTION_REP_NONE},
         XR_TARGET_INSTRUCTION_RESULT_OWNERSHIP_TRIVIAL,
