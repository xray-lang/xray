...
static const XrXtpTextFamilyName family_names[] = {
    ...
    {XR_TARGET_FAMILY_JSON_NAMESPACE_CODEC_STORAGE, "JSON_NAMESPACE_CODEC_STORAGE"},
    ...
    {XR_TARGET_FAMILY_RUNE_TO_STRING_RESULT_STORAGE, "RUNE_TO_STRING_RESULT_STORAGE"},
    {XR_TARGET_FAMILY_SOURCE_CLASS_FIELD_RESULT_STORAGE, "SOURCE_CLASS_FIELD_RESULT_STORAGE"},
    {XR_TARGET_FAMILY_SOURCE_STRUCTURAL_FIELD_RESULT_STORAGE,
     "SOURCE_STRUCTURAL_FIELD_RESULT_STORAGE"},
};
