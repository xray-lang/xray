...
#define XR_XTP_I64_OVERFLOW_PREDICATE_FIELDS(F)                                                   \
...
#define XR_XTP_MODULE_PARTITION_FIELDS(F)                                                        \
...
#define XR_XTP_PROGRAM_GRAPH_FIELDS(F)                                                            \
...
#define XR_XTP_TYPED_ROWS(F)                                                                       \
    ...
    F(I64_OVERFLOW_PREDICATES, XrTargetI64OverflowPredicateRecord,                               \
      XR_XTP_I64_OVERFLOW_PREDICATE_FIELDS)                                                      \
    ...
    F(MODULE_PARTITIONS, XrTargetModulePartitionRecord, XR_XTP_MODULE_PARTITION_FIELDS)           \
    F(PROGRAM_GRAPHS, XrTargetProgramGraphRecord, XR_XTP_PROGRAM_GRAPH_FIELDS)
...
XR_FUNC uint64_t xr_xtp_table_count_limit(XrXtpSectionKind kind) {
    switch (kind) {
        ...
        case XR_XTP_SECTION_I64_OVERFLOW_PREDICATES:
            return XR_PROGRAM_SEMANTIC_CLOSURE_MAX_CALLS;
        ...
        case XR_XTP_SECTION_MODULE_PARTITIONS:
            return XR_PROGRAM_SEMANTIC_CLOSURE_MAX_MODULES;
        case XR_XTP_SECTION_PROGRAM_GRAPHS: return 1;
        default: return 0;
    }
}
