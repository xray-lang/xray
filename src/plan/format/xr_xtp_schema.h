...
#define XR_XTP_SCHEMA_VERSION UINT32_C(53)
...
#define XR_XTP_MAX_VERIFY_WORK_UNITS UINT64_C(268435456)

#define XR_XTP_SECTION_FLAG_COMPACT UINT32_C(1)
...
typedef enum XrXtpSectionKind {
    ...
    XR_XTP_SECTION_I64_OVERFLOW_PREDICATES,
    ...
    XR_XTP_SECTION_ENTRY_EXPECTATIONS,
    XR_XTP_SECTION_DEBUG_FACTS,
    XR_XTP_SECTION_MODULE_PARTITIONS,
